...
eval0_1 env (Param00_1) = evalVar1 env "w"
eval0_1 env (Param10_1) = evalVar1 env "pos"
...
eval2_0 env (Param32_0) = evalVar1 env "global0"
eval2_0 env (Param42_0) = evalVar1 env "global1"
...
data Choice
  = Cnil Unit
  | Ccons SymInteger SymInteger Choice
  deriving stock (Generic, Show, Eq)
  deriving (Mergeable, EvaluateSym, ToCon Choice, ExtractSymbolics)
    via (Default Choice)
      ...
      case xs of
        ...
        Pcons h t -> Pcons (let
            tmp1 =
              (snoc pos w)
          in
          evalU0_0 (RefEnv [("h", (Env0 h)), ("w", (Env1 w)), ("pos", (Env1 pos))]) ((genSym (4::Int) "hole0") :: (UnionM Expr0_0))) (f t)
      ...
      case xs of
        ...
        Pcons h t -> max' (let
            tmp3 =
              (eval global0 global1)
          in
          evalU2_0 (RefEnv [("global0", (Env1 global0)), ("global1", (Env1 global1)), ("h", (Env0 h))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))) (f t)
      
  in
  f 

main' global0 global1 graph = 
  get_best global0 global1 (generate_paths graph)
...
ioPair :: [((SymInteger, SymInteger, Graph), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, SymInteger, Graph), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((-1)), ((-5)), ((Gcons ((Cons ((1)) ((Nil Unit)))) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((1)), ((-2)), ((Gcons ((Cons ((-3)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((2)) ((Nil Unit)))))))))) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((-5)), ((-4)), ((Gcons ((Nil Unit)) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((-3)), ((2)), ((Gcons ((Cons ((-1)) ((Cons ((-3)) ((Cons ((-5)) ((Cons ((2)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((-3)) ((Nil Unit)))))))))))))))) ((Gnil Unit))))), (3))
                , ((((-1)), ((-4)), ((Gcons ((Nil Unit)) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((1)), ((-2)), ((Gcons ((Nil Unit)) ((Gcons ((Cons ((-5)) ((Cons ((2)) ((Nil Unit)))))) ((Gcons ((Cons ((-3)) ((Nil Unit)))) ((Gnil Unit))))))))), (0))
                , ((((0)), ((3)), ((Gcons ((Cons ((-5)) ((Cons ((2)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((0)) ((Nil Unit)))))))))))) ((Gnil Unit))))), (3))
                , ((((-2)), ((-3)), ((Gcons ((Nil Unit)) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((-4)), ((-2)), ((Gnil Unit))), (1))
                , ((((2)), ((-3)), ((Gnil Unit))), (1))
                , ((((-3)), ((-3)), ((Gcons ((Cons ((2)) ((Cons ((-5)) ((Cons ((-4)) ((Cons ((-5)) ((Nil Unit)))))))))) ((Gcons ((Cons ((-2)) ((Nil Unit)))) ((Gnil Unit))))))), (4))
                , ((((-3)), ((0)), ((Gcons ((Cons ((-4)) ((Cons ((-4)) ((Nil Unit)))))) ((Gnil Unit))))), (0))
                , ((((-4)), ((2)), ((Gcons ((Cons ((-2)) ((Nil Unit)))) ((Gcons ((Cons ((3)) ((Nil Unit)))) ((Gnil Unit))))))), (6))
                , ((((0)), ((1)), ((Gcons ((Cons ((3)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((1)) ((Nil Unit)))))))))) ((Gcons ((Cons ((-2)) ((Nil Unit)))) ((Gnil Unit))))))), (8))
                , ((((1)), ((-5)), ((Gcons ((Cons ((-2)) ((Nil Unit)))) ((Gnil Unit))))), (0))
                , ((((0)), ((-2)), ((Gcons ((Nil Unit)) ((Gcons ((Cons ((-1)) ((Nil Unit)))) ((Gnil Unit))))))), (0))
                , ((((1)), ((-3)), ((Gcons ((Cons ((-5)) ((Cons ((1)) ((Cons ((0)) ((Cons ((-4)) ((Nil Unit)))))))))) ((Gcons ((Nil Unit)) ((Gnil Unit))))))), (0))
                , ((((-4)), ((-2)), ((Gcons ((Cons ((0)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((3)) ((Nil Unit)))))))))) ((Gcons ((Cons ((-2)) ((Nil Unit)))) ((Gnil Unit))))))), (6))
                , ((((0)), ((1)), ((Gcons ((Cons ((1)) ((Nil Unit)))) ((Gcons ((Cons ((-4)) ((Nil Unit)))) ((Gnil Unit))))))), (0))
                , ((((-3)), ((0)), ((Gcons ((Cons ((3)) ((Nil Unit)))) ((Gnil Unit))))), (3))
                ]
