...
main = do
    let pairs = [
                (((Elt (-1))), (-1))
                , (((Cons ((-2)) ((Cons ((0)) ((Cons ((-4)) ((Cons ((3)) ((Cons ((5)) ((Elt (3))))))))))))), (-4))
                , (((Elt (-2))), (-2))
                , (((Cons ((5)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((1)) ((Elt (5))))))))))))), (-5))
                , (((Cons ((5)) ((Elt (-5))))), (-5))
                , (((Cons ((5)) ((Elt (-4))))), (-4))
                , (((Cons ((-2)) ((Cons ((5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-5)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((3)) ((Elt (5))))))))))))))))))), (-5))
                , (((Cons ((4)) ((Elt (5))))), (4))
                , (((Cons ((-5)) ((Elt (4))))), (-5))
                , (((Cons ((-2)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((4)) ((Elt (-1))))))))))))))))))), (-4))
                , (((Cons ((3)) ((Cons ((-4)) ((Elt (0))))))), (-4))
                , (((Cons ((-2)) ((Elt (5))))), (-2))
                , (((Cons ((-3)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((-1)) ((Elt (-4))))))))))), (-5))
                , (((Cons ((4)) ((Elt (5))))), (4))
                , (((Elt (-1))), (-1))
                , (((Elt (-3))), (-3))
                , (((Cons ((-5)) ((Cons ((5)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((5)) ((Cons ((1)) ((Cons ((4)) ((Cons ((-2)) ((Cons ((-2)) ((Elt (2))))))))))))))))))))), (-5))
                , (((Cons ((-1)) ((Cons ((-3)) ((Cons ((-5)) ((Elt (-1))))))))), (-5))
                , (((Cons ((0)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((2)) ((Cons ((3)) ((Cons ((4)) ((Cons ((2)) ((Cons ((-2)) ((Elt (-4))))))))))))))))))))), (-4))
                , (((Cons ((3)) ((Elt (1))))), (1))
                ]
