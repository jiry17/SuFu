...
-- output_type: {Int,Int}
-- param_list: info z tmp2 zz w tree
data Expr1_0
  = Param21_0
...
-- output_type: {Int,Int}
-- param_list: info z tmp3 zz w tree
data Expr2_0
  = Param22_0
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam02_1] ++ [mrgParam42_1] ++ [mrgCzero2_1]
...
eval1_1 env (Param01_1) = evalVar1 env "info"
eval1_1 env (Param41_1) = evalVar1 env "w"
...
eval2_1 env (Param02_1) = evalVar1 env "info"
...
eval3_1 env (Param03_1) = evalVar0 env "tmp4"
...
Hole grammar for #1
info z tmp2 zz w tree 

Hole grammar for #2
info z tmp3 zz w tree 
        ...
        Node a l r -> 
          let
            result =
              (f s l)
          in
          f (((fst result) +  a), (max' (snd result) ((fst result) +  a))) r
        ...
        Left' w tree zz -> 
          ...
          let
            tmp2 =
              (f zz)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("info", (Env1 info)), ("w", (Env1 w))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
        Right' w tree zz -> 
          let
            info =
              (spec tree)
          ...
          let
            tmp3 =
              (f zz)
          in
          evalU2_0 (RefEnv [("tmp3", (Env0 tmp3)), ("info", (Env1 info)), ("w", (Env1 w))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
...
main = do
    let pairs = [
                (((Left' ((-3)) ((Empty Unit)) ((Right' ((-4)) ((Empty Unit)) ((Top Unit)))))), (0))
                ...
                , (((Right' ((-4)) ((Empty Unit)) ((Right' ((-4)) ((Empty Unit)) ((Right' ((-2)) ((Node ((-2)) ((Empty Unit)) ((Empty Unit)))) ((Top Unit)))))))), (0))
                , (((Left' ((-5)) ((Empty Unit)) ((Top Unit)))), (0))
                , (((Top Unit)), (0))
                ...
                , (((Left' ((-1)) ((Node ((-1)) ((Empty Unit)) ((Empty Unit)))) ((Left' ((-3)) ((Empty Unit)) ((Top Unit)))))), (0))
