...
-- output_type: Int
-- param_list: zz w tree tmp6 z tmp5
data Expr3_0
  = Param13_0
  | Param33_0
  | Param53_0
...
-- output_type: Int
-- param_list: zz w tree tmp8 z tmp7
data Expr4_0
  = Param14_0
  | Param34_0
  | Param54_0
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam13_0] ++ [mrgParam33_0] ++ [mrgParam53_0] ++ [mrgCzero3_0]
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam14_0] ++ [mrgParam34_0] ++ [mrgParam54_0] ++ [mrgCzero4_0]
...
eval3_0 env (Param13_0) = evalVar0 env "w"
...
eval4_0 env (Param14_0) = evalVar0 env "w"
eval4_0 env (Param34_0) = evalVar0 env "tmp8"
...
eval5_0 env (Param15_0) = evalVar0 env "tmp9"
...
Hole grammar for #3
zz w tree tmp6 z tmp5 

Hole grammar for #4
zz w tree tmp8 z tmp7 
        ...
        Left' w tree zz -> 
          ...
          let
            tmp6 =
              (f zz)
          in
          evalU3_0 (RefEnv [("w", (Env0 w)), ("tmp6", (Env0 tmp6)), ("tmp5", (Env0 tmp5))]) ((genSym (5::Int) "hole3") :: (UnionM Expr3_0))
        Right' w tree zz -> 
          let
            tmp7 =
              (tree_rec tree)
          ...
          let
            tmp8 =
              (f zz)
          in
          evalU4_0 (RefEnv [("w", (Env0 w)), ("tmp8", (Env0 tmp8)), ("tmp7", (Env0 tmp7))]) ((genSym (5::Int) "hole4") :: (UnionM Expr4_0))
