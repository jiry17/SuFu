...
eval1_1 env (Param31_1) = evalVar1 env "tmp2"
...
eval2_0 env (Param02_0) = evalVar1 env "global0"
...
eval2_1 env (Param12_1) = evalVar0 env "tmp5"
...
data IndexedList
  = Inil Unit
  | Icons SymInteger SymInteger IndexedList
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon IndexedList, ExtractSymbolics)
    via (Default IndexedList)
{-
        ...
        Cons h t -> 
          ...
          let
            tmp3 =
              (f t)
          in
          evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("tmp2", (Env1 tmp2)), ("h", (Env1 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                ...
                , ((((1)), ((Nil Unit))), (0))
                , ((((1)), ((Cons ((5)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((1)) ((Nil Unit))))))))))))), (0))
                , ((((-5)), ((Cons ((5)) ((Nil Unit))))), (0))
                , ((((4)), ((Cons ((5)) ((Nil Unit))))), (0))
                ...
                , ((((2)), ((Cons ((0)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((2)) ((Cons ((3)) ((Cons ((4)) ((Cons ((2)) ((Cons ((-2)) ((Nil Unit))))))))))))))))))))), (4))
                , ((((3)), ((Cons ((3)) ((Nil Unit))))), (0))
                ]
