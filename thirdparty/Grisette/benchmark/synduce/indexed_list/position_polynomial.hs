        ...
        Cons h t -> 
          ...
          let
            tmp3 =
              (f t)
          in
          evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("tmp2", (Env0 tmp2)), ("h", (Env0 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Nil Unit)), 0)
                , (((Nil Unit)), 0)
                , (((Cons ((2)) ((Cons ((4)) ((Cons ((3)) ((Cons ((1)) ((Cons ((5)) ((Cons ((3)) ((Cons ((1)) ((Cons ((-4)) ((Nil Unit)))))))))))))))))), 79)
                , (((Cons ((4)) ((Cons ((5)) ((Nil Unit)))))), 4)
                , (((Cons ((-3)) ((Cons ((1)) ((Cons ((5)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((4)) ((Cons ((1)) ((Cons ((5)) ((Nil Unit)))))))))))))))))))), 6)
                , (((Cons ((-1)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((-2)) ((Nil Unit)))))))))), -2)
                , (((Cons ((-5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((5)) ((Nil Unit)))))))))))))))))), -2)
                , (((Cons ((4)) ((Cons ((-4)) ((Cons ((1)) ((Cons ((-2)) ((Nil Unit)))))))))), 5)
                , (((Cons ((-3)) ((Nil Unit)))), 0)
                , (((Cons ((-3)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((-3)) ((Nil Unit)))))))))))))))), -29)
                , (((Cons ((4)) ((Cons ((-5)) ((Nil Unit)))))), 4)
                , (((Cons ((-1)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((-3)) ((Cons ((0)) ((Cons ((2)) ((Nil Unit)))))))))))))), -27)
                , (((Nil Unit)), 0)
                ...
                , (((Cons ((5)) ((Cons ((-1)) ((Cons ((0)) ((Nil Unit)))))))), 9)
                , (((Nil Unit)), 0)
                , (((Cons ((-2)) ((Cons ((-4)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((1)) ((Cons ((3)) ((Cons ((3)) ((Nil Unit)))))))))))))))))), -69)
                ]
