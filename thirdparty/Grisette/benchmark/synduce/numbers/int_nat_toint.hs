        ...
        Add1 e' -> 
          let
            tmp2 =
              (f e')
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
        Sub1 e' -> 
          let
            tmp3 =
              (f e')
          in
          evalU2_0 (RefEnv [("tmp3", (Env0 tmp3))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(EInt, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                (((Add1 (Zero Unit))), (1))
                , (((Add1 (Add1 (Add1 (Sub1 (Sub1 (Add1 (Add1 (Add1 (Zero Unit)))))))))), (4))
                , (((Sub1 (Zero Unit))), (-1))
                , (((Zero Unit)), (0))
                , (((Add1 (Add1 (Sub1 (Sub1 (Zero Unit)))))), (0))
                , (((Sub1 (Zero Unit))), (-1))
                , (((Add1 (Sub1 (Sub1 (Sub1 (Add1 (Sub1 (Zero Unit)))))))), (-2))
                , (((Sub1 (Add1 (Add1 (Add1 (Sub1 (Add1 (Add1 (Zero Unit))))))))), (3))
                , (((Add1 (Sub1 (Sub1 (Add1 (Add1 (Sub1 (Add1 (Zero Unit))))))))), (1))
                , (((Sub1 (Add1 (Add1 (Sub1 (Zero Unit)))))), (0))
                , (((Sub1 (Add1 (Sub1 (Zero Unit))))), (-1))
                , (((Add1 (Sub1 (Add1 (Zero Unit))))), (1))
                , (((Zero Unit)), (0))
                , (((Sub1 (Sub1 (Sub1 (Add1 (Zero Unit)))))), (-2))
                , (((Add1 (Sub1 (Sub1 (Add1 (Add1 (Add1 (Sub1 (Zero Unit))))))))), (1))
                , (((Zero Unit)), (0))
                , (((Add1 (Add1 (Add1 (Add1 (Sub1 (Add1 (Add1 (Zero Unit))))))))), (5))
                , (((Add1 (Add1 (Sub1 (Sub1 (Add1 (Sub1 (Sub1 (Add1 (Zero Unit)))))))))), (0))
                , (((Sub1 (Add1 (Sub1 (Add1 (Zero Unit)))))), (0))
                , (((Sub1 (Zero Unit))), (-1))
                ]
