...
data Expr3_1
  = Param23_1
  | Prod3_1 (UnionM Expr3_2) (UnionM Expr3_0)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_0_1 e0_0] ++ [mrgMax0_1 e1_6 e1_7] ++ [mrgCmul0_1 e1_8 e1_9])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_1_1 e0_0] ++ [mrgMax1_1 e1_6 e1_7] ++ [mrgCmul1_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_2_1 e0_0] ++ [mrgMax2_1 e1_6 e1_7] ++ [mrgCmul2_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam03_0] ++ [mrgCzero3_0] ++ [mrgAl_inf3_0]
    genSingle1 = [mrgParam23_1]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_0 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess1_1_3_0 e1_0] ++ [mrgMax3_0 e0_6 e0_7] ++ [mrgCmul3_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgProd3_1 e2_0 e0_0])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgAccess0_1_3_2 e1_0] ++ [mrgCeq3_2 e0_0 e0_1] ++ [mrgCless3_2 e0_2 e0_3] ++ [mrgCleq3_2 e0_4 e0_5] ++ [mrgCand3_2 e2_0 e2_1] ++ [mrgCor3_2 e2_2 e2_3] ++ [mrgCnot3_2 e2_4])
        return res
...
eval3_1 env (Param23_1) = evalVar1 env "tmp6"
eval3_1 env (Prod3_1 p0 p1) = ((evalU3_2 env p0), (evalU3_0 env p1))
        ...
        Cons hd tl -> 
          let
            result =
              (f tl)
          in
          (((fst result) +  (hd *  (snd result))), (global0 *  (snd result)))
...
ioPair :: [((SymInteger, CList), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, CList), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((-5)), ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit))))), (0))
                , ((((-3)), ((Cnil Unit))), (0))
                , ((((-3)), ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Single (2))))) ((Cnil Unit))))))), (-1))
                , ((((0)), ((Single (5)))), (5))
                , ((((3)), ((Single (-2)))), (-2))
                , ((((1)), ((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit))))), (-5))
                , ((((-1)), ((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5)))))))), (1))
                , ((((3)), ((Concat ((Cnil Unit)) ((Single (1)))))), (1))
                , ((((-5)), ((Cnil Unit))), (0))
                , ((((3)), ((Concat ((Concat ((Concat ((Single (2))) ((Concat ((Single (4))) ((Single (4))))))) ((Single (-4))))) ((Cnil Unit))))), (98))
                , ((((-4)), ((Concat ((Cnil Unit)) ((Cnil Unit))))), (0))
                , ((((-3)), ((Concat ((Concat ((Cnil Unit)) ((Single (4))))) ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit))))))), (4))
                , ((((-3)), ((Concat ((Single (0))) ((Cnil Unit))))), (0))
                , ((((-3)), ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit))))))))), (0))
                , ((((2)), ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit))))), (0))
                , ((((-1)), ((Single (-3)))), (-3))
                , ((((5)), ((Concat ((Single (5))) ((Single (-3)))))), (22))
                , ((((2)), ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Concat ((Cnil Unit)) ((Single (-1))))) ((Cnil Unit))))))), (-1))
                , ((((-3)), ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Cnil Unit)))) ((Single (0)))))))), (-3))
                , ((((2)), ((Single (4)))), (4))
                ]
