  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e0_0 e2_4 e2_5] ++ [mrgAccess1_1_2_2 e1_0] ++ [mrgAccess2_1_2_2 e1_1])
        return res
...
data SList
  = Elt SymInteger
  | Cons SymInteger SList
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon SList, ExtractSymbolics)
    via (Default SList)
...
spec xs = 
  (get3from3 (let
    f xs = 
      case xs of
        Elt a -> (a, a, (toSym True))
        Cons hd tl -> 
          let
            result =
              (f tl)
          in
          (hd, (get2from3 result), ((get3from3 result) &&~  (hd <~  (get1from3 result))))
...
main = do
    let pairs = [
                (((Concat ((Concat ((Concat ((Single (1))) ((Single (5))))) ((Single (3))))) ((Single (1))))), (toSym False))
                , (((Single (-2))), (toSym True))
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Single (3))))), (toSym False))
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Single (-1))))))) ((Concat ((Single (5))) ((Single (3))))))), (toSym False))
                , (((Concat ((Concat ((Single (3))) ((Concat ((Single (-2))) ((Concat ((Single (-1))) ((Single (1))))))))) ((Single (3))))), (toSym False))
                , (((Concat ((Concat ((Single (4))) ((Single (-4))))) ((Concat ((Single (-4))) ((Single (2))))))), (toSym False))
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Single (-1))))))), (toSym False))
                , (((Concat ((Single (-2))) ((Single (-3))))), (toSym False))
                , (((Concat ((Single (-2))) ((Single (5))))), (toSym True))
                , (((Concat ((Single (2))) ((Concat ((Single (-1))) ((Single (-1))))))), (toSym False))
                , (((Single (2))), (toSym True))
                , (((Concat ((Concat ((Single (-3))) ((Concat ((Concat ((Single (-4))) ((Single (2))))) ((Single (0))))))) ((Single (-2))))), (toSym False))
                , (((Concat ((Concat ((Single (5))) ((Single (1))))) ((Concat ((Single (-4))) ((Single (-2))))))), (toSym False))
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (3))))))), (toSym False))
                , (((Concat ((Single (0))) ((Concat ((Single (1))) ((Concat ((Single (0))) ((Single (2))))))))), (toSym False))
                , (((Concat ((Concat ((Concat ((Single (-4))) ((Single (-3))))) ((Single (-3))))) ((Concat ((Single (1))) ((Single (-4))))))), (toSym False))
                , (((Single (-4))), (toSym True))
                , (((Concat ((Single (4))) ((Single (3))))), (toSym False))
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (2))))))), (toSym False))
                , (((Single (2))), (toSym True))
                ]
