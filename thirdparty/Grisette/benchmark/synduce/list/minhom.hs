...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam20_0] ++ [mrgCzero0_0]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam21_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
eval0_0 env (Param20_0) = evalVar0 env "a"
        ...
        Concat a b -> 
          ...
          let
            tmp3 =
              (f b)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("tmp3", (Env0 tmp3))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Concat ((Concat ((Concat ((Single (1))) ((Single (5))))) ((Single (3))))) ((Single (1))))), 1)
                , (((Single (-2))), -2)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Single (3))))), -5)
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Single (-1))))))) ((Concat ((Single (5))) ((Single (3))))))), -1)
                , (((Concat ((Concat ((Single (3))) ((Concat ((Single (-2))) ((Concat ((Single (-1))) ((Single (1))))))))) ((Single (3))))), -2)
                , (((Concat ((Concat ((Single (4))) ((Single (-4))))) ((Concat ((Single (-4))) ((Single (2))))))), -4)
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Single (-1))))))), -3)
                , (((Concat ((Single (-2))) ((Single (-3))))), -3)
                , (((Concat ((Single (-2))) ((Single (5))))), -2)
                , (((Concat ((Single (2))) ((Concat ((Single (-1))) ((Single (-1))))))), -1)
                , (((Single (2))), 2)
                , (((Concat ((Concat ((Single (-3))) ((Concat ((Concat ((Single (-4))) ((Single (2))))) ((Single (0))))))) ((Single (-2))))), -4)
                , (((Concat ((Concat ((Single (5))) ((Single (1))))) ((Concat ((Single (-4))) ((Single (-2))))))), -4)
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (3))))))), 1)
                , (((Concat ((Single (0))) ((Concat ((Single (1))) ((Concat ((Single (0))) ((Single (2))))))))), 0)
                , (((Concat ((Concat ((Concat ((Single (-4))) ((Single (-3))))) ((Single (-3))))) ((Concat ((Single (1))) ((Single (-4))))))), -4)
                , (((Single (-4))), -4)
                , (((Concat ((Single (4))) ((Single (3))))), 3)
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (2))))))), 1)
                , (((Single (2))), 2)
                ]
