        ...
        Concat a b -> 
          ...
          let
            tmp4 =
              (f b)
          in
          evalU2_0 (RefEnv [("tmp4", (Env0 tmp4)), ("tmp3", (Env0 tmp3))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
...
main' global0 x = 
  ...
  let
    tmp6 =
      (repr x)
  in
  evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp6", (Env0 tmp6))]) ((genSym (3::Int) "hole3") :: (UnionM Expr3_0))
...
ioPair pairs = do
    ...
    where
        ...
        constraint [] = con True
        constraint (((x, z), y) : xs) = main' x z ==~ (toSym y) &&~ constraint xs
...
main = do
    let pairs = [
                ...
                , ((((-3)), ((Cnil Unit))), (0))
                , ((((-3)), ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Single (2))))) ((Cnil Unit))))))), (3))
                , ((((0)), ((Single (5)))), (5))
                , ((((3)), ((Single (-2)))), (0))
                , ((((1)), ((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit))))), (5))
                , ((((-1)), ((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5)))))))), (9))
                , ((((3)), ((Concat ((Cnil Unit)) ((Single (1)))))), (0))
                , ((((-5)), ((Cnil Unit))), (0))
                , ((((3)), ((Concat ((Concat ((Concat ((Single (2))) ((Concat ((Single (4))) ((Single (4))))))) ((Single (-4))))) ((Cnil Unit))))), (8))
                ...
                , ((((-1)), ((Single (-3)))), (0))
                , ((((5)), ((Concat ((Single (5))) ((Single (-3)))))), (0))
                , ((((2)), ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Concat ((Cnil Unit)) ((Single (-1))))) ((Cnil Unit))))))), (0))
                , ((((-3)), ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Cnil Unit)))) ((Single (0)))))))), (1))
                , ((((2)), ((Single (4)))), (4))
                ]
