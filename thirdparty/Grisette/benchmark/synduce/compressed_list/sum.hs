...
repeat' :: SymInteger -> List -> Nat -> List
repeat' w xs n = 
  let
    f n xs = 
      case n of
        ...
        Ccons n h t -> 
          ...
          let
            tmp3 =
              (f t)
          in
          evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("h", (Env0 h)), ("w", (Env0 w))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Cnil Unit)), 0)
                , (((Cnil Unit)), 0)
                , (((Ccons ((S (Z Unit))) ((-3)) ((Ccons ((Z Unit)) ((-4)) ((Cnil Unit)))))), -3)
                , (((Ccons ((S (S (Z Unit)))) ((3)) ((Ccons ((Z Unit)) ((1)) ((Cnil Unit)))))), 6)
                , (((Ccons ((Z Unit)) ((-4)) ((Cnil Unit)))), 0)
                , (((Ccons ((S (S (S (S (S (Z Unit))))))) ((-2)) ((Ccons ((Z Unit)) ((4)) ((Cnil Unit)))))), -10)
                , (((Ccons ((Z Unit)) ((5)) ((Cnil Unit)))), 0)
                , (((Ccons ((S (S (S (Z Unit))))) ((5)) ((Cnil Unit)))), 15)
                , (((Ccons ((S (S (S (Z Unit))))) ((0)) ((Ccons ((S (Z Unit))) ((-2)) ((Cnil Unit)))))), -2)
                , (((Ccons ((S (S (S (S (S (Z Unit))))))) ((-5)) ((Cnil Unit)))), -25)
                , (((Ccons ((S (Z Unit))) ((4)) ((Ccons ((S (S (Z Unit)))) ((5)) ((Ccons ((Z Unit)) ((0)) ((Cnil Unit)))))))), 14)
                , (((Ccons ((S (Z Unit))) ((-4)) ((Ccons ((Z Unit)) ((-1)) ((Ccons ((S (Z Unit))) ((-3)) ((Cnil Unit)))))))), -7)
                , (((Ccons ((S (S (S (S (S (Z Unit))))))) ((3)) ((Cnil Unit)))), 15)
                , (((Ccons ((Z Unit)) ((5)) ((Ccons ((Z Unit)) ((5)) ((Cnil Unit)))))), 0)
                , (((Cnil Unit)), 0)
                , (((Ccons ((S (Z Unit))) ((-2)) ((Cnil Unit)))), -2)
                , (((Ccons ((S (S (Z Unit)))) ((-3)) ((Cnil Unit)))), -6)
                , (((Ccons ((S (S (S (Z Unit))))) ((-2)) ((Ccons ((Z Unit)) ((5)) ((Cnil Unit)))))), -6)
                , (((Ccons ((S (Z Unit))) ((1)) ((Cnil Unit)))), 1)
                , (((Cnil Unit)), 0)
                ]
