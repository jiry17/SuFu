...
eval1_1 env (Param11_1) = evalVar0 env "w"
...
eval2_0 env (Param32_0) = evalVar1 env "tmp2"
eval2_0 env (Param42_0) = evalVar1 env "tmp1"
...
eval3_1 env (Param13_1) = evalVar1 env "tmp3"
        ...
        Cons h t -> 
          let
            res =
              (f t)
          in
          ((max' (fst res) h), (max' (snd res) (min' (fst res) h)))
  ...
  let
    f c = 
      case c of
        ...
        Elt w -> 
          evalU1_0 (RefEnv [("w", (Env0 w))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
        Concat l r -> 
          let
            tmp1 =
              (f l)
          ...
          let
            tmp2 =
              (f r)
          in
          evalU2_0 (RefEnv [("tmp2", (Env1 tmp2)), ("tmp1", (Env1 tmp1))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
      
  in
  f 

main' c = 
  mrgIte (is_sorted (repr c))
    (let
      tmp3 =
        (target c)
    in
    evalU3_0 (RefEnv [("tmp3", (Env1 tmp3))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
main = do
    let pairs = [
                ((((Empty Unit))), (0))
                , ((((Concat ((Empty Unit)) ((Concat ((Concat ((Elt (1))) ((Elt (2))))) ((Empty Unit))))))), (0))
                , ((((Concat ((Elt (3))) ((Concat ((Elt (3))) ((Elt (1)))))))), (3))
                , ((((Elt (-2)))), (0))
                , ((((Concat ((Concat ((Elt (5))) ((Concat ((Elt (-3))) ((Concat ((Elt (-2))) ((Elt (-5))))))))) ((Empty Unit))))), (0))
                , ((((Concat ((Concat ((Elt (0))) ((Concat ((Elt (4))) ((Empty Unit)))))) ((Concat ((Empty Unit)) ((Elt (5)))))))), (0))
                , ((((Concat ((Empty Unit)) ((Elt (1)))))), (0))
                , ((((Empty Unit))), (0))
                , ((((Concat ((Concat ((Concat ((Elt (2))) ((Concat ((Elt (4))) ((Elt (4))))))) ((Elt (-4))))) ((Empty Unit))))), (0))
                , ((((Elt (-1)))), (0))
                , ((((Concat ((Elt (-3))) ((Concat ((Elt (4))) ((Empty Unit))))))), (0))
                , ((((Elt (4)))), (0))
                , ((((Concat ((Empty Unit)) ((Empty Unit))))), (0))
                , ((((Concat ((Elt (0))) ((Empty Unit))))), (0))
                , ((((Concat ((Empty Unit)) ((Concat ((Empty Unit)) ((Concat ((Empty Unit)) ((Empty Unit))))))))), (0))
                , ((((Concat ((Concat ((Concat ((Empty Unit)) ((Empty Unit)))) ((Empty Unit)))) ((Elt (-1)))))), (0))
                , ((((Elt (-3)))), (0))
                , ((((Concat ((Elt (5))) ((Elt (-3)))))), (0))
                , ((((Concat ((Concat ((Elt (5))) ((Concat ((Empty Unit)) ((Empty Unit)))))) ((Empty Unit))))), (0))
                , ((((Concat ((Empty Unit)) ((Concat ((Empty Unit)) ((Empty Unit))))))), (0))
                ]
