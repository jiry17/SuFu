  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd0_0 e0_0 e0_1] ++ [mrgCsub0_0 e0_2 e0_3] ++ [mrgCIte0_0 e1_0 e0_4 e0_5] ++ [mrgMin0_0 e0_6 e0_7])
        return res
    gen1 gendepth
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam11_0] ++ [mrgCzero1_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_7 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd1_0 e0_0 e0_1] ++ [mrgCsub1_0 e0_2 e0_3] ++ [mrgCIte1_0 e1_0 e0_4 e0_5] ++ [mrgMin1_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval2_0 env (Param12_0) = evalVar0 env "tmp1"
  ...
  mrgIte (is_sorted xs)
    (let
      tmp1 =
        (target xs)
    in
    evalU2_0 (RefEnv [("tmp1", (Env0 tmp1))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
    (0)
...
main = do
    let pairs = [
                ((((Cons ((-3)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((2)) ((Elt (5)))))))))))))))))))))), (-3))
                , ((((Cons ((-2)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((0)) ((Cons ((1)) ((Cons ((3)) ((Elt (3)))))))))))))))))))))), (-2))
                , ((((Cons ((-5)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((0)) ((Cons ((1)) ((Cons ((2)) ((Elt (4)))))))))))))))))), (-5))
                , ((((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((0)) ((Cons ((0)) ((Elt (1)))))))))))))))))), (-2))
                , ((((Cons ((-4)) ((Cons ((-4)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((0)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))))))))), (-4))
                , ((((Cons ((-5)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((2)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))))))))), (-5))
                , ((((Cons ((-4)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((1)) ((Cons ((2)) ((Cons ((2)) ((Cons ((2)) ((Elt (4)))))))))))))))))), (-4))
                , ((((Cons ((-2)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Elt (5)))))))))))))))))), (-2))
                , ((((Cons ((-5)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((0)) ((Cons ((1)) ((Cons ((1)) ((Cons ((3)) ((Elt (5)))))))))))))))))), (-5))
                , ((((Cons ((-3)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Elt (2)))))))))))))))), (-3))
                , ((((Cons ((-2)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-1)) ((Elt (3)))))))))))))))), (-2))
                , ((((Cons ((-3)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((1)) ((Elt (2)))))))))))))))), (-3))
                , ((((Cons ((-4)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((2)) ((Elt (5)))))))))))))))), (-4))
                , ((((Cons ((-5)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((1)) ((Elt (5)))))))))))))))), (-5))
                , ((((Cons ((-4)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((5)) ((Cons ((5)) ((Elt (5)))))))))))))))), (-4))
                , ((((Cons ((-4)) ((Cons ((-4)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((2)) ((Cons ((2)) ((Elt (5)))))))))))))))), (-4))
                , ((((Cons ((-5)) ((Cons ((-4)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((3)) ((Cons ((3)) ((Elt (5)))))))))))))))), (-5))
                , ((((Cons ((-3)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Elt (4)))))))))))))))), (-3))
                , ((((Cons ((-4)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))))))), (-4))
                , ((((Cons ((-5)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((4)) ((Elt (5)))))))))))))))), (-5))
                ]
