...
-- output_type: Int
-- param_list: global0 h xs t tmp1
data Expr1_0
  = Param01_0
  | Param11_0
  | Param41_0
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam11_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
eval3_0 env (Param23_0) = evalVar0 env "tmp3"
...
target global0 = 
  let
    f xs = 
      case xs of
        Elt w -> 
          evalU0_0 (RefEnv [("global0", (Env0 global0)), ("w", (Env0 w))]) ((genSym (3::Int) "hole0") :: (UnionM Expr0_0))
        Cons h t -> mrgIte (h <~  global0)
            (let
              tmp1 =
                (f t)
            in
            evalU1_0 (RefEnv [("global0", (Env0 global0)), ("h", (Env0 h)), ("tmp1", (Env0 tmp1))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0)))
            (evalU2_0 (RefEnv [("global0", (Env0 global0)), ("h", (Env0 h))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0)))
