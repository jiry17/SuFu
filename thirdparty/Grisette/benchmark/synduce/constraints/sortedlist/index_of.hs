...
eval2_0 env (Param42_0) = evalVar0 env "tmp1"
    ...
    f xs = 
      case xs of
        ...
        Cons h t -> mrgIte (h >=~  global0)
            (evalU1_0 (RefEnv [("global0", (Env0 global0)), ("h", (Env0 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp1 =
                (f t)
            in
            evalU2_0 (RefEnv [("global0", (Env0 global0)), ("h", (Env0 h)), ("tmp1", (Env0 tmp1))]) ((genSym (3::Int) "hole2") :: (UnionM Expr2_0)))
