  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd0_0 e0_0 e0_1] ++ [mrgCsub0_0 e0_2 e0_3] ++ [mrgCIte0_0 e1_0 e0_4 e0_5] ++ [mrgMax0_0 e0_6 e0_7] ++ [mrgMod20_0 e0_8])
        return res
    gen1 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_8 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd1_0 e0_0 e0_1] ++ [mrgCsub1_0 e0_2 e0_3] ++ [mrgCIte1_0 e1_0 e0_4 e0_5] ++ [mrgMax1_0 e0_6 e0_7] ++ [mrgMod21_0 e0_8])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgParam22_0] ++ [mrgCzero2_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_8 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e1_0 e0_4 e0_5] ++ [mrgMax2_0 e0_6 e0_7] ++ [mrgMod22_0 e0_8])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_8 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e1_0 e0_4 e0_5] ++ [mrgMax3_0 e0_6 e0_7] ++ [mrgMod23_0 e0_8])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval0_0 env (Param10_0) = evalVar0 env "w"
...
eval0_0 env (Mod20_0 p0) = mod2 (evalU0_0 env p0)
...
eval1_0 env (Mod21_0 p0) = mod2 (evalU1_0 env p0)
...
eval2_0 env (Mod22_0 p0) = mod2 (evalU2_0 env p0)
...
eval3_0 env (Mod23_0 p0) = mod2 (evalU3_0 env p0)
...
spec = 
  let
    f xs = 
      case xs of
        Elt x -> mrgIte ((0 ==~  (mod2 x)) &&~  (x >~  0))
            (x)
            (0)
        Cons h t -> mrgIte ((0 ==~  (mod2 h)) &&~  (h >~  0))
            (max' h (f t))
            (f t)
...
target = 
  let
    f xs = 
      case xs of
        Elt w -> 
          evalU0_0 (RefEnv [("w", (Env0 w))]) ((genSym (1::Int) "hole0") :: (UnionM Expr0_0))
        Cons h t -> mrgIte (h <=~  0)
            (evalU1_0 (RefEnv [("h", (Env0 h))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp1 =
                (f t)
            in
            evalU2_0 (RefEnv [("h", (Env0 h)), ("tmp1", (Env0 tmp1))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_sorted xs)
    (let
      tmp2 =
        (target xs)
    in
    evalU3_0 (RefEnv [("tmp2", (Env0 tmp2))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
main = do
    let pairs = [
                ((((Cons ((2)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-3)) ((Cons ((-4)) ((Cons ((-4)) ((Cons ((-5)) ((Elt (-5)))))))))))))))))))), (2))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((-5)) ((Cons ((-5)) ((Cons ((-5)) ((Elt (-5)))))))))))))))))), (4))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((3)) ((Cons ((2)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-5)) ((Elt (-5)))))))))))))))))), (4))
                , ((((Cons ((5)) ((Cons ((4)) ((Cons ((2)) ((Cons ((1)) ((Cons ((-1)) ((Cons ((-3)) ((Cons ((-4)) ((Elt (-4)))))))))))))))))), (4))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((0)) ((Cons ((0)) ((Cons ((0)) ((Cons ((-4)) ((Cons ((-4)) ((Elt (-4)))))))))))))))))), (4))
                , ((((Cons ((2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-5)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((2)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((-4)) ((Elt (-4)))))))))))))))), (2))
                , ((((Cons ((2)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((-5)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((5)) ((Cons ((4)) ((Cons ((-1)) ((Cons ((-2)) ((Cons ((-4)) ((Cons ((-4)) ((Elt (-4)))))))))))))))), (4))
                , ((((Cons ((3)) ((Cons ((2)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-2)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((5)) ((Cons ((3)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-1)) ((Elt (-2)))))))))))))))), (2))
                , ((((Cons ((4)) ((Cons ((0)) ((Cons ((0)) ((Cons ((-1)) ((Cons ((-5)) ((Cons ((-5)) ((Elt (-5)))))))))))))))), (4))
                , ((((Cons ((5)) ((Cons ((4)) ((Cons ((3)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((-3)) ((Elt (-3)))))))))))))))), (4))
                , ((((Cons ((5)) ((Cons ((2)) ((Cons ((2)) ((Cons ((2)) ((Cons ((-2)) ((Cons ((-4)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((3)) ((Cons ((2)) ((Cons ((1)) ((Cons ((1)) ((Cons ((-3)) ((Cons ((-3)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((5)) ((Cons ((2)) ((Cons ((1)) ((Cons ((0)) ((Cons ((-1)) ((Cons ((-3)) ((Elt (-5)))))))))))))))), (2))
                , ((((Cons ((2)) ((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((-2)) ((Elt (-3)))))))))))))))), (2))
                , ((((Cons ((5)) ((Cons ((4)) ((Cons ((3)) ((Cons ((1)) ((Cons ((0)) ((Cons ((-2)) ((Elt (-5)))))))))))))))), (4))
                , ((((Cons ((5)) ((Cons ((4)) ((Cons ((0)) ((Cons ((0)) ((Cons ((0)) ((Cons ((-1)) ((Elt (-5)))))))))))))))), (4))
                , ((((Cons ((5)) ((Cons ((5)) ((Cons ((2)) ((Cons ((1)) ((Cons ((0)) ((Cons ((-2)) ((Elt (-5)))))))))))))))), (2))
                ]
