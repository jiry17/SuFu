...
eval1_0 env (Param31_0) = evalVar0 env "aux"
eval1_0 env (Param41_0) = evalVar0 env "h"
        ...
        Cons h t -> 
          ...
          let
            newmin =
              (min' h (get3from3 res))
          in
          ((max' (get1from3 res) (newmax -  newmin)), newmax, newmin)
        ...
        Cons h t -> 
          ...
          let
            tmp1 =
              (Cons h t)
          in
          evalU1_0 (RefEnv [("aux", (Env0 aux)), ("h", (Env0 h))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
      
  in
  f 

main' xs = 
  mrgIte ((is_sorted xs) &&~  (is_pos xs))
    (let
      tmp2 =
        (target xs)
    in
...
main = do
    let pairs = [
                ((((Cons ((1)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))))))), (4))
                , ((((Cons ((3)) ((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Elt (4)))))))))))))), (1))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))))), (4))
                , ((((Cons ((2)) ((Cons ((2)) ((Cons ((2)) ((Cons ((4)) ((Elt (5)))))))))))), (3))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Cons ((3)) ((Elt (4)))))))))))), (3))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))), (4))
                , ((((Cons ((2)) ((Cons ((2)) ((Cons ((3)) ((Cons ((3)) ((Elt (3)))))))))))), (1))
                , ((((Cons ((1)) ((Cons ((2)) ((Cons ((3)) ((Cons ((3)) ((Elt (5)))))))))))), (4))
                , ((((Cons ((1)) ((Cons ((2)) ((Cons ((3)) ((Cons ((4)) ((Elt (5)))))))))))), (4))
                , ((((Cons ((1)) ((Cons ((3)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))), (4))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((3)) ((Elt (5)))))))))))), (4))
                , ((((Cons ((3)) ((Cons ((3)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))), (2))
                , ((((Cons ((1)) ((Cons ((2)) ((Cons ((4)) ((Cons ((4)) ((Elt (4)))))))))))), (3))
                , ((((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))), (2))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Elt (5)))))))))))), (1))
                , ((((Cons ((2)) ((Cons ((3)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))), (3))
                , ((((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((5)) ((Elt (5)))))))))))), (2))
                , ((((Cons ((2)) ((Cons ((2)) ((Cons ((3)) ((Cons ((4)) ((Elt (5)))))))))))), (3))
                , ((((Cons ((3)) ((Cons ((3)) ((Cons ((3)) ((Cons ((5)) ((Elt (5)))))))))))), (2))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((2)) ((Cons ((2)) ((Elt (5)))))))))))), (4))
                ]
