        ...
        Nil _ -> 
          let
            tmp1 =
              (Nil Unit)
          in
          evalU0_0 (RefEnv [("global0", (Env0 global0))]) ((genSym (2::Int) "hole0") :: (UnionM Expr0_0))
        Cons h t -> mrgIte (h ==~  global0)
            (let
              tmp2 =
                (Cons h t)
            in
            evalU1_0 (RefEnv [("global0", (Env0 global0)), ("h", (Env0 h))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp3 =
                (f t)
            in
            evalU2_0 (RefEnv [("h", (Env0 h)), ("global0", (Env0 global0)), ("tmp3", (Env0 tmp3))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_unique xs)
    ...
    let
      tmp5 =
        (target global0 xs)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp5", (Env0 tmp5))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
main = do
    let pairs = [
                ((((-5)), ((Nil Unit))), (0))
                , ((((4)), ((Cons ((-2)) ((Cons ((0)) ((Cons ((-4)) ((Cons ((3)) ((Cons ((5)) ((Nil Unit))))))))))))), (0))
                , ((((1)), ((Nil Unit))), (0))
                , ((((1)), ((Cons ((5)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((1)) ((Nil Unit))))))))))))), (1))
                , ((((-5)), ((Cons ((5)) ((Nil Unit))))), (0))
                , ((((4)), ((Cons ((5)) ((Nil Unit))))), (0))
                , ((((0)), ((Cons ((-2)) ((Cons ((5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-5)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((3)) ((Nil Unit))))))))))))))))))), (0))
                , ((((-2)), ((Cons ((4)) ((Nil Unit))))), (0))
                , ((((3)), ((Cons ((-5)) ((Nil Unit))))), (0))
                , ((((3)), ((Cons ((-2)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((3)) ((Cons ((4)) ((Nil Unit))))))))))))))))))), (1))
                , ((((-4)), ((Cons ((3)) ((Cons ((-4)) ((Nil Unit))))))), (1))
                , ((((-2)), ((Cons ((-2)) ((Nil Unit))))), (1))
                , ((((4)), ((Cons ((-3)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((-1)) ((Nil Unit))))))))))), (0))
                , ((((-2)), ((Cons ((4)) ((Nil Unit))))), (0))
                , ((((-3)), ((Nil Unit))), (0))
                , ((((3)), ((Nil Unit))), (0))
                , ((((0)), ((Cons ((-5)) ((Cons ((5)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((5)) ((Cons ((1)) ((Cons ((4)) ((Cons ((-2)) ((Cons ((-2)) ((Nil Unit))))))))))))))))))))), (0))
                , ((((-4)), ((Cons ((-1)) ((Cons ((-3)) ((Cons ((-5)) ((Nil Unit))))))))), (0))
                , ((((2)), ((Cons ((0)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((2)) ((Cons ((3)) ((Cons ((4)) ((Cons ((2)) ((Cons ((-2)) ((Nil Unit))))))))))))))))))))), (0))
                , ((((3)), ((Cons ((3)) ((Nil Unit))))), (1))
                ]
