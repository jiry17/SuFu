...
-- output_type: Int
-- param_list: r t l tmp3 a global0 tmp2
data Expr1_0
  = Param31_0
  | Param41_0
  | Param51_0
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam12_0] ++ [mrgParam32_0] ++ [mrgParam42_0] ++ [mrgCzero2_0]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam13_0] ++ [mrgParam23_0] ++ [mrgCzero3_0]
...
eval2_0 env (Param12_0) = evalVar0 env "a"
...
eval3_0 env (Param13_0) = evalVar0 env "tmp6"
        ...
        Node a l r -> mrgIte (a <~  global0)
            ...
            let
              tmp3 =
                (f r)
            in
            evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("a", (Env0 a)), ("global0", (Env0 global0)), ("tmp2", (Env0 tmp2))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp4 =
                (f l)
            in
            evalU2_0 (RefEnv [("a", (Env0 a)), ("global0", (Env0 global0)), ("tmp4", (Env0 tmp4))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_bst t)
    ...
    let
      tmp6 =
        (target global0 t)
    in
    evalU3_0 (RefEnv [("tmp6", (Env0 tmp6)), ("global0", (Env0 global0))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
main = do
    let pairs = [
                ((((3)), ((Node ((-4)) ((Leaf (-4))) ((Node ((-4)) ((Leaf (-4))) ((Node ((3)) ((Leaf (-2))) ((Leaf (4)))))))))), (5))
                , ((((-1)), ((Node ((1)) ((Node ((-1)) ((Node ((-2)) ((Leaf (-4))) ((Leaf (-1))))) ((Leaf (1))))) ((Leaf (1)))))), (2))
                , ((((2)), ((Node ((-2)) ((Node ((-3)) ((Leaf (-5))) ((Leaf (-2))))) ((Node ((3)) ((Leaf (0))) ((Leaf (4)))))))), (5))
                , ((((-3)), ((Node ((5)) ((Node ((1)) ((Node ((-5)) ((Leaf (-5))) ((Leaf (-5))))) ((Leaf (5))))) ((Leaf (5)))))), (3))
                , ((((-1)), ((Node ((-1)) ((Leaf (-3))) ((Node ((0)) ((Leaf (-1))) ((Node ((2)) ((Leaf (1))) ((Leaf (5)))))))))), (1))
                , ((((-2)), ((Node ((2)) ((Node ((-5)) ((Leaf (-5))) ((Node ((1)) ((Leaf (-2))) ((Leaf (2))))))) ((Leaf (3)))))), (2))
                , ((((1)), ((Node ((3)) ((Node ((-2)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-4))))) ((Leaf (0))))) ((Leaf (3)))))), (5))
                , ((((-2)), ((Node ((-2)) ((Leaf (-5))) ((Node ((3)) ((Node ((1)) ((Leaf (-2))) ((Leaf (1))))) ((Leaf (3)))))))), (1))
                , ((((-1)), ((Node ((-2)) ((Leaf (-2))) ((Node ((1)) ((Leaf (1))) ((Node ((4)) ((Leaf (3))) ((Leaf (4)))))))))), (2))
                , ((((5)), ((Node ((3)) ((Node ((-2)) ((Leaf (-4))) ((Node ((1)) ((Leaf (-2))) ((Leaf (3))))))) ((Leaf (3)))))), (7))
                , ((((5)), ((Node ((0)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-1))))) ((Node ((4)) ((Leaf (0))) ((Leaf (5)))))))), (6))
                , ((((4)), ((Node ((-4)) ((Leaf (-5))) ((Node ((1)) ((Node ((1)) ((Leaf (1))) ((Leaf (1))))) ((Leaf (2)))))))), (7))
                , ((((3)), ((Node ((-2)) ((Node ((-5)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (-2)))))), (5))
                , ((((-1)), ((Node ((-1)) ((Node ((-3)) ((Leaf (-4))) ((Leaf (-2))))) ((Leaf (1)))))), (3))
                , ((((-3)), ((Node ((-4)) ((Leaf (-4))) ((Node ((-3)) ((Leaf (-4))) ((Leaf (1)))))))), (3))
                , ((((3)), ((Node ((-2)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (-1)))))), (5))
                , ((((4)), ((Node ((-2)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (-1)))))), (5))
                , ((((-2)), ((Node ((-1)) ((Node ((-3)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (5)))))), (2))
                , ((((-1)), ((Node ((-3)) ((Leaf (-5))) ((Node ((-1)) ((Leaf (-2))) ((Leaf (3)))))))), (3))
                , ((((-3)), ((Node ((-1)) ((Node ((-4)) ((Leaf (-4))) ((Leaf (-1))))) ((Leaf (5)))))), (2))
                ]
