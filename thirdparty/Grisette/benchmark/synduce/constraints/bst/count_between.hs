...
-- output_type: Int
-- param_list: tmp1 t x global0 global1
data Expr0_0
  = Param20_0
  | Param30_0
  | Param40_0
...
-- output_type: Int
-- param_list: r t l a global1 global0 tmp2
data Expr1_0
  = Param31_0
  | Param41_0
  | Param51_0
...
-- output_type: Int
-- param_list: r t l tmp3 a global1 global0
data Expr2_0
  = Param32_0
  | Param42_0
  | Param52_0
...
-- output_type: Int
-- param_list: r t tmp4 a l global0 global1 tmp5
data Expr3_0
  = Param23_0
  | Param33_0
  | Param53_0
...
-- output_type: Int
-- param_list: tmp7 t global1 global0
data Expr4_0
  = Param04_0
  | Param24_0
  | Param34_0
...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam20_0] ++ [mrgParam30_0] ++ [mrgParam40_0] ++ [mrgCzero0_0]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam31_0] ++ [mrgParam41_0] ++ [mrgParam51_0] ++ [mrgParam61_0] ++ [mrgCzero1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam32_0] ++ [mrgParam42_0] ++ [mrgParam52_0] ++ [mrgParam62_0] ++ [mrgCzero2_0]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam23_0] ++ [mrgParam33_0] ++ [mrgParam53_0] ++ [mrgParam63_0] ++ [mrgParam73_0] ++ [mrgCzero3_0]
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam04_0] ++ [mrgParam24_0] ++ [mrgParam34_0] ++ [mrgCzero4_0]
...
eval0_0 env (Param40_0) = evalVar0 env "global1"
...
eval1_0 env (Param31_0) = evalVar0 env "a"
eval1_0 env (Param41_0) = evalVar0 env "global1"
eval1_0 env (Param51_0) = evalVar0 env "global0"
eval1_0 env (Param61_0) = evalVar0 env "tmp2"
...
eval2_0 env (Param42_0) = evalVar0 env "a"
eval2_0 env (Param52_0) = evalVar0 env "global1"
eval2_0 env (Param62_0) = evalVar0 env "global0"
...
eval3_0 env (Param23_0) = evalVar0 env "tmp4"
eval3_0 env (Param33_0) = evalVar0 env "a"
eval3_0 env (Param53_0) = evalVar0 env "global0"
eval3_0 env (Param63_0) = evalVar0 env "global1"
eval3_0 env (Param73_0) = evalVar0 env "tmp5"
...
eval4_0 env (Param04_0) = evalVar0 env "tmp7"
eval4_0 env (Param24_0) = evalVar0 env "global1"
eval4_0 env (Param34_0) = evalVar0 env "global0"
...
{-
Hole grammar for #0
tmp1 t x global0 global1 

Hole grammar for #1
r t l a global1 global0 tmp2 

Hole grammar for #2
r t l tmp3 a global1 global0 

Hole grammar for #3
r t tmp4 a l global0 global1 tmp5 

Hole grammar for #4
tmp7 t global1 global0 
-}
...
spec :: SymInteger -> SymInteger -> Tree -> SymInteger
spec global0 global1 = 
  let
    f t = 
      case t of
        Leaf x -> mrgIte ((x >~  global0) &&~  (x <~  global1))
            (1)
            (0)
        Node a l r -> (mrgIte ((a >~  global0) &&~  (a <~  global1))
            (1)
            (0)) +  ((f l) +  (f r))
        ...
        Leaf x -> 
          let
            tmp1 =
              (Leaf x)
          in
          evalU0_0 (RefEnv [("x", (Env0 x)), ("global0", (Env0 global0)), ("global1", (Env0 global1))]) ((genSym (1::Int) "hole0") :: (UnionM Expr0_0))
        Node a l r -> mrgIte (a <=~  global0)
            (let
              tmp2 =
                (f r)
            in
            evalU1_0 (RefEnv [("a", (Env0 a)), ("global1", (Env0 global1)), ("global0", (Env0 global0)), ("tmp2", (Env0 tmp2))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0)))
            (mrgIte (a >=~  global1)
              (let
                tmp3 =
                  (f l)
              in
              evalU2_0 (RefEnv [("tmp3", (Env0 tmp3)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
              (let
                tmp4 =
                  (f l)
              in
              let
                tmp5 =
                  (f r)
              in
              evalU3_0 (RefEnv [("tmp4", (Env0 tmp4)), ("a", (Env0 a)), ("global0", (Env0 global0)), ("global1", (Env0 global1)), ("tmp5", (Env0 tmp5))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0))))
...
main' global0 global1 t = 
  mrgIte (is_bst t)
    ...
    in
    evalU4_0 (RefEnv [("tmp7", (Env0 tmp7)), ("global1", (Env0 global1)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole4") :: (UnionM Expr4_0)))
    (0)
...
ioPair :: [((SymInteger, SymInteger, Tree), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, SymInteger, Tree), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((0)), ((3)), ((Node ((4)) ((Node ((-1)) ((Node ((-3)) ((Leaf (-5))) ((Leaf (-3))))) ((Node ((2)) ((Leaf (1))) ((Leaf (2))))))) ((Leaf (4)))))), (3))
                , ((((-3)), ((0)), ((Node ((-2)) ((Leaf (-3))) ((Node ((-2)) ((Leaf (-2))) ((Node ((2)) ((Leaf (-2))) ((Leaf (3)))))))))), (4))
                , ((((-4)), ((4)), ((Node ((0)) ((Node ((-2)) ((Leaf (-3))) ((Leaf (0))))) ((Node ((0)) ((Leaf (0))) ((Leaf (3)))))))), (7))
                , ((((-3)), ((4)), ((Node ((-1)) ((Node ((-2)) ((Leaf (-4))) ((Leaf (-1))))) ((Leaf (-1)))))), (4))
                , ((((-5)), ((-2)), ((Node ((-3)) ((Leaf (-4))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (4)))))))), (4))
                , ((((-4)), ((-1)), ((Node ((0)) ((Node ((-2)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (2)))))), (2))
                , ((((-1)), ((3)), ((Node ((-5)) ((Leaf (-5))) ((Node ((-1)) ((Leaf (-4))) ((Leaf (1)))))))), (1))
                , ((((-2)), ((2)), ((Node ((-4)) ((Leaf (-5))) ((Node ((-1)) ((Leaf (-3))) ((Leaf (1)))))))), (2))
                , ((((-5)), ((-3)), ((Node ((-4)) ((Leaf (-5))) ((Node ((5)) ((Leaf (-3))) ((Leaf (5)))))))), (1))
                , ((((-1)), ((3)), ((Node ((-5)) ((Leaf (-5))) ((Node ((-4)) ((Leaf (-4))) ((Leaf (0)))))))), (1))
                , ((((-5)), ((-2)), ((Node ((-4)) ((Leaf (-4))) ((Node ((2)) ((Leaf (-4))) ((Leaf (3)))))))), (3))
                , ((((-3)), ((3)), ((Node ((-2)) ((Node ((-4)) ((Leaf (-4))) ((Leaf (-4))))) ((Leaf (1)))))), (2))
                , ((((-5)), ((2)), ((Node ((-3)) ((Leaf (-5))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (1)))))))), (4))
                , ((((-5)), ((-1)), ((Node ((1)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-1))))) ((Leaf (4)))))), (1))
                , ((((-3)), ((2)), ((Node ((-1)) ((Node ((-2)) ((Leaf (-2))) ((Leaf (-2))))) ((Leaf (2)))))), (4))
                , ((((-3)), ((3)), ((Node ((-2)) ((Leaf (-4))) ((Node ((-1)) ((Leaf (-1))) ((Leaf (2)))))))), (4))
                , ((((-3)), ((5)), ((Node ((-4)) ((Leaf (-4))) ((Node ((-1)) ((Leaf (-1))) ((Leaf (3)))))))), (3))
                , ((((-5)), ((-3)), ((Node ((-4)) ((Leaf (-5))) ((Node ((2)) ((Leaf (-4))) ((Leaf (5)))))))), (2))
                , ((((-4)), ((-1)), ((Node ((-3)) ((Leaf (-4))) ((Node ((0)) ((Leaf (-2))) ((Leaf (3)))))))), (2))
                , ((((-4)), ((1)), ((Node ((-5)) ((Leaf (-5))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (2)))))))), (2))
                ]
