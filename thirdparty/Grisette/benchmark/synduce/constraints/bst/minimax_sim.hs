...
-- output_type: {Int,Int}
-- param_list: r t tmp2 lmin l rmax a
data Expr1_0
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam31_1] ++ [mrgParam51_1] ++ [mrgParam61_1] ++ [mrgCzero1_1]
...
eval1_1 env (Param31_1) = evalVar0 env "lmin"
eval1_1 env (Param51_1) = evalVar0 env "rmax"
eval1_1 env (Param61_1) = evalVar0 env "a"
        ...
        Node a l r -> 
          ...
          let
            tmp2 =
              (Node a l r)
          in
          evalU1_0 (RefEnv [("lmin", (Env0 lmin)), ("rmax", (Env0 rmax)), ("a", (Env0 a))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
