        ...
        Ncons h t -> 
          ...
          let
            tres =
              (f t)
          in
          ((max' ((snd tres) +  hsum) (fst tres)), ((snd tres) +  hsum))
...
main = do
    let pairs = [
                ((((Cat ((Sglt (Cons ((5)) ((Cons ((-3)) ((Elt (-1)))))))) ((Cat ((Sglt (Elt (4)))) ((Sglt (Elt (-4))))))))), (1))
                , ((((Cat ((Sglt (Elt (-1)))) ((Sglt (Elt (5))))))), (5))
                ...
                , ((((Cat ((Cat ((Sglt (Elt (-2)))) ((Sglt (Elt (3)))))) ((Sglt (Elt (-3))))))), (0))
                , ((((Sglt (Elt (3))))), (3))
                , ((((Sglt (Cons ((-1)) ((Cons ((-1)) ((Cons ((-2)) ((Cons ((2)) ((Cons ((4)) ((Cons ((3)) ((Elt (0))))))))))))))))), (5))
                , ((((Sglt (Elt (2))))), (2))
                , ((((Cat ((Sglt (Cons ((3)) ((Cons ((-5)) ((Elt (-4)))))))) ((Sglt (Cons ((2)) ((Elt (1))))))))), (3))
                , ((((Cat ((Sglt (Elt (-4)))) ((Sglt (Cons ((0)) ((Elt (1))))))))), (1))
                ]
