...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam21_0] ++ [mrgParam31_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
eval1_0 env (Param21_0) = evalVar0 env "tmp3"
eval1_0 env (Param31_0) = evalVar0 env "tmp2"
eval1_0 env (Param41_0) = evalVar0 env "w"
...
balanced = 
  let
    f t = 
      case t of
        Nil _ -> (toSym True)
        Node w l r -> (((height l) ==~  (height r)) &&~  (f l)) &&~  (f r)
        ...
        Node w l r -> 
          ...
          let
            tmp3 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("tmp2", (Env0 tmp2)), ("w", (Env0 w))]) ((genSym (3::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                ...
                , ((((Node ((-1)) ((Nil Unit)) ((Node ((4)) ((Nil Unit)) ((Node ((2)) ((Nil Unit)) ((Nil Unit))))))))), (0))
                , ((((Nil Unit))), (0))
                , ((((Nil Unit))), (0))
                , ((((Node ((-2)) ((Node ((5)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))))) ((Nil Unit)))) ((Nil Unit))))), (0))
                , ((((Node ((-4)) ((Node ((0)) ((Node ((0)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Node ((2)) ((Nil Unit)) ((Nil Unit))))))), (0))
                , ((((Node ((-5)) ((Nil Unit)) ((Nil Unit))))), (1))
                , ((((Nil Unit))), (0))
                , ((((Node ((3)) ((Node ((5)) ((Nil Unit)) ((Node ((0)) ((Nil Unit)) ((Node ((4)) ((Nil Unit)) ((Nil Unit)))))))) ((Nil Unit))))), (0))
                , ((((Nil Unit))), (0))
                , ((((Node ((1)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit))))))), (0))
                , ((((Nil Unit))), (0))
                , ((((Node ((0)) ((Nil Unit)) ((Nil Unit))))), (1))
                , ((((Node ((4)) ((Nil Unit)) ((Nil Unit))))), (1))
                , ((((Node ((-1)) ((Nil Unit)) ((Node ((-5)) ((Nil Unit)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit))))))))), (0))
                , ((((Node ((-4)) ((Nil Unit)) ((Node ((-1)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit))))))), (0))
                , ((((Node ((5)) ((Nil Unit)) ((Nil Unit))))), (1))
                , ((((Node ((-1)) ((Node ((5)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (0))
                , ((((Nil Unit))), (0))
                , ((((Node ((-1)) ((Nil Unit)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit))))))))), (0))
                ]
