...
eval0_1 env (Param20_1) = evalVar0 env "i"
...
eval2_0 env (Param22_0) = evalVar1 env "tmp5"
eval2_0 env (Param42_0) = evalVar1 env "tmp4"
...
data ArithExpr
  ...
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon ArithExpr, ExtractSymbolics)
    via (Default ArithExpr)
...
data PsumExpr
  ...
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon PsumExpr, ExtractSymbolics)
    via (Default PsumExpr)
{-
        ...
        Nint i -> 
          let
            tmp1 =
              (Int i)
          in
          evalU0_0 (RefEnv [("i", (Env0 i))]) ((genSym (1::Int) "hole0") :: (UnionM Expr0_0))
        Nplus e1 e2 -> 
          let
            tmp2 =
              (f e1)
        ...
        Nminus e1 e2 -> 
          ...
          let
            tmp5 =
              (f e2)
          in
          evalU2_0 (RefEnv [("tmp5", (Env1 tmp5)), ("tmp4", (Env1 tmp4))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
...
main' e = 
  let
    tmp6 =
      (repr e)
  in
  evalU3_0 (RefEnv [("tmp6", (Env1 tmp6))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(PsumExpr, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                (((Nminus ((Nminus ((Nint (-4))) ((Nint (3))))) ((Nminus ((Nint (3))) ((Nint (1))))))), 3)
                , (((Nint (-2))), -2)
                , (((Nminus ((Nplus ((Nminus ((Nint (-5))) ((Nint (-3))))) ((Nplus ((Nint (-2))) ((Nint (-5))))))) ((Nint (3))))), 3)
                , (((Nminus ((Nint (5))) ((Nminus ((Nint (0))) ((Nminus ((Nplus ((Nint (-2))) ((Nint (5))))) ((Nint (3))))))))), 5)
                , (((Nminus ((Nplus ((Nint (3))) ((Nplus ((Nint (-2))) ((Nplus ((Nint (-1))) ((Nint (1))))))))) ((Nint (3))))), 3)
                , (((Nminus ((Nint (3))) ((Nminus ((Nminus ((Nint (-2))) ((Nint (-4))))) ((Nint (2))))))), 3)
                , (((Nplus ((Nint (-3))) ((Nminus ((Nint (4))) ((Nint (-1))))))), 5)
                , (((Nminus ((Nint (-2))) ((Nint (-3))))), 1)
                , (((Nplus ((Nint (-2))) ((Nint (5))))), 5)
                , (((Nplus ((Nint (2))) ((Nplus ((Nint (-1))) ((Nint (-1))))))), 2)
                , (((Nint (2))), 2)
                , (((Nminus ((Nplus ((Nplus ((Nint (5))) ((Nint (3))))) ((Nplus ((Nint (2))) ((Nint (0))))))) ((Nint (-2))))), 12)
                , (((Nplus ((Nminus ((Nint (5))) ((Nplus ((Nint (5))) ((Nint (-4))))))) ((Nint (-2))))), 5)
                , (((Nplus ((Nint (1))) ((Nplus ((Nint (1))) ((Nint (3))))))), 5)
                , (((Nplus ((Nint (0))) ((Nplus ((Nminus ((Nint (-1))) ((Nint (0))))) ((Nint (2))))))), 2)
                , (((Nminus ((Nminus ((Nint (4))) ((Nint (3))))) ((Nplus ((Nint (-3))) ((Nminus ((Nint (1))) ((Nint (-4))))))))), 5)
                , (((Nint (-4))), -4)
                , (((Nminus ((Nint (4))) ((Nint (3))))), 4)
                , (((Nplus ((Nint (1))) ((Nplus ((Nint (1))) ((Nint (2))))))), 4)
                , (((Nint (2))), 2)
                ]
