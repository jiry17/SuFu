...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam00_0] ++ [mrgParam10_0] ++ [mrgCzero0_0] ++ [mrgAl_inf0_0]
...
repr = 
  let
    f pre xs = 
      case xs of
        Nil _ -> pre
        Cons h t -> f (evalU0_0 (RefEnv [("pre", (Env0 pre)), ("h", (Env0 h))]) ((genSym (5::Int) "hole0") :: (UnionM Expr0_0))) t
  in
  f  (let
    tmp1 =
      (Nil Unit)
