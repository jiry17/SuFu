...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam22_0] ++ [mrgParam42_0]
    genSingle1 = [mrgParam52_1] ++ [mrgCzero2_1]
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_3_0 e1_0] ++ [mrgAccess1_1_3_0 e1_1] ++ [mrgAccess2_1_3_0 e1_2] ++ [mrgMax3_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval2_0 env (Param22_0) = evalVar1 env "tmp4"
...
eval3_0 env (Access0_1_3_0 p0) = get1from3 (evalU3_1 env p0)
eval3_0 env (Access1_1_3_0 p0) = get2from3 (evalU3_1 env p0)
eval3_0 env (Access2_1_3_0 p0) = get3from3 (evalU3_1 env p0)
...
spec t = 
  (snd (let
    f s t = 
      case t of
        Nil _ -> s
        Single a -> (((fst s) +  a), (max' (snd s) ((fst s) +  a)))
        Node a l r -> f (f (((fst s) +  a), (max' (snd s) ((fst s) +  a))) l) r
        ...
        Single a -> 
          let
            tmp2 =
              (Single a)
          in
          evalU1_0 (RefEnv [("a", (Env0 a))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
        Node a l r -> 
          let
            tmp3 =
              (f l)
          ...
          let
            tmp4 =
              (f r)
          in
          evalU2_0 (RefEnv [("tmp4", (Env1 tmp4)), ("tmp3", (Env1 tmp3)), ("a", (Env0 a))]) ((genSym (2::Int) "hole2") :: (UnionM Expr2_0))
...
main = do
    let pairs = [
                (((Node ((-1)) ((Single (-1))) ((Node ((1)) ((Node ((2)) ((Nil Unit)) ((Single (0))))) ((Single (-4))))))), (1))
                , (((Single (-2))), (0))
                , (((Node ((-2)) ((Node ((5)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Single (-5))))))) ((Nil Unit)))) ((Single (-1))))), (9))
                , (((Node ((-4)) ((Node ((0)) ((Node ((0)) ((Single (-2))) ((Nil Unit)))) ((Nil Unit)))) ((Node ((5)) ((Nil Unit)) ((Single (-2))))))), (0))
                , (((Node ((-5)) ((Node ((3)) ((Nil Unit)) ((Node ((-2)) ((Node ((3)) ((Nil Unit)) ((Single (1))))) ((Single (3))))))) ((Nil Unit)))), (3))
                , (((Node ((4)) ((Node ((4)) ((Single (-4))) ((Nil Unit)))) ((Node ((-4)) ((Nil Unit)) ((Single (-1))))))), (8))
                , (((Node ((1)) ((Nil Unit)) ((Node ((1)) ((Single (-3))) ((Nil Unit)))))), (2))
                , (((Node ((3)) ((Nil Unit)) ((Nil Unit)))), (3))
                , (((Node ((-3)) ((Single (-2))) ((Node ((5)) ((Single (0))) ((Nil Unit)))))), (0))
                , (((Node ((-1)) ((Nil Unit)) ((Node ((-5)) ((Nil Unit)) ((Node ((-3)) ((Single (0))) ((Single (2))))))))), (0))
                , (((Single (-1))), (0))
                , (((Single (-3))), (0))
                , (((Node ((5)) ((Single (2))) ((Nil Unit)))), (7))
                , (((Node ((-1)) ((Node ((5)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))), (4))
                , (((Single (-1))), (0))
                , (((Node ((-1)) ((Single (-2))) ((Node ((1)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))) ((Single (-4))))))), (0))
                , (((Node ((3)) ((Node ((4)) ((Nil Unit)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit)))))) ((Node ((-3)) ((Single (1))) ((Nil Unit)))))), (7))
                , (((Nil Unit)), (0))
                , (((Node ((-4)) ((Single (0))) ((Single (5))))), (1))
                , (((Single (3))), (3))
                ]
