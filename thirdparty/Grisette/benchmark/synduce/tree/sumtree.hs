...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam21_0] ++ [mrgParam41_0] ++ [mrgParam51_0] ++ [mrgCzero1_0]
...
eval1_0 env (Param51_0) = evalVar0 env "a"
        ...
        Node a l r -> 
          ...
          let
            tmp3 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("tmp3", (Env0 tmp3)), ("a", (Env0 a))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Node ((-3)) ((Nil Unit)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))))), (-7))
                ...
                , (((Node ((-1)) ((Nil Unit)) ((Node ((-5)) ((Nil Unit)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit)))))))), (-9))
                , (((Node ((-4)) ((Nil Unit)) ((Node ((-1)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))))), (-9))
                , (((Node ((5)) ((Nil Unit)) ((Nil Unit)))), (5))
