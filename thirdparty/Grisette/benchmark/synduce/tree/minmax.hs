  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_0_1 e0_0] ++ [mrgAccess1_0_0_1 e0_1] ++ [mrgMax0_1 e1_6 e1_7] ++ [mrgMin0_1 e1_8 e1_9])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_1_1 e0_0] ++ [mrgAccess1_0_1_1 e0_1] ++ [mrgMax1_1 e1_6 e1_7] ++ [mrgMin1_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1] ++ [mrgMax2_1 e1_6 e1_7] ++ [mrgMin2_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
eval0_1 env (Param20_1) = evalVar0 env "a"
...
g = 
  let
    f x t = 
      case t of
        Leaf a -> ((min' a (fst x)), (max' a (snd x)))
        Node a l r -> f (f ((min' a (fst x)), (max' a (snd x))) l) r
        ...
        Leaf a -> 
          let
            tmp1 =
              (Leaf a)
          in
          evalU0_0 (RefEnv [("a", (Env0 a))]) ((genSym (2::Int) "hole0") :: (UnionM Expr0_0))
        Node a l r -> 
          let
            tmp2 =
              (f l)
          ...
          let
            tmp3 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp3", (Env1 tmp3)), ("tmp2", (Env1 tmp2)), ("a", (Env0 a))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main' t = 
  let
    tmp4 =
      (repr t)
  in
  evalU2_0 (RefEnv [("tmp4", (Env1 tmp4))]) ((genSym (2::Int) "hole2") :: (UnionM Expr2_0))
...
main = do
    let pairs = [
                (((Leaf (-4))), ((-4, -4)))
                , (((Node ((-2)) ((Node ((5)) ((Leaf (3))) ((Leaf (5))))) ((Node ((-5)) ((Leaf (1))) ((Node ((-5)) ((Leaf (3))) ((Leaf (5))))))))), ((-5, 5)))
                , (((Node ((3)) ((Node ((5)) ((Leaf (-5))) ((Node ((4)) ((Node ((4)) ((Leaf (-4))) ((Leaf (1))))) ((Leaf (-2))))))) ((Leaf (-1))))), ((-5, 5)))
                , (((Node ((1)) ((Leaf (3))) ((Node ((4)) ((Leaf (-1))) ((Leaf (-2))))))), ((-2, 4)))
                , (((Node ((-4)) ((Node ((0)) ((Leaf (-3))) ((Leaf (5))))) ((Node ((2)) ((Leaf (4))) ((Node ((-5)) ((Leaf (-3))) ((Leaf (-5))))))))), ((-5, 5)))
                , (((Node ((-4)) ((Leaf (-3))) ((Node ((0)) ((Leaf (2))) ((Leaf (-3))))))), ((-4, 2)))
                , (((Leaf (-3))), ((-3, -3)))
                , (((Node ((5)) ((Leaf (2))) ((Leaf (-1))))), ((-1, 5)))
                , (((Node ((-2)) ((Node ((0)) ((Leaf (-4))) ((Leaf (1))))) ((Node ((-1)) ((Leaf (-3))) ((Node ((-5)) ((Leaf (-1))) ((Leaf (5))))))))), ((-5, 5)))
                , (((Node ((1)) ((Node ((1)) ((Leaf (-2))) ((Leaf (-4))))) ((Leaf (1))))), ((-4, 1)))
                , (((Node ((-2)) ((Node ((-4)) ((Node ((-3)) ((Leaf (-3))) ((Leaf (-3))))) ((Leaf (1))))) ((Node ((3)) ((Leaf (3))) ((Leaf (-4))))))), ((-4, 3)))
                , (((Node ((-4)) ((Leaf (0))) ((Leaf (5))))), ((-4, 5)))
                , (((Leaf (3))), ((3, 3)))
                , (((Node ((3)) ((Node ((-5)) ((Leaf (-4))) ((Leaf (-2))))) ((Node ((-3)) ((Leaf (-1))) ((Leaf (-2))))))), ((-5, 3)))
                , (((Leaf (0))), ((0, 0)))
                , (((Leaf (-4))), ((-4, -4)))
                , (((Node ((2)) ((Leaf (-1))) ((Node ((-4)) ((Leaf (1))) ((Node ((-1)) ((Leaf (3))) ((Node ((1)) ((Leaf (4))) ((Leaf (-2))))))))))), ((-4, 4)))
                , (((Node ((-1)) ((Leaf (-3))) ((Leaf (-2))))), ((-3, -1)))
                , (((Node ((-2)) ((Leaf (-4))) ((Leaf (2))))), ((-4, 2)))
                , (((Node ((-5)) ((Leaf (4))) ((Node ((0)) ((Node ((2)) ((Leaf (-4))) ((Leaf (-3))))) ((Node ((2)) ((Leaf (-1))) ((Leaf (2))))))))), ((-5, 4)))
                ]
