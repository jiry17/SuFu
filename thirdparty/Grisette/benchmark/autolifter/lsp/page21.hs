...
-- param_list: tmp5 t
data Expr4_0
  = Prod4_0 (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1)
  | CZero44_0
  deriving stock (Generic, Show)
...
data Expr5_1
  = Param05_1
  | Prod5_1 (UnionM Expr5_0) (UnionM Expr5_0) (UnionM Expr5_0) (UnionM Expr5_0)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_1_1 e0_0] ++ [mrgAccess1_0_1_1 e0_1] ++ [mrgAccess2_0_1_1 e0_2] ++ [mrgAccess3_0_1_1 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e1_3 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd4_0 e1_0 e1_1 e1_2 e1_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd4_1 e1_0 e1_1] ++ [mrgCsub4_1 e1_2 e1_3] ++ [mrgCIte4_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_4_1 e0_0] ++ [mrgAccess1_0_4_1 e0_1] ++ [mrgAccess2_0_4_1 e0_2] ++ [mrgAccess3_0_4_1 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_3 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd5_0 e0_0 e0_1] ++ [mrgCsub5_0 e0_2 e0_3] ++ [mrgCIte5_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_5_0 e1_0] ++ [mrgAccess1_1_5_0 e1_1] ++ [mrgAccess2_1_5_0 e1_2] ++ [mrgAccess3_1_5_0 e1_3] ++ [mrgMax5_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e0_2 <- (gen0 (gendepth - 1))
        e0_3 <- (gen0 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgProd5_1 e0_0 e0_1 e0_2 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
eval4_0 :: RefEnv -> Expr4_0 -> (SymInteger, SymInteger, SymInteger, SymInteger)
eval4_0 env (Prod4_0 p0 p1 p2 p3) = ((evalU4_1 env p0), (evalU4_1 env p1), (evalU4_1 env p2), (evalU4_1 env p3))
eval4_0 env (CZero44_0) = (0,0,0,0)

evalU4_0 :: RefEnv -> UnionM Expr4_0 -> (SymInteger, SymInteger, SymInteger, SymInteger)
...
eval4_1 env (Access0_0_4_1 p0) = get1from4 (evalU4_0 env p0)
eval4_1 env (Access1_0_4_1 p0) = get2from4 (evalU4_0 env p0)
eval4_1 env (Access2_0_4_1 p0) = get3from4 (evalU4_0 env p0)
eval4_1 env (Access3_0_4_1 p0) = get4from4 (evalU4_0 env p0)
...
eval5_0 env (Access0_1_5_0 p0) = get1from4 (evalU5_1 env p0)
eval5_0 env (Access1_1_5_0 p0) = get2from4 (evalU5_1 env p0)
eval5_0 env (Access2_1_5_0 p0) = get3from4 (evalU5_1 env p0)
eval5_0 env (Access3_1_5_0 p0) = get4from4 (evalU5_1 env p0)
...
eval5_1 :: RefEnv -> Expr5_1 -> (SymInteger, SymInteger, SymInteger, SymInteger)
eval5_1 env (Param05_1) = evalVar1 env "tmp7"
eval5_1 env (Prod5_1 p0 p1 p2 p3) = ((evalU5_0 env p0), (evalU5_0 env p1), (evalU5_0 env p2), (evalU5_0 env p3))

evalU5_1 :: RefEnv -> UnionM Expr5_1 -> (SymInteger, SymInteger, SymInteger, SymInteger)
        ...
        _ -> 
          let
            tmp5 =
              (Nil Unit)
          in
          evalU4_0 (RefEnv []) ((genSym (4::Int) "hole4") :: (UnionM Expr4_0))
...
lsp r b x = 
  ...
  let
    tmp7 =
      (cart2l t)
  in
  evalU5_0 (RefEnv [("tmp7", (Env1 tmp7))]) ((genSym (2::Int) "hole5") :: (UnionM Expr5_0))
...
main = do
    let pairs = [
                ...
                , ((((Cons ((-3)) ((Cons ((1)) ((Cons ((5)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((4)) ((Cons ((1)) ((Cons ((5)) ((Nil Unit))))))))))))))))))))), (9))
