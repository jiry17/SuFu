...
single_pass v xs = 
    let run = (let f xs = 
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        evalU1_0 (RefEnv [("h", (Env0 h)), ("tmp1", (Env0 tmp1))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
...
main = do
    let pairs = [
                ...
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), 4)
                ...
                , ((Nil Unit), 0)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), 2)
                ]
