...
main = do
    let pairs = [
                ((Cons (2) (Cons (-4) (Cons (-5) (Cons (-4) (Cons (-3) (Cons (3) (Nil Unit))))))), 3)
                , ((Cons (-5) (Cons (1) (Cons (-2) (Nil Unit)))), 1)
                , ((Cons (-5) (Cons (2) (Cons (4) (Nil Unit)))), 4)
                , ((Cons (-4) (Cons (5) (Cons (-5) (Cons (-3) (Nil Unit))))), 5)
                , ((Cons (4) (Cons (4) (Cons (-2) (Cons (5) (Cons (0) (Cons (-1) (Cons (5) (Cons (4) (Nil Unit))))))))), 5)
                , ((Cons (3) (Cons (-5) (Cons (2) (Cons (-3) (Cons (5) (Cons (2) (Cons (-5) (Cons (3) (Nil Unit))))))))), 5)
                , ((Cons (3) (Nil Unit)), 3)
                , ((Cons (3) (Cons (0) (Cons (-2) (Cons (-1) (Cons (2) (Cons (4) (Cons (1) (Nil Unit)))))))), 4)
                , ((Cons (4) (Cons (-5) (Cons (0) (Cons (4) (Nil Unit))))), 4)
                , ((Cons (2) (Cons (0) (Cons (-4) (Nil Unit)))), 2)
                , ((Cons (5) (Nil Unit)), 5)
                , ((Cons (1) (Nil Unit)), 1)
                , ((Cons (-5) (Cons (-4) (Cons (3) (Cons (0) (Cons (0) (Cons (2) (Cons (5) (Cons (2) (Cons (4) (Nil Unit)))))))))), 5)
                , ((Cons (-2) (Cons (2) (Cons (0) (Cons (5) (Cons (2) (Nil Unit)))))), 5)
                , ((Cons (-2) (Cons (0) (Cons (1) (Nil Unit)))), 1)
                , ((Cons (-2) (Cons (-1) (Cons (-5) (Cons (3) (Cons (4) (Cons (5) (Cons (-2) (Nil Unit)))))))), 5)
                , ((Cons (-3) (Cons (-5) (Cons (4) (Cons (-3) (Cons (3) (Cons (5) (Cons (-5) (Nil Unit)))))))), 5)
                , ((Cons (-2) (Cons (-5) (Cons (0) (Nil Unit)))), 0)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (2) (Cons (4) (Cons (-2) (Nil Unit)))), 4)
                ]
