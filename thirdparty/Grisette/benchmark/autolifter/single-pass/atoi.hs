...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCzero0_0] ++ [mrgBase0_0] ++ [mrgAl_inf0_0]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam31_0] ++ [mrgCzero1_0] ++ [mrgBase1_0] ++ [mrgAl_inf1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgCzero2_0] ++ [mrgBase2_0] ++ [mrgAl_inf2_0]
...
main = do
    let pairs = [
                ((Cons (8) (Cons (6) (Cons (9) (Nil Unit)))), 968)
                , ((Cons (1) (Cons (8) (Nil Unit))), 81)
                , ((Cons (3) (Cons (9) (Cons (3) (Cons (0) (Nil Unit))))), 393)
                , ((Cons (5) (Cons (7) (Cons (9) (Cons (3) (Nil Unit))))), 3975)
                , ((Cons (7) (Cons (5) (Cons (3) (Cons (9) (Nil Unit))))), 9357)
                , ((Cons (2) (Nil Unit)), 2)
                , ((Cons (8) (Cons (5) (Cons (8) (Nil Unit)))), 858)
                , ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (5) (Cons (9) (Nil Unit))), 95)
                , ((Cons (0) (Cons (5) (Nil Unit))), 50)
                , ((Cons (6) (Cons (9) (Cons (0) (Cons (1) (Nil Unit))))), 1096)
                , ((Cons (3) (Cons (8) (Cons (0) (Nil Unit)))), 83)
                , ((Cons (1) (Cons (6) (Nil Unit))), 61)
                , ((Cons (3) (Nil Unit)), 3)
                , ((Cons (4) (Cons (2) (Cons (4) (Nil Unit)))), 424)
                , ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (5) (Nil Unit)), 5)
                , ((Cons (9) (Cons (2) (Nil Unit))), 29)
                ]
