...
largest_peak :: List -> SymInteger
largest_peak = 
    let f cmo xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let cmo = (mrgIte (h >~  0) (cmo + h) 0) in
                            max' cmo (f cmo t)
                in f  0

main' = 
    single_pass largest_peak
...
main = do
    let pairs = [
                ...
                , ((Cons (0) (Cons (2) (Cons (3) (Cons (0) (Cons (1) (Cons (2) (Cons (3) (Cons (2) (Cons (3) (Nil Unit)))))))))), 11)
                , ((Cons (1) (Cons (2) (Cons (0) (Cons (1) (Nil Unit))))), 3)
                , ((Cons (0) (Cons (3) (Cons (3) (Cons (0) (Cons (1) (Cons (2) (Cons (3) (Cons (3) (Nil Unit))))))))), 9)
                , ((Cons (3) (Cons (0) (Cons (2) (Cons (1) (Nil Unit))))), 3)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (2) (Cons (3) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))), 5)
                , ((Cons (3) (Cons (0) (Nil Unit))), 3)
                , ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (2) (Nil Unit))))))), 3)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (1) (Cons (1) (Cons (0) (Cons (3) (Cons (0) (Cons (2) (Nil Unit)))))))), 4)
                , ((Cons (3) (Cons (1) (Cons (1) (Nil Unit)))), 5)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (0) (Cons (2) (Nil Unit)))), 2)
                , ((Cons (3) (Cons (1) (Cons (1) (Nil Unit)))), 5)
                , ((Nil Unit), 0)
