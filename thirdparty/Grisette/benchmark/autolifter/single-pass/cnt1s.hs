  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCand1_2 e2_0 e2_1] ++ [mrgCor1_2 e2_2 e2_3])
        return res
...
main = do
    let pairs = [
                ((Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Nil Unit)))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (1) (Nil Unit))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Nil Unit)))), 1)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit))))), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))))), 0)
                , ((Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Nil Unit))))))))), 1)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Nil Unit)))))))))), 1)
                , ((Cons (1) (Cons (1) (Nil Unit))), 1)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit))))), 1)
                ]
