...
count1s2s3s :: List -> SymInteger
count1s2s3s = 
    let f s1 s2 xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let upd = (mrgIte ((h ==~  3) &&~  (s1 ||~  s2)) 1 0) in
                            let s2 = ((h ==~  2) &&~  (s1 ||~  s2)) in 
                                let s1 = (h ==~  1) in 
                                    upd +  (f s1 s2 t)
                in f  (toSym False) (toSym False)

main' = 
    single_pass count1s2s3s
...
main = do
    let pairs = [
                ...
                , ((Cons (1) (Cons (3) (Cons (5) (Cons (1) (Cons (2) (Cons (3) (Cons (5) (Cons (3) (Cons (5) (Nil Unit)))))))))), 2)
                , ((Cons (2) (Cons (4) (Cons (1) (Cons (2) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (4) (Cons (5) (Cons (1) (Cons (2) (Cons (3) (Cons (4) (Cons (5) (Nil Unit))))))))), 1)
                , ((Cons (5) (Cons (1) (Cons (3) (Cons (1) (Nil Unit))))), 1)
                , ((Cons (1) (Nil Unit)), 0)
                , ((Cons (1) (Cons (0) (Cons (4) (Cons (4) (Cons (0) (Cons (2) (Cons (1) (Nil Unit)))))))), 0)
                , ((Cons (5) (Cons (0) (Nil Unit))), 0)
                , ((Cons (2) (Cons (2) (Cons (0) (Cons (1) (Cons (2) (Cons (4) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (4) (Cons (2) (Cons (2) (Cons (0) (Cons (5) (Cons (1) (Cons (3) (Nil Unit)))))))), 1)
                , ((Cons (5) (Cons (1) (Cons (1) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (4) (Cons (0) (Cons (4) (Nil Unit)))), 0)
                , ((Cons (5) (Cons (2) (Cons (2) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (3) (Cons (4) (Cons (4) (Nil Unit))))))))), 1)
                ]
