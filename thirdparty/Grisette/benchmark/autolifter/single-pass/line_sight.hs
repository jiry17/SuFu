...
data Expr2_1
  = Param02_1
  | Prod2_1 (UnionM Expr2_2) (UnionM Expr2_2)
  deriving stock (Generic, Show)
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam01_1] ++ [mrgAl_inf1_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgMax1_1 e1_0 e1_1] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        e1_2 <- (gen1 (gendepth - 1))
        e1_3 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCless1_2 e1_2 e1_3])
        return res
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle2 = [mrgCzero2_2] ++ [mrgAl_inf2_2]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCeq2_0 e2_0 e2_1] ++ [mrgCless2_0 e2_2 e2_3] ++ [mrgCleq2_0 e2_4 e2_5] ++ [mrgCand2_0 e0_0 e0_1] ++ [mrgCor2_0 e0_2 e0_3] ++ [mrgCnot2_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        e2_0 <- (gen2 (gendepth - 1))
        e2_1 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgProd2_1 e2_0 e2_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e0_0 e2_4 e2_5] ++ [mrgAccess02_2 e1_0] ++ [mrgAccess12_2 e1_1])
        return res
...
eval2_1 env (Prod2_1 p0 p1) = ((evalU2_2 env p0), (evalU2_2 env p1))
...
eval2_2 env (Access02_2 p0) = fst (evalU2_1 env p0)
eval2_2 env (Access12_2 p0) = snd (evalU2_1 env p0)
...
single_pass v xs = 
    let run = (let f xs = 
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        -- (max' h (fst tmp1), mrgIte (snd tmp1 <~ 100) (snd tmp1) (h))
...
main = do
    let pairs = [
                ((Nil Unit), True)
                , ((Nil Unit), True)
                , ((Cons (2) (Cons (4) (Cons (3) (Cons (1) (Cons (5) (Cons (3) (Cons (1) (Cons (-4) (Nil Unit))))))))), False)
                , ((Cons (4) (Cons (5) (Nil Unit))), True)
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), True)
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), False)
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), True)
                , ((Cons (4) (Cons (-4) (Cons (1) (Cons (-2) (Nil Unit))))), False)
                , ((Cons (-3) (Nil Unit)), True)
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), False)
                , ((Cons (4) (Cons (-5) (Nil Unit))), False)
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), True)
                , ((Nil Unit), True)
                , ((Cons (2) (Cons (0) (Cons (-2) (Cons (-5) (Cons (5) (Cons (-3) (Cons (2) (Nil Unit)))))))), False)
                , ((Cons (4) (Cons (-2) (Cons (-2) (Nil Unit)))), False)
                , ((Nil Unit), True)
                , ((Cons (3) (Cons (-5) (Cons (2) (Nil Unit)))), False)
                , ((Cons (5) (Cons (-1) (Cons (0) (Nil Unit)))), False)
                , ((Nil Unit), True)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), True)
                ]
