...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgCzero0_1] ++ [mrgCone0_1] ++ [mrgAl_inf0_1]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam01_1] ++ [mrgParam41_1] ++ [mrgCzero1_1] ++ [mrgAl_inf1_1]
...
single_pass :: (List -> SymInteger) -> List -> SymInteger
single_pass v xs = 
    let run = (let f xs = 
                            case xs of
                                Nil _ -> 
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        let c0 = (al_head t) in
                                        -- (mrgIte ((-1 <~ h) &&~ (snd tmp1 <=~ (h + (c0 + c0)))) (-1) (fst tmp1 + 1), mrgIte((snd tmp1 + (h - (2 * c0))) <~ h) (h) (snd tmp1 + (h - (2 * c0))))
                                        evalU1_0 (RefEnv [("tmp1", (Env0 tmp1)), ("h", (Env1 h)), ("c0", (Env1 c0))]) ((genSym (6::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
            -- fst tmp2
...
mts_p :: List -> SymInteger
mts_p xs = 
    let f xs i pos mts = 
                case xs of
                    Nil _ -> pos
                    Cons h t -> 
                        let pos = (mrgIte ((mts +  h) <~  0) (i) (pos)) in 
...
main = do
    let pairs = [
                ...
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), 3)
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), 0)
                , ((Cons (4) (Cons (-4) (Cons (1) (Cons (-2) (Nil Unit))))), 3)
                , ((Cons (-3) (Nil Unit)), 0)
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), 6)
                , ((Cons (4) (Cons (-5) (Nil Unit))), 1)
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), 3)
                , ((Nil Unit), -1)
                , ((Cons (2) (Cons (0) (Cons (-2) (Cons (-5) (Cons (5) (Cons (-3) (Cons (2) (Nil Unit)))))))), 3)
                , ((Cons (4) (Cons (-2) (Cons (-2) (Nil Unit)))), -1)
                , ((Nil Unit), -1)
                , ((Cons (3) (Cons (-5) (Cons (2) (Nil Unit)))), 1)
                , ((Cons (5) (Cons (-1) (Cons (0) (Nil Unit)))), -1)
                , ((Nil Unit), -1)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), 4)
                ]
