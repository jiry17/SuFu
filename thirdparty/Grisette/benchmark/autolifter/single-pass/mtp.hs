  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess00_1 e0_0] ++ [mrgAccess10_1 e0_1] ++ [mrgCmul0_1 e1_6 e1_7])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1] ++ [mrgCmul1_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCless1_2 e1_2 e1_3] ++ [mrgCleq1_2 e1_4 e1_5] ++ [mrgCand1_2 e2_0 e2_1] ++ [mrgCor1_2 e2_2 e2_3] ++ [mrgCerror1_2 e1_6])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e2_0 e0_4 e0_5] ++ [mrgAccess02_0 e1_0] ++ [mrgAccess12_0 e1_1] ++ [mrgCmul2_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval1_2 env (Cerror1_2 p0) = al_error (evalU1_1 env p0)
                            ...
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        ...
                                        *
                                        < <= and or al_error
                                                    {if (and (al_error tmp1.2) (< tmp1.1 h)) then h
            else if (or (< (* h tmp1.2) tmp1.1) (<= (* h tmp1.2) tmp1.2)) then tmp1.1
...
main = do
    let pairs = [
                ((Nil Unit), 1)
                , ((Nil Unit), 1)
                , ((Cons (1) (Cons (2) (Cons (2) (Cons (1) (Cons (3) (Cons (2) (Cons (1) (Cons (-2) (Nil Unit))))))))), 1)
                , ((Cons (2) (Cons (3) (Nil Unit))), 6)
                , ((Cons (-2) (Cons (1) (Cons (3) (Cons (-2) (Cons (0) (Cons (1) (Cons (2) (Cons (0) (Cons (3) (Nil Unit)))))))))), 3)
                , ((Cons (0) (Cons (1) (Cons (-2) (Cons (-1) (Nil Unit))))), 2)
                , ((Cons (-3) (Cons (2) (Cons (3) (Cons (-2) (Cons (-1) (Cons (1) (Cons (2) (Cons (3) (Nil Unit))))))))), 72)
                , ((Cons (3) (Cons (-2) (Cons (0) (Cons (-1) (Nil Unit))))), 1)
                , ((Cons (-2) (Nil Unit)), 1)
                , ((Cons (-2) (Cons (-3) (Cons (1) (Cons (2) (Cons (-2) (Cons (0) (Cons (-2) (Nil Unit)))))))), 1)
                , ((Cons (2) (Cons (-3) (Nil Unit))), 1)
                , ((Cons (0) (Cons (-1) (Cons (-3) (Cons (-2) (Cons (0) (Cons (1) (Nil Unit))))))), 1)
                , ((Nil Unit), 1)
                , ((Cons (2) (Cons (0) (Cons (-1) (Cons (-3) (Cons (3) (Cons (-2) (Cons (1) (Nil Unit)))))))), 18)
                , ((Cons (3) (Cons (-1) (Cons (-1) (Nil Unit)))), 3)
                , ((Nil Unit), 1)
                , ((Cons (2) (Cons (-3) (Cons (1) (Nil Unit)))), 1)
                , ((Cons (3) (Cons (-1) (Cons (0) (Nil Unit)))), 1)
                , ((Nil Unit), 1)
                , ((Cons (-1) (Cons (-2) (Cons (-2) (Cons (-2) (Cons (-2) (Cons (1) (Cons (2) (Cons (2) (Nil Unit))))))))), 64)
                ]
