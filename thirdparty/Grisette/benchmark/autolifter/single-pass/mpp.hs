  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCless1_2 e1_2 e1_3] ++ [mrgCleq1_2 e1_4 e1_5] ++ [mrgCand1_2 e2_0 e2_1] ++ [mrgCor1_2 e2_2 e2_3])
        return res
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        ...
                                        1 0 *
                                                    ...
                                                    {if (and (< (* h tmp1.2) 1) (< h 1)) then 1
            else if (< h 0) then * h tmp1.2
            else * h tmp1.1, if (and (< h (* h tmp1.1)) (< h (* h tmp1.2))) then h
            else if (or (< h 0) (<= (* h tmp1.1) tmp1.2)) then * h tmp1.1
            else * h tmp1.2}
                                        -}
                                        evalU1_0 (RefEnv [("tmp1", (Env0 tmp1)), ("h", (Env1 h))]) ((genSym (6::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
...
main = do
    let pairs = [
                ((Nil Unit), 1)
                , ((Nil Unit), 1)
                , ((Cons (1) (Cons (2) (Cons (2) (Cons (1) (Cons (3) (Cons (2) (Cons (1) (Cons (-2) (Nil Unit))))))))), 24)
                , ((Cons (2) (Cons (3) (Nil Unit))), 6)
                , ((Cons (-2) (Cons (1) (Cons (3) (Cons (-2) (Cons (0) (Cons (1) (Cons (2) (Cons (0) (Cons (3) (Nil Unit)))))))))), 12)
                , ((Cons (0) (Cons (1) (Cons (-2) (Cons (-1) (Nil Unit))))), 1)
                , ((Cons (-3) (Cons (2) (Cons (3) (Cons (-2) (Cons (-1) (Cons (1) (Cons (2) (Cons (3) (Nil Unit))))))))), 36)
                , ((Cons (3) (Cons (-2) (Cons (0) (Cons (-1) (Nil Unit))))), 3)
                , ((Cons (-2) (Nil Unit)), 1)
                , ((Cons (-2) (Cons (-3) (Cons (1) (Cons (2) (Cons (-2) (Cons (0) (Cons (-2) (Nil Unit)))))))), 12)
                , ((Cons (2) (Cons (-3) (Nil Unit))), 2)
                , ((Cons (0) (Cons (-1) (Cons (-3) (Cons (-2) (Cons (0) (Cons (1) (Nil Unit))))))), 1)
                , ((Nil Unit), 1)
                , ((Cons (2) (Cons (0) (Cons (-1) (Cons (-3) (Cons (3) (Cons (-2) (Cons (1) (Nil Unit)))))))), 2)
                , ((Cons (3) (Cons (-1) (Cons (-1) (Nil Unit)))), 3)
                , ((Nil Unit), 1)
                , ((Cons (2) (Cons (-3) (Cons (1) (Nil Unit)))), 2)
                , ((Cons (3) (Cons (-1) (Cons (0) (Nil Unit)))), 3)
                , ((Nil Unit), 1)
                , ((Cons (-1) (Cons (-2) (Cons (-2) (Cons (-2) (Cons (-2) (Cons (1) (Cons (2) (Cons (2) (Nil Unit))))))))), 8)
                ]
