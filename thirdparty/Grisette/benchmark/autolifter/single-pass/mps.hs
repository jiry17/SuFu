  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_3 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd1_0 e0_0 e0_1] ++ [mrgMin1_0 e0_2 e0_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
main = do
    let pairs = [
                ((Cons (1) (Cons (2) (Cons (2) (Cons (5) (Cons (2) (Cons (3) (Cons (2) (Cons (5) (Cons (4) (Nil Unit)))))))))), 0)
                , ((Cons (3) (Cons (-4) (Cons (0) (Cons (-2) (Nil Unit))))), -3)
                , ((Cons (3) (Cons (-3) (Nil Unit))), 0)
                , ((Cons (-5) (Cons (-2) (Cons (0) (Cons (-2) (Cons (4) (Cons (5) (Nil Unit))))))), -9)
                , ((Cons (-4) (Cons (-2) (Cons (2) (Cons (5) (Cons (5) (Cons (-5) (Cons (1) (Cons (1) (Cons (-2) (Nil Unit)))))))))), -6)
                , ((Cons (5) (Cons (-3) (Nil Unit))), 0)
                , ((Cons (4) (Cons (4) (Cons (5) (Cons (-4) (Nil Unit))))), 0)
                , ((Cons (4) (Cons (3) (Cons (1) (Cons (-2) (Cons (-1) (Cons (4) (Cons (-5) (Nil Unit)))))))), 0)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (2) (Cons (-5) (Nil Unit)))))), -2)
                , ((Cons (-2) (Cons (1) (Cons (-4) (Cons (-2) (Cons (-4) (Cons (-1) (Cons (5) (Cons (3) (Nil Unit))))))))), -12)
                , ((Cons (4) (Cons (3) (Cons (-2) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (1) (Cons (-1) (Cons (-5) (Cons (-4) (Cons (5) (Cons (5) (Cons (-2) (Cons (-1) (Cons (4) (Nil Unit)))))))))), -9)
                , ((Cons (-2) (Cons (-2) (Cons (2) (Cons (4) (Cons (2) (Cons (2) (Nil Unit))))))), -4)
                , ((Nil Unit), 0)
                , ((Cons (-4) (Cons (-2) (Cons (1) (Cons (1) (Cons (-3) (Nil Unit)))))), -7)
                , ((Cons (-4) (Nil Unit)), -4)
                , ((Cons (0) (Cons (1) (Cons (2) (Nil Unit)))), 0)
                , ((Cons (-4) (Cons (0) (Cons (-5) (Cons (0) (Cons (-2) (Cons (3) (Cons (-3) (Nil Unit)))))))), -11)
                , ((Cons (4) (Cons (4) (Cons (-1) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (-3) (Cons (-2) (Cons (-3) (Cons (1) (Cons (2) (Cons (4) (Cons (-2) (Cons (4) (Nil Unit))))))))), -8)
                ]
