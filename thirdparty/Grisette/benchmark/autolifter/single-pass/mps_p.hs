  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCleq1_2 e1_4 e1_5] ++ [mrgCor1_2 e2_2 e2_3])
        return res
    ...
    let run = (let f xs = 
                            case xs of
                                ...
                                Cons h t -> 
                                    ...
                                    -}
                                    -- (mrgIte (((h + snd tmp1) <=~ 0) ||~ (snd tmp1 <=~ 0)) (0) (1 + fst tmp1) , max' h (h + snd tmp1))
...
mps_p :: List -> SymInteger
mps_p xs = 
    let f xs i mps pos sum = 
                case xs of
                    Nil _ -> pos
                    Cons h t -> 
                        let sum = (sum +  h) in 
                            let pos = (mrgIte (sum >~  mps) (i) (pos)) in 
...
main = do
    let pairs = [
                ((Cons (-2) (Cons (5) (Cons (1) (Nil Unit)))), 2)
                , ((Cons (4) (Cons (5) (Cons (0) (Nil Unit)))), 1)
                , ((Cons (-4) (Cons (-1) (Cons (3) (Cons (1) (Cons (-2) (Cons (-2) (Cons (2) (Nil Unit)))))))), 0)
                , ((Cons (5) (Cons (-3) (Cons (0) (Cons (-1) (Cons (-3) (Cons (-4) (Cons (-1) (Cons (-3) (Nil Unit))))))))), 0)
                , ((Cons (0) (Cons (4) (Cons (3) (Cons (-4) (Cons (5) (Nil Unit)))))), 4)
                , ((Cons (4) (Cons (4) (Cons (5) (Cons (-1) (Nil Unit))))), 2)
                , ((Cons (4) (Cons (5) (Cons (-1) (Cons (1) (Cons (1) (Cons (4) (Nil Unit))))))), 5)
                , ((Cons (5) (Cons (3) (Cons (0) (Cons (5) (Cons (2) (Cons (2) (Cons (5) (Cons (-2) (Cons (3) (Nil Unit)))))))))), 8)
                , ((Cons (-1) (Nil Unit)), 0)
                , ((Cons (5) (Cons (-5) (Cons (-4) (Cons (-4) (Nil Unit))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (4) (Cons (-3) (Cons (3) (Cons (3) (Cons (0) (Nil Unit))))))))), 6)
                , ((Cons (4) (Cons (4) (Cons (0) (Cons (5) (Cons (-5) (Cons (-4) (Cons (5) (Cons (3) (Cons (3) (Nil Unit)))))))))), 8)
                , ((Cons (-4) (Cons (1) (Cons (0) (Cons (-2) (Cons (3) (Cons (1) (Nil Unit))))))), 0)
                , ((Cons (-2) (Nil Unit)), 0)
                , ((Cons (-4) (Cons (2) (Cons (-4) (Cons (4) (Cons (-4) (Cons (-2) (Nil Unit))))))), 0)
                , ((Cons (4) (Nil Unit)), 0)
                , ((Cons (0) (Cons (-1) (Nil Unit))), 0)
                , ((Cons (1) (Cons (-1) (Cons (-1) (Cons (-1) (Nil Unit))))), 0)
                , ((Cons (2) (Cons (2) (Cons (3) (Cons (-4) (Cons (5) (Cons (4) (Cons (-1) (Cons (-3) (Nil Unit))))))))), 5)
                ]
