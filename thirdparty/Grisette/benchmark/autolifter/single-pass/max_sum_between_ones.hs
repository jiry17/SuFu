...
max_sum_between_ones :: List -> SymInteger
max_sum_between_ones = 
    let f cs xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let cs = (mrgIte (h ==~  1) 0 (cs + h)) in
                            max' cs (f cs t)
                in f  0

main' = 
    single_pass max_sum_between_ones
...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (3) (Cons (3) (Cons (2) (Cons (3) (Cons (3) (Cons (2) (Cons (0) (Nil Unit))))))))), 18)
                , ((Cons (3) (Cons (3) (Nil Unit))), 6)
                , ((Cons (0) (Cons (2) (Cons (3) (Cons (0) (Cons (1) (Cons (2) (Cons (3) (Cons (2) (Cons (3) (Nil Unit)))))))))), 10)
                , ((Cons (1) (Cons (2) (Cons (0) (Cons (1) (Nil Unit))))), 2)
                , ((Cons (0) (Cons (3) (Cons (3) (Cons (0) (Cons (1) (Cons (2) (Cons (3) (Cons (3) (Nil Unit))))))))), 8)
                , ((Cons (3) (Cons (0) (Cons (2) (Cons (1) (Nil Unit))))), 5)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (2) (Cons (3) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))), 5)
                , ((Cons (3) (Cons (0) (Nil Unit))), 3)
                , ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (2) (Nil Unit))))))), 2)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (1) (Cons (1) (Cons (0) (Cons (3) (Cons (0) (Cons (2) (Nil Unit)))))))), 5)
                , ((Cons (3) (Cons (1) (Cons (1) (Nil Unit)))), 3)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (0) (Cons (2) (Nil Unit)))), 4)
                , ((Cons (3) (Cons (1) (Cons (1) (Nil Unit)))), 3)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (2) (Cons (3) (Cons (3) (Nil Unit))))))))), 8)
                ]
