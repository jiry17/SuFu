  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e1_3 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCless1_2 e1_2 e1_3])
        return res
                            ...
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        ...
                                        -}
                                        -- (mrgIte ((h ==~ 0) ||~ (snd tmp1 <~ fst tmp1)) (fst tmp1) (1 + fst tmp1), mrgIte (h ==~ 0) (0) (1 + snd tmp1))
...
main = do
    let pairs = [
                ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 3)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))))))), 4)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))), 4)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))), 4)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), 3)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 5)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))))))))), 3)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), 6)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))))))), 4)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 3)
                ...
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))), 4)
                , ((Cons (0) (Cons (1) (Nil Unit))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 2)
                ]
