...
data EnvValue
  ...
  | Env1 SymBool
  | Env2 (SymBool, (SymInteger, SymInteger, SymInteger, SymInteger))
  | Env3 SymInteger
  | Env4 (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
...
evalVar2 :: RefEnv -> Ident -> (SymBool, (SymInteger, SymInteger, SymInteger, SymInteger))
...
evalVar4 :: RefEnv -> Ident -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
...
SymBool
(SymBool, (SymInteger, SymInteger, SymInteger, SymInteger))
SymInteger
...
data Expr1_0
  ...
  | Prod1_0 (UnionM Expr1_3) (UnionM Expr1_3) (UnionM Expr1_3) (UnionM Expr1_3)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd0_2 e2_0 e2_1] ++ [mrgCsub0_2 e2_2 e2_3] ++ [mrgCIte0_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_0_2 e0_0] ++ [mrgAccess1_0_0_2 e0_1] ++ [mrgAccess2_0_0_2 e0_2] ++ [mrgAccess3_0_0_2 e0_3] ++ [mrgCmul0_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess1_2_1_0 e2_0] ++ [mrgProd1_0 e3_0 e3_1 e3_2 e3_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen3 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle3 ++ [mrgCadd1_3 e3_0 e3_1] ++ [mrgCsub1_3 e3_2 e3_3] ++ [mrgCIte1_3 e1_0 e3_4 e3_5] ++ [mrgAccess0_0_1_3 e0_0] ++ [mrgAccess1_0_1_3 e0_1] ++ [mrgAccess2_0_1_3 e0_2] ++ [mrgAccess3_0_1_3 e0_3] ++ [mrgCmul1_3 e3_6 e3_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_6 <- (gen2 (gendepth - 1))
        e2_7 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_2_2 e0_0] ++ [mrgAccess1_0_2_2 e0_1] ++ [mrgAccess2_0_2_2 e0_2] ++ [mrgAccess3_0_2_2 e0_3] ++ [mrgCmul2_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_6 <- (gen2 (gendepth - 1))
        e2_7 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd3_2 e2_0 e2_1] ++ [mrgCsub3_2 e2_2 e2_3] ++ [mrgCIte3_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_3_2 e0_0] ++ [mrgAccess1_0_3_2 e0_1] ++ [mrgAccess2_0_3_2 e0_2] ++ [mrgAccess3_0_3_2 e0_3] ++ [mrgCmul3_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_3 <- (gen1 (gendepth - 1))
        e3_0 <- (gen3 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd4_0 e0_0 e0_1] ++ [mrgCsub4_0 e0_2 e0_3] ++ [mrgCIte4_0 e3_0 e0_4 e0_5] ++ [mrgAccess0_1_4_0 e1_0] ++ [mrgAccess1_1_4_0 e1_1] ++ [mrgAccess2_1_4_0 e1_2] ++ [mrgAccess3_1_4_0 e1_3] ++ [mrgCmul4_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval1_0 env (Prod1_0 p0 p1 p2 p3) = ((evalU1_3 env p0), (evalU1_3 env p1), (evalU1_3 env p2), (evalU1_3 env p3))
...
eval1_2 :: RefEnv -> Expr1_2 -> (SymBool, (SymInteger, SymInteger, SymInteger, SymInteger))
eval1_2 env (Param61_2) = evalVar2 env "info"
eval1_2 env (Prod1_2 p0 p1) = ((evalU1_1 env p0), (evalU1_0 env p1))

evalU1_2 :: RefEnv -> UnionM Expr1_2 -> (SymBool, (SymInteger, SymInteger, SymInteger, SymInteger))
...
eval1_3 env (Access0_0_1_3 p0) = get1from4 (evalU1_0 env p0)
eval1_3 env (Access1_0_1_3 p0) = get2from4 (evalU1_0 env p0)
eval1_3 env (Access2_0_1_3 p0) = get3from4 (evalU1_0 env p0)
eval1_3 env (Access3_0_1_3 p0) = get4from4 (evalU1_0 env p0)
        ...
        Cons h t -> 
          let
            res =
              (f t)
          in
          ((min' (fst res) (max' (snd res) h)), (min' (snd res) h))
      
  in
  f  xs))

main' = 
  solve' merge_tag default_tag apply_tag sndmin
...
main = do
    let pairs = [
                ...
                , ((((Cons ((2)) ((Cons ((5)) ((Nil Unit)))))), ((Ocons ((Query ((1)) ((2)))) ((Ocons ((Query ((-1)) ((4)))) ((Ocons ((Query ((5)) ((-5)))) ((Ocons ((Update ((3)) ((-1)) ((toSym False)))) ((Ocons ((Query ((3)) ((-5)))) ((Ocons ((Query ((-5)) ((3)))) ((Ocons ((Query ((1)) ((-2)))) ((Onil Unit))))))))))))))))), (Cons ((5)) ((Nil Unit))))
