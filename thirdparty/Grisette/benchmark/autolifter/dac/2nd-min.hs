...
eval2_1 env (Access02_1 p0) = getFirst (evalU2_0 env p0)
eval2_1 env (Access12_1 p0) = getSecond (evalU2_0 env p0)
...
eval3_0 env (Access03_0 p0) = getFirst (evalU3_1 env p0)
eval3_0 env (Access13_0 p0) = getSecond (evalU3_1 env p0)
...
main = do
    let pairs = [
                ...
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), -3)
                ...
                , ((Cons (-3) (Nil Unit)), 100)
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), -4)
