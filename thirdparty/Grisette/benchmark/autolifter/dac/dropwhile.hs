...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))), 0)
                , ((Cons (1) (Cons (1) (Nil Unit))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 1)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (0) (Nil Unit)), 1)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 2)
                , ((Cons (1) (Cons (0) (Nil Unit))), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit))))))), 5)
                , ((Nil Unit), 0)
                ...
                , ((Cons (1) (Cons (0) (Cons (0) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 5)
                ]
