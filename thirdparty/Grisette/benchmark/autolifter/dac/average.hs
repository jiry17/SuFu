...
data Expr0_1
  ...
  | Div0_1 (UnionM Expr0_1) (UnionM Expr0_1)
  | Al_inf0_1
  deriving stock (Generic, Show)
...
data Expr1_1
  ...
  | Div1_1 (UnionM Expr1_1) (UnionM Expr1_1)
  | Al_inf1_1
  deriving stock (Generic, Show)
...
data Expr2_1
  ...
  | Div2_1 (UnionM Expr2_1) (UnionM Expr2_1)
  | Al_inf2_1
  deriving stock (Generic, Show)
...
data Expr3_0
  ...
  | Div3_0 (UnionM Expr3_0) (UnionM Expr3_0)
  | Al_inf3_0
  deriving stock (Generic, Show)
...
data Expr3_1
  = Param13_1
  | Prod3_1 (UnionM Expr3_0) (UnionM Expr3_0) (UnionM Expr3_0)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess00_1 e0_0] ++ [mrgAccess10_1 e0_1] ++ [mrgAccess20_1 e0_2] ++ [mrgDiv0_1 e1_6 e1_7])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1] ++ [mrgAccess21_1 e0_2] ++ [mrgDiv1_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess02_1 e0_0] ++ [mrgAccess12_1 e0_1] ++ [mrgAccess22_1 e0_2] ++ [mrgDiv2_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess03_0 e1_0] ++ [mrgAccess13_0 e1_1] ++ [mrgAccess23_0 e1_2] ++ [mrgDiv3_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e0_1 <- (gen0 (gendepth - 1))
        e0_2 <- (gen0 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgProd3_1 e0_0 e0_1 e0_2])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
get1th :: (SymInteger, SymInteger, SymInteger) -> SymInteger
get1th (a, _, _) = a

get2th :: (SymInteger, SymInteger, SymInteger) -> SymInteger
get2th (_, b, _) = b

get3th :: (SymInteger, SymInteger, SymInteger) -> SymInteger
get3th (_, _, c) = c
...
eval0_1 env (Div0_1 p0 p1) = div' (evalU0_1 env p0) (evalU0_1 env p1)
...
eval1_0 env (CTripleZero1_0) = (0,0,0)
...
eval1_1 env (Div1_1 p0 p1) = div' (evalU1_1 env p0) (evalU1_1 env p1)
...
eval2_1 env (Div2_1 p0 p1) = div' (evalU2_1 env p0) (evalU2_1 env p1)
...
eval3_0 env (Div3_0 p0 p1) = div' (evalU3_0 env p0) (evalU3_0 env p1)
...
eval3_1 env (Prod3_1 p0 p1 p2) = ((evalU3_0 env p0), (evalU3_0 env p1), (evalU3_0 env p2))
...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (4) (Cons (3) (Cons (1) (Cons (5) (Cons (3) (Cons (1) (Cons (-4) (Nil Unit))))))))), 1)
                , ((Cons (4) (Cons (5) (Nil Unit))), 4)
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), 1)
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), -1)
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), 1)
                , ((Cons (4) (Cons (-4) (Cons (1) (Cons (-2) (Nil Unit))))), 0)
                , ((Cons (-3) (Nil Unit)), -3)
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), -1)
                ...
                , ((Nil Unit), 0)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), -1)
                ]
