  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess02_1 e0_0] ++ [mrgAccess12_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess03_0 e1_0] ++ [mrgAccess13_0 e1_1])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
get1th :: (SymInteger, SymInteger) -> SymInteger
get1th (a, _) = a

get2th :: (SymInteger, SymInteger) -> SymInteger
get2th (_, b) = b
...
f :: SymInteger -> SymInteger -> List -> SymInteger
f pre cnt xs = 
      case xs of
        Nil _ -> cnt
        Cons h t -> 
...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))), 1)
                , ((Cons (1) (Cons (1) (Nil Unit))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 1)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Nil Unit))))), 1)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 0)
                , ((Cons (1) (Cons (0) (Nil Unit))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Nil Unit)))), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 1)
                ]
