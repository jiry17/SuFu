...
main = do
    let pairs = [
                ...
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), False)
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), False)
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), False)
                ...
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), False)
                , ((Nil Unit), True)
                ...
                , ((Nil Unit), True)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), False)
                ]
