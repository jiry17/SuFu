...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam00_0] ++ [mrgParam20_0] ++ [mrgCzero0_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd0_0 e0_0 e0_1] ++ [mrgCsub0_0 e0_2 e0_3] ++ [mrgCIte0_0 e1_0 e0_4 e0_5] ++ [mrgSquare0_0 e0_6])
        return res
    gen1 gendepth
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam11_0] ++ [mrgParam21_0] ++ [mrgCzero1_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_6 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd1_0 e0_0 e0_1] ++ [mrgCsub1_0 e0_2 e0_3] ++ [mrgCIte1_0 e1_0 e0_4 e0_5] ++ [mrgSquare1_0 e0_6])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgParam12_0] ++ [mrgCzero2_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_6 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e1_0 e0_4 e0_5] ++ [mrgSquare2_0 e0_6])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval0_0 env (Param00_0) = evalVar0 env "n"
...
eval0_0 env (Square0_0 p0) = square (evalU0_0 env p0)
...
eval1_0 env (Param01_0) = evalVar0 env "tmp2"
eval1_0 env (Param11_0) = evalVar0 env "now"
eval1_0 env (Param21_0) = evalVar0 env "n"
...
eval1_0 env (Square1_0 p0) = square (evalU1_0 env p0)
...
eval2_0 env (Param02_0) = evalVar0 env "n"
...
eval2_0 env (Square2_0 p0) = square (evalU2_0 env p0)
      ...
      mrgIte (now >~  n)
        (let
          tmp1 =
            (Nil Unit)
        in
        evalU0_0 (RefEnv [("n", (Env0 n)), ("now", (Env0 now))]) ((genSym (4::Int) "hole0") :: (UnionM Expr0_0)))
        (let
          tmp2 =
            (f (now +  1))
        in
        evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("now", (Env0 now)), ("n", (Env0 n))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0)))
  in
  f  1
...
main' n = 
  ...
  let
    tmp4 =
      (upto n)
  in
  evalU2_0 (RefEnv [("n", (Env0 n)), ("tmp4", (Env0 tmp4))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(SymInteger, Integer)] -> SymBool
        constraint [] = con True
