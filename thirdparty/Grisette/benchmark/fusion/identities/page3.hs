...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCzero0_0] ++ [mrgInf0_0]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam11_0] ++ [mrgParam31_0] ++ [mrgCzero1_0] ++ [mrgInf1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgCzero2_0] ++ [mrgInf2_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e1_0 e0_4 e0_5] ++ [mrgMax2_0 e0_6 e0_7] ++ [mrgMin2_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        Ncons h t -> 
          ...
          let
            tmp3 =
              (g t)
          in
          evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("tmp2", (Env0 tmp2))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
...
main' xs = 
  let
    tmp4 =
      (map' maximum' xs)
  in
  evalU2_0 (RefEnv [("tmp4", (Env0 tmp4))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(NList, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((Ncons ((Cons ((0)) ((Cons ((-5)) ((Nil Unit)))))) ((Nnil Unit))))), (0))
                , ((((Nnil Unit))), (100))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Cons ((4)) ((Cons ((3)) ((Nil Unit)))))) ((Nnil Unit))))))), (-100))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Nnil Unit))))))), (-100))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Cons ((-2)) ((Nil Unit)))) ((Ncons ((Nil Unit)) ((Nnil Unit))))))))), (-100))
                , ((((Ncons ((Nil Unit)) ((Nnil Unit))))), (-100))
                , ((((Ncons ((Cons ((-5)) ((Nil Unit)))) ((Nnil Unit))))), (-5))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Cons ((-4)) ((Nil Unit)))) ((Ncons ((Cons ((0)) ((Cons ((-2)) ((Nil Unit)))))) ((Nnil Unit))))))))), (-100))
                , ((((Ncons ((Cons ((5)) ((Cons ((-5)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((3)) ((Nil Unit)))))))))))) ((Ncons ((Nil Unit)) ((Nnil Unit))))))), (-100))
                , ((((Ncons ((Cons ((3)) ((Nil Unit)))) ((Nnil Unit))))), (3))
                , ((((Ncons ((Cons ((3)) ((Cons ((-2)) ((Nil Unit)))))) ((Nnil Unit))))), (3))
                , ((((Ncons ((Cons ((-1)) ((Nil Unit)))) ((Ncons ((Cons ((3)) ((Nil Unit)))) ((Nnil Unit))))))), (-1))
                , ((((Ncons ((Cons ((4)) ((Nil Unit)))) ((Nnil Unit))))), (4))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Nnil Unit))))))), (-100))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Nnil Unit))))))))))), (-100))
                , ((((Nnil Unit))), (100))
                , ((((Ncons ((Cons ((-3)) ((Cons ((-3)) ((Nil Unit)))))) ((Nnil Unit))))), (-3))
                , ((((Nnil Unit))), (100))
                , ((((Ncons ((Nil Unit)) ((Ncons ((Nil Unit)) ((Nnil Unit))))))), (-100))
                , ((((Ncons ((Cons ((-1)) ((Nil Unit)))) ((Nnil Unit))))), (-1))
                ]
