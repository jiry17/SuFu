...
eval3_1 env (Param13_1) = evalVar0 env "tmp5"
...
data List2D
  ...
  | Cons2D List List2D
  deriving stock (Generic, Show, Eq)
  deriving (Mergeable, EvaluateSym, ToCon List2D, ExtractSymbolics)
    via (Default List2D)
...
data List3D
  ...
  deriving stock (Generic, Show, Eq)
  deriving (Mergeable, EvaluateSym, ToCon List3D, ExtractSymbolics)
    via (Default List3D)
{-
...
main = do
    let pairs = [
                ((((Nil Unit))), (0))
                , ((((Nil Unit))), (0))
                , ((((Cons ((2)) ((Cons ((4)) ((Cons ((3)) ((Cons ((1)) ((Cons ((5)) ((Cons ((3)) ((Cons ((1)) ((Cons ((-4)) ((Nil Unit))))))))))))))))))), (19))
                ...
                , ((((Cons ((4)) ((Cons ((-4)) ((Cons ((1)) ((Cons ((-2)) ((Nil Unit))))))))))), (4))
                , ((((Cons ((-3)) ((Nil Unit))))), (0))
                , ((((Cons ((-3)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((-3)) ((Nil Unit))))))))))))))))), (5))
