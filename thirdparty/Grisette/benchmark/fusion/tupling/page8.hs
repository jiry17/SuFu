...
eval1_0 env (Param01_0) = evalVar0 env "tmp1"
        ...
        Succ m -> 
          let
            tmp1 =
              (f m)
          in
          evalU1_0 (RefEnv [("tmp1", (Env0 tmp1))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
...
main' n = 
  let
    tmp2 =
      (repr n)
  in
  evalU2_0 (RefEnv [("tmp2", (Env0 tmp2))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(Nat, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((Succ (Zero Unit)))), (1))
                , ((((Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Zero Unit))))))))))), (21))
                , ((((Succ (Zero Unit)))), (1))
                , ((((Zero Unit))), (0))
                , ((((Succ (Succ (Succ (Succ (Zero Unit))))))), (3))
                , ((((Succ (Zero Unit)))), (1))
                , ((((Succ (Succ (Succ (Succ (Succ (Succ (Zero Unit))))))))), (8))
                , ((((Succ (Succ (Succ (Succ (Succ (Succ (Succ (Zero Unit)))))))))), (13))
                , ((((Succ (Succ (Succ (Succ (Succ (Succ (Succ (Zero Unit)))))))))), (13))
                , ((((Succ (Succ (Succ (Succ (Zero Unit))))))), (3))
                , ((((Succ (Succ (Succ (Zero Unit)))))), (2))
                , ((((Succ (Succ (Succ (Zero Unit)))))), (2))
                , ((((Zero Unit))), (0))
                , ((((Succ (Succ (Succ (Succ (Zero Unit))))))), (3))
                , ((((Succ (Succ (Succ (Succ (Succ (Succ (Succ (Zero Unit)))))))))), (13))
