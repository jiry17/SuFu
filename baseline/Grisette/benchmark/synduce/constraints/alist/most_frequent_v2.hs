        ...
        Aelt h n -> 
          let
            num =
              (p2i n)
          in
          evalU0_0 (RefEnv [("h", (Env0 h)), ("num", (Env0 num))]) ((genSym (1::Int) "hole0") :: (UnionM Expr0_0))
        Acons h n t -> 
          let
            num =
              (p2i n)
          ...
          let
            tmp1 =
              (f t)
          in
          evalU1_0 (RefEnv [("tmp1", (Env1 tmp1)), ("num", (Env0 num)), ("h", (Env0 h))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
