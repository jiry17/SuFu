...
-- output_type: Int
-- param_list: n num h t xs tmp2 global0
data Expr1_0
  = Param11_0
  | Param21_0
  | Param61_0
...
-- output_type: Int
-- param_list: h n tmp3 global0 t xs
data Expr2_0
  = Param02_0
  | Param22_0
  | Param32_0
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam11_0] ++ [mrgParam21_0] ++ [mrgParam61_0] ++ [mrgCzero1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgParam22_0] ++ [mrgParam32_0] ++ [mrgCzero2_0]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam03_0] ++ [mrgParam13_0] ++ [mrgCzero3_0]
...
eval0_0 env (Param00_0) = evalVar0 env "global0"
...
eval1_0 env (Param11_0) = evalVar0 env "num"
eval1_0 env (Param21_0) = evalVar0 env "h"
eval1_0 env (Param61_0) = evalVar0 env "global0"
...
eval2_0 env (Param32_0) = evalVar0 env "global0"
...
eval3_0 env (Param03_0) = evalVar0 env "global0"
...
Hole grammar for #1
n num h t xs tmp2 global0 

Hole grammar for #2
h n tmp3 global0 t xs 
        ...
        Anil _ -> 
          let
            tmp1 =
              (Anil Unit)
          in
          evalU0_0 (RefEnv [("global0", (Env0 global0))]) ((genSym (1::Int) "hole0") :: (UnionM Expr0_0))
        Acons h n t -> mrgIte (h ==~  global0)
            (let
              num =
                (n2i n)
            in
            let
              tmp2 =
                (Acons h n t)
            in
            evalU1_0 (RefEnv [("num", (Env0 num)), ("h", (Env0 h)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp3 =
                (f t)
            in
            evalU2_0 (RefEnv [("h", (Env0 h)), ("tmp3", (Env0 tmp3)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_unique xs)
    ...
    let
      tmp5 =
        (target global0 xs)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp5", (Env0 tmp5))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
ioPair :: [((SymInteger, AList), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, AList), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((-1)), ((Acons ((-3)) ((Z Unit)) ((Acons ((3)) ((Z Unit)) ((Acons ((4)) ((Z Unit)) ((Acons ((-1)) ((S (Z Unit))) ((Anil Unit))))))))))), (1))
                , ((((2)), ((Acons ((-5)) ((Z Unit)) ((Acons ((2)) ((S (Z Unit))) ((Acons ((3)) ((Z Unit)) ((Acons ((-3)) ((Z Unit)) ((Anil Unit))))))))))), (1))
                , ((((5)), ((Acons ((5)) ((S (Z Unit))) ((Acons ((-1)) ((Z Unit)) ((Acons ((4)) ((Z Unit)) ((Acons ((-5)) ((Z Unit)) ((Anil Unit))))))))))), (1))
                , ((((0)), ((Acons ((0)) ((S (Z Unit))) ((Acons ((3)) ((Z Unit)) ((Acons ((1)) ((Z Unit)) ((Acons ((-3)) ((Z Unit)) ((Anil Unit))))))))))), (1))
                , ((((-1)), ((Acons ((-1)) ((S (S (Z Unit)))) ((Acons ((-2)) ((S (Z Unit))) ((Acons ((-3)) ((Z Unit)) ((Anil Unit))))))))), (2))
