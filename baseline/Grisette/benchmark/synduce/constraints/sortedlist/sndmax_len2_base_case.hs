...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam11_0] ++ [mrgParam21_0] ++ [mrgCzero1_0] ++ [mrgAl_inf1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam12_0] ++ [mrgCzero2_0] ++ [mrgAl_inf2_0]
...
is_sorted = 
  let
    f xs = 
      case xs of
        Nil _ -> (toSym True)
        Cons a b t -> ((a >~  0) &&~  (b >~  0)) &&~  ((a >~  b) &&~  ((next_is_lt b t) &&~  (f t)))
        ...
        Scons h t -> 
          let
            res =
              (f t)
          in
          ((max' h (fst res)), (max' (snd res) (min' h (fst res))))
  ...
  let
    f c = 
      case c of
        ...
        Cons a b t -> 
          evalU1_0 (RefEnv [("b", (Env0 b)), ("a", (Env0 a))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                ((((Cons ((5)) ((4)) ((Cons ((3)) ((1)) ((Nil Unit))))))), (4))
                , ((((Cons ((4)) ((3)) ((Cons ((2)) ((1)) ((Nil Unit))))))), (3))
                , ((((Cons ((5)) ((4)) ((Cons ((3)) ((2)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((4)) ((Cons ((3)) ((2)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((3)) ((Cons ((2)) ((1)) ((Nil Unit))))))), (3))
                , ((((Cons ((5)) ((4)) ((Cons ((2)) ((1)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((4)) ((Cons ((3)) ((2)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((4)) ((Cons ((2)) ((1)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((4)) ((Cons ((3)) ((2)) ((Nil Unit))))))), (4))
                , ((((Cons ((5)) ((4)) ((Cons ((2)) ((1)) ((Nil Unit))))))), (4))
