...
-- output_type: {Bool,Int}
-- param_list: r tmp1 t l a global0 tmp2 n
data Expr2_0
  = Param12_0
  | Param62_0
...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam10_1] ++ [mrgParam20_1] ++ [mrgParam30_1] ++ [mrgCzero0_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_0_1 e0_0] ++ [mrgMax0_1 e1_6 e1_7])
        return res
    gen2 gendepth
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam11_1] ++ [mrgParam31_1] ++ [mrgParam41_1] ++ [mrgCzero1_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_1_1 e0_0] ++ [mrgMax1_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam12_0] ++ [mrgParam62_0]
    genSingle1 = [mrgParam42_1] ++ [mrgParam52_1] ++ [mrgParam72_1] ++ [mrgCzero2_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_2_1 e0_0] ++ [mrgMax2_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess0_2_3_0 e2_0] ++ [mrgCeq3_0 e1_0 e1_1] ++ [mrgCless3_0 e1_2 e1_3] ++ [mrgCleq3_0 e1_4 e1_5] ++ [mrgCand3_0 e0_0 e0_1] ++ [mrgCor3_0 e0_2 e0_3] ++ [mrgCnot3_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd3_1 e1_0 e1_1] ++ [mrgCsub3_1 e1_2 e1_3] ++ [mrgCIte3_1 e0_0 e1_4 e1_5] ++ [mrgAccess1_2_3_1 e2_0] ++ [mrgMax3_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
eval0_1 env (Param10_1) = evalVar0 env "n"
...
eval1_1 env (Param11_1) = evalVar0 env "n"
eval1_1 env (Param31_1) = evalVar0 env "a"
eval1_1 env (Param41_1) = evalVar0 env "global0"
...
eval2_0 env (Param12_0) = evalVar1 env "tmp1"
eval2_0 env (Param62_0) = evalVar1 env "tmp2"
...
eval2_1 env (Param72_1) = evalVar0 env "n"
...
eval3_2 :: RefEnv -> Expr3_2 -> (SymBool, SymInteger)
eval3_2 env (Param03_2) = evalVar1 env "tmp4"
eval3_2 env (Prod3_2 p0 p1) = ((evalU3_0 env p0), (evalU3_1 env p1))

evalU3_2 :: RefEnv -> UnionM Expr3_2 -> (SymBool, SymInteger)
...
is_memo = 
  let
    f t = 
      case t of
        Mleaf n x -> (toSym True)
        Mnode n a l r -> (((n >=~  (tmax l)) &&~  (n >=~  (tmax r))) &&~  (n >=~  a)) &&~  ((f l) &&~  (f r))
...
target global0 = 
  let
    f t = 
      case t of
        Mleaf n a -> 
          evalU0_0 (RefEnv [("n", (Env0 n)), ("global0", (Env0 global0)), ("a", (Env0 a))]) ((genSym (2::Int) "hole0") :: (UnionM Expr0_0))
        Mnode n a l r -> mrgIte (global0 >~  n)
            (evalU1_0 (RefEnv [("n", (Env0 n)), ("a", (Env0 a)), ("global0", (Env0 global0))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp1 =
                (f l)
            in
            let
              tmp2 =
                (f r)
            in
            evalU2_0 (RefEnv [("tmp1", (Env1 tmp1)), ("tmp2", (Env1 tmp2)), ("a", (Env0 a)), ("global0", (Env0 global0)), ("n", (Env0 n))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_memo mt)
    ...
    let
      tmp4 =
        (target global0 mt)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp4", (Env1 tmp4))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0)))
    ((toSym False))
...
ioPair :: [((SymInteger, TreeMemo), Bool)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, TreeMemo), Bool)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((-1)), ((Mleaf ((4)) ((3))))), (toSym False))
                , ((((-4)), ((Mnode ((-3)) ((5)) ((Mleaf ((2)) ((5)))) ((Mnode ((0)) ((-5)) ((Mleaf ((-3)) ((2)))) ((Mleaf ((-3)) ((-1))))))))), (toSym False))
                , ((((-1)), ((Mleaf ((2)) ((0))))), (toSym False))
                , ((((2)), ((Mleaf ((-1)) ((3))))), (toSym False))
                , ((((3)), ((Mnode ((5)) ((-2)) ((Mnode ((-5)) ((5)) ((Mleaf ((2)) ((-3)))) ((Mleaf ((2)) ((3)))))) ((Mnode ((-1)) ((1)) ((Mleaf ((4)) ((-4)))) ((Mleaf ((-2)) ((-2))))))))), (toSym False))
                , ((((2)), ((Mleaf ((-1)) ((-1))))), (toSym False))
                , ((((-3)), ((Mnode ((-1)) ((0)) ((Mleaf ((5)) ((1)))) ((Mnode ((1)) ((0)) ((Mleaf ((2)) ((-4)))) ((Mnode ((1)) ((4)) ((Mleaf ((2)) ((3)))) ((Mleaf ((4)) ((-4))))))))))), (toSym False))
                , ((((-3)), ((Mleaf ((3)) ((-1))))), (toSym False))
                , ((((-3)), ((Mnode ((-4)) ((4)) ((Mleaf ((3)) ((5)))) ((Mleaf ((-1)) ((-3))))))), (toSym False))
                , ((((1)), ((Mleaf ((3)) ((2))))), (toSym False))
                , ((((-1)), ((Mleaf ((2)) ((-3))))), (toSym False))
                , ((((-1)), ((Mnode ((5)) ((-4)) ((Mleaf ((-5)) ((0)))) ((Mleaf ((1)) ((-4))))))), (toSym False))
                , ((((-4)), ((Mleaf ((5)) ((-4))))), (toSym True))
                , ((((-1)), ((Mnode ((1)) ((-4)) ((Mleaf ((-5)) ((3)))) ((Mleaf ((1)) ((5))))))), (toSym False))
                , ((((5)), ((Mnode ((-1)) ((5)) ((Mleaf ((-1)) ((-3)))) ((Mleaf ((-2)) ((4))))))), (toSym False))
                , ((((-2)), ((Mnode ((-4)) ((-4)) ((Mnode ((-4)) ((4)) ((Mnode ((-4)) ((-5)) ((Mleaf ((4)) ((1)))) ((Mleaf ((0)) ((2)))))) ((Mleaf ((-4)) ((3)))))) ((Mnode ((-5)) ((2)) ((Mleaf ((-1)) ((1)))) ((Mleaf ((2)) ((5))))))))), (toSym False))
                , ((((-3)), ((Mnode ((-3)) ((-5)) ((Mleaf ((-4)) ((-3)))) ((Mleaf ((-4)) ((5))))))), (toSym False))
                , ((((5)), ((Mleaf ((-4)) ((3))))), (toSym False))
                , ((((1)), ((Mnode ((-3)) ((3)) ((Mnode ((4)) ((5)) ((Mleaf ((-5)) ((3)))) ((Mleaf ((4)) ((0)))))) ((Mleaf ((5)) ((0))))))), (toSym False))
                , ((((3)), ((Mnode ((-5)) ((-2)) ((Mnode ((3)) ((1)) ((Mnode ((-5)) ((2)) ((Mnode ((-1)) ((-2)) ((Mleaf ((5)) ((2)))) ((Mleaf ((0)) ((4)))))) ((Mleaf ((4)) ((1)))))) ((Mleaf ((2)) ((2)))))) ((Mleaf ((-3)) ((2))))))), (toSym False))
                ]
