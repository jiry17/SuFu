...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam32_0] ++ [mrgParam42_0] ++ [mrgParam52_0] ++ [mrgCzero2_0]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam03_0] ++ [mrgParam43_0] ++ [mrgParam53_0] ++ [mrgCzero3_0]
...
eval2_0 env (Param32_0) = evalVar0 env "b"
eval2_0 env (Param42_0) = evalVar0 env "tmp3"
eval2_0 env (Param52_0) = evalVar0 env "a"
...
eval3_0 env (Param43_0) = evalVar0 env "b"
eval3_0 env (Param53_0) = evalVar0 env "a"
...
eval4_0 env (Param04_0) = evalVar0 env "tmp5"
  ...
  let
    f xs = 
      case xs of
        ...
        Usplit x a b y -> mrgIte (a >~  b)
            (let
              tmp3 =
                (f x)
            in
            evalU2_0 (RefEnv [("b", (Env0 b)), ("tmp3", (Env0 tmp3)), ("a", (Env0 a))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
            (let
              tmp4 =
                (f y)
            in
            evalU3_0 (RefEnv [("tmp4", (Env0 tmp4)), ("b", (Env0 b)), ("a", (Env0 a))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0)))
  ...
  mrgIte (is_unimodal (repr xs))
    (let
      tmp5 =
        (target xs)
    in
    evalU4_0 (RefEnv [("tmp5", (Env0 tmp5))]) ((genSym (1::Int) "hole4") :: (UnionM Expr4_0)))
    (0)
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(UList, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((Usplit ((Usplit ((Unil Unit)) ((2)) ((4)) ((Unil Unit)))) ((3)) ((2)) ((Unil Unit))))), (4))
                , ((((Usplit ((Unil Unit)) ((2)) ((4)) ((Usplit ((Unil Unit)) ((4)) ((2)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((3)) ((5)) ((Usplit ((Unil Unit)) ((3)) ((2)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Unil Unit)) ((5)) ((5)) ((Usplit ((Unil Unit)) ((2)) ((1)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Usplit ((Unil Unit)) ((1)) ((5)) ((Unil Unit)))) ((5)) ((3)) ((Unil Unit))))), (5))
                , ((((Usplit ((Unil Unit)) ((3)) ((4)) ((Usplit ((Unil Unit)) ((3)) ((2)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((4)) ((5)) ((Usplit ((Unil Unit)) ((3)) ((1)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Unil Unit)) ((1)) ((4)) ((Usplit ((Unil Unit)) ((3)) ((1)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Usplit ((Unil Unit)) ((2)) ((5)) ((Unil Unit)))) ((4)) ((3)) ((Unil Unit))))), (5))
                , ((((Usplit ((Usplit ((Unil Unit)) ((2)) ((4)) ((Unil Unit)))) ((2)) ((1)) ((Unil Unit))))), (4))
                , ((((Usplit ((Unil Unit)) ((2)) ((5)) ((Usplit ((Unil Unit)) ((3)) ((2)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Unil Unit)) ((3)) ((4)) ((Usplit ((Unil Unit)) ((3)) ((1)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((5)) ((5)) ((Usplit ((Unil Unit)) ((3)) ((1)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Usplit ((Unil Unit)) ((3)) ((4)) ((Unil Unit)))) ((3)) ((1)) ((Unil Unit))))), (4))
                , ((((Usplit ((Unil Unit)) ((3)) ((5)) ((Usplit ((Unil Unit)) ((3)) ((2)) ((Unil Unit))))))), (5))
                , ((((Usplit ((Unil Unit)) ((3)) ((4)) ((Usplit ((Unil Unit)) ((4)) ((3)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((1)) ((4)) ((Usplit ((Unil Unit)) ((2)) ((1)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((1)) ((3)) ((Usplit ((Unil Unit)) ((2)) ((1)) ((Unil Unit))))))), (3))
                , ((((Usplit ((Unil Unit)) ((1)) ((2)) ((Usplit ((Unil Unit)) ((4)) ((1)) ((Unil Unit))))))), (4))
                , ((((Usplit ((Unil Unit)) ((1)) ((3)) ((Usplit ((Unil Unit)) ((5)) ((3)) ((Unil Unit))))))), (5))
                ]
