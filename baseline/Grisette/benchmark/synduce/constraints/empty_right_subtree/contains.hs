  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_3_0 e1_0] ++ [mrgAccess1_1_3_0 e1_1])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval2_1 env (Param22_1) = evalVar0 env "a"
...
eval3_0 env (Param13_0) = evalVar0 env "global0"
...
eval3_1 env (Param03_1) = evalVar1 env "tmp5"
...
empty_right :: Tree -> SymBool
empty_right = 
  let
    f t = 
      case t of
        Node _ l r -> (0 ==~  (size r)) &&~  (f l)
        _ -> (toSym True)
  in
  f 
        ...
        Node a l r -> 
          let
            tmp3 =
              (f l)
          in
          evalU2_0 (RefEnv [("tmp3", (Env1 tmp3)), ("a", (Env0 a))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0))
      
  in
  f 

main' global0 t = 
  mrgIte (empty_right t)
    (let
      tmp4 =
        (spec global0)
    in
    let
      tmp5 =
        (target t)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp5", (Env1 tmp5))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
main = do
    let pairs = [
                ((((-4)), ((Node ((-4)) ((Node ((-5)) ((Node ((-4)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-3)), ((Node ((4)) ((Node ((-3)) ((Node ((-3)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-2)), ((Node ((-2)) ((Node ((-1)) ((Node ((3)) ((Node ((-1)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-1)), ((Node ((-1)) ((Node ((-3)) ((Node ((-4)) ((Node ((0)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((3)), ((Node ((-2)) ((Node ((-2)) ((Node ((3)) ((Node ((-1)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-1)), ((Node ((-3)) ((Node ((1)) ((Node ((2)) ((Node ((-1)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-5)), ((Node ((3)) ((Node ((-3)) ((Node ((4)) ((Node ((-5)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-5)), ((Node ((4)) ((Node ((-3)) ((Node ((1)) ((Node ((-5)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-4)), ((Node ((4)) ((Node ((2)) ((Node ((-4)) ((Node ((-5)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((1)), ((Node ((-5)) ((Node ((-4)) ((Node ((1)) ((Node ((-2)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-2)), ((Node ((-2)) ((Node ((4)) ((Node ((-2)) ((Node ((-5)) ((Leaf (-4))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-2)), ((Node ((-2)) ((Node ((1)) ((Node ((3)) ((Node ((-5)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((5)), ((Node ((3)) ((Node ((-2)) ((Node ((5)) ((Node ((-1)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-2)), ((Node ((-5)) ((Node ((3)) ((Node ((-2)) ((Node ((-3)) ((Leaf (5))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-4)), ((Node ((-4)) ((Node ((0)) ((Node ((2)) ((Node ((3)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((-5)), ((Node ((0)) ((Node ((5)) ((Node ((-5)) ((Node ((4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((1)), ((Node ((-3)) ((Node ((1)) ((Node ((0)) ((Node ((-3)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((0)), ((Node ((-2)) ((Node ((-5)) ((Node ((1)) ((Node ((0)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((1)), ((Node ((-5)) ((Node ((4)) ((Node ((-1)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                , ((((4)), ((Node ((-3)) ((Node ((2)) ((Node ((-2)) ((Node ((4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit))))), (1))
                ]
