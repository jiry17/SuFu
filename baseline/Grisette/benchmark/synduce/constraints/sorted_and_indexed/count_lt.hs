...
-- output_type: Int
-- param_list: h idx t tmp1 xs global0
data Expr2_0
  = Param02_0
  | Param12_0
  | Param32_0
...
-- output_type: Int
-- param_list: global0 tmp3 xs inp
data Expr3_0
  = Param03_0
  | Param13_0
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam31_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgParam12_0] ++ [mrgParam32_0] ++ [mrgParam52_0] ++ [mrgCzero2_0]
...
eval1_0 env (Param31_0) = evalVar0 env "idx"
...
eval2_0 env (Param12_0) = evalVar0 env "idx"
eval2_0 env (Param32_0) = evalVar0 env "tmp1"
eval2_0 env (Param52_0) = evalVar0 env "global0"
...
spec global0 = 
  let
    f xs = 
      case xs of
        Elt x -> mrgIte (x <~  global0)
            (1)
            (0)
        Cons h t -> (f t) +  (mrgIte (h <~  global0)
            (1)
            (-1))
  in
  f 
...
target global0 = 
  let
    f xs = 
      case xs of
        Ielt x -> 
          evalU0_0 (RefEnv [("global0", (Env0 global0)), ("x", (Env0 x))]) ((genSym (3::Int) "hole0") :: (UnionM Expr0_0))
        Icons h idx t -> mrgIte (h <~  global0)
            (evalU1_0 (RefEnv [("global0", (Env0 global0)), ("idx", (Env0 idx)), ("h", (Env0 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp1 =
                (f t)
            in
            evalU2_0 (RefEnv [("h", (Env0 h)), ("idx", (Env0 idx)), ("tmp1", (Env0 tmp1)), ("global0", (Env0 global0))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte ((is_sorted inp) &&~  (is_indexed inp))
    ...
    let
      tmp3 =
        (target global0 inp)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp3", (Env0 tmp3))]) ((genSym (3::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
