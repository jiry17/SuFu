...
eval0_0 env (Param20_0) = evalVar0 env "info"
        ...
        Ncons h t -> 
          ...
          let
            res =
              (f t)
          in
          ((min' (fst rh) (fst res)), (max' (snd rh) (snd res)))
        ...
        Cat l r -> 
          ...
          let
            tmp2 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("tmp1", (Env0 tmp1))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
...
main' c = 
  let
    tmp3 =
      (target c)
  in
  evalU2_0 (RefEnv [("tmp3", (Env0 tmp3))]) ((genSym (2::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair :: [(CNList, (Integer, Integer))] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(CNList, (Integer, Integer))] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((Cat ((Sglt (Cons ((5)) ((Cons ((-3)) ((Elt (-1)))))))) ((Cat ((Sglt (Elt (4)))) ((Sglt (Elt (-4))))))))), (((-4)), ((5))))
                , ((((Cat ((Sglt (Elt (-1)))) ((Sglt (Elt (5))))))), (((-1)), ((5))))
                , ((((Cat ((Sglt (Cons ((4)) ((Cons ((5)) ((Cons ((-5)) ((Elt (-4)))))))))) ((Sglt (Elt (-3))))))), (((-5)), ((5))))
                , ((((Sglt (Cons ((3)) ((Cons ((5)) ((Elt (-5))))))))), (((-5)), ((5))))
                , ((((Cat ((Cat ((Sglt (Cons ((1)) ((Elt (-2)))))) ((Sglt (Elt (-3)))))) ((Sglt (Elt (-3))))))), (((-3)), ((1))))
                , ((((Sglt (Elt (-3))))), (((-3)), ((-3))))
                , ((((Sglt (Cons ((-2)) ((Elt (-3))))))), (((-3)), ((-2))))
                , ((((Sglt (Cons ((-2)) ((Elt (5))))))), (((-2)), ((5))))
                , ((((Sglt (Cons ((2)) ((Cons ((-3)) ((Cons ((0)) ((Elt (-5))))))))))), (((-5)), ((2))))
                , ((((Sglt (Cons ((4)) ((Elt (5))))))), (((4)), ((5))))
                , ((((Sglt (Elt (-4))))), (((-4)), ((-4))))
                , ((((Cat ((Sglt (Elt (1)))) ((Sglt (Cons ((5)) ((Cons ((-3)) ((Elt (2))))))))))), (((-3)), ((5))))
                , ((((Cat ((Cat ((Sglt (Elt (-2)))) ((Sglt (Elt (0)))))) ((Sglt (Cons ((-1)) ((Cons ((-1)) ((Elt (1))))))))))), (((-2)), ((1))))
                , ((((Sglt (Cons ((2)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((0)) ((Elt (2))))))))))))))))), (((-5)), ((5))))
                , ((((Cat ((Cat ((Sglt (Elt (-2)))) ((Sglt (Elt (3)))))) ((Sglt (Elt (-3))))))), (((-3)), ((3))))
                , ((((Sglt (Elt (3))))), (((3)), ((3))))
                , ((((Sglt (Cons ((-1)) ((Cons ((-1)) ((Cons ((-2)) ((Cons ((2)) ((Cons ((4)) ((Cons ((3)) ((Elt (0))))))))))))))))), (((-2)), ((4))))
                , ((((Sglt (Elt (2))))), (((2)), ((2))))
                , ((((Cat ((Sglt (Cons ((3)) ((Cons ((-5)) ((Elt (-4)))))))) ((Sglt (Cons ((2)) ((Elt (1))))))))), (((-5)), ((3))))
                , ((((Cat ((Sglt (Elt (-4)))) ((Sglt (Cons ((0)) ((Elt (1))))))))), (((-4)), ((1))))
                ]
