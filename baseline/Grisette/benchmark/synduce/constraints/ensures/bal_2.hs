  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_0_1 e0_0] ++ [mrgAccess1_0_0_1 e0_1] ++ [mrgMin0_1 e1_6 e1_7])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_1_1 e0_0] ++ [mrgAccess1_0_1_1 e0_1] ++ [mrgMin1_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1] ++ [mrgMin2_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCeq3_0 e2_0 e2_1] ++ [mrgCless3_0 e2_2 e2_3] ++ [mrgCleq3_0 e2_4 e2_5] ++ [mrgCand3_0 e0_0 e0_1] ++ [mrgCor3_0 e0_2 e0_3] ++ [mrgCnot3_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd3_2 e2_0 e2_1] ++ [mrgCsub3_2 e2_2 e2_3] ++ [mrgCIte3_2 e0_0 e2_4 e2_5] ++ [mrgAccess0_1_3_2 e1_0] ++ [mrgAccess1_1_3_2 e1_1] ++ [mrgMin3_2 e2_6 e2_7])
        return res
...
eval1_1 env (Param01_1) = evalVar0 env "x"
...
f :: List -> (SymInteger, SymInteger, SymBool)
f x = 
      case x of
        Nil _ -> (0, 0, (toSym True))
        Cons h t -> 
          let
            result =
              (f t)
...
main' x = 
  let
    tmp5 =
      (repr x)
  in
  evalU3_0 (RefEnv [("tmp5", (Env1 tmp5))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0))
...
main = do
    let pairs = [
                ((((Concat ((Cnil Unit)) ((Single (0)))))), (toSym False))
                , ((((Concat ((Concat ((Single (1))) ((Concat ((Concat ((Concat ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Single (1))))) ((Cnil Unit)))) ((Single (0))))) ((Single (0))))))) ((Concat ((Cnil Unit)) ((Single (1)))))))), (toSym False))
                , ((((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Concat ((Single (0))) ((Cnil Unit)))) ((Single (-1)))))))), (toSym False))
                , ((((Concat ((Concat ((Single (-1))) ((Cnil Unit)))) ((Concat ((Concat ((Concat ((Cnil Unit)) ((Single (0))))) ((Single (-1))))) ((Concat ((Single (0))) ((Concat ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Single (-1))))))) ((Cnil Unit))))))))))), (toSym False))
                , ((((Concat ((Concat ((Concat ((Single (1))) ((Concat ((Concat ((Single (-1))) ((Cnil Unit)))) ((Single (-1))))))) ((Concat ((Single (0))) ((Concat ((Cnil Unit)) ((Cnil Unit)))))))) ((Cnil Unit))))), (toSym False))
                , ((((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit))))), (toSym True))
                , ((((Concat ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))) ((Concat ((Concat ((Cnil Unit)) ((Single (1))))) ((Concat ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Cnil Unit)))))) ((Cnil Unit))))))))), (toSym True))
                , ((((Concat ((Single (1))) ((Concat ((Cnil Unit)) ((Cnil Unit))))))), (toSym True))
                , ((((Concat ((Concat ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (-1))) ((Single (1))))) ((Single (-1))))))) ((Concat ((Single (1))) ((Single (0))))))) ((Concat ((Single (1))) ((Cnil Unit))))))), (toSym True))
                , ((((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Cnil Unit))))))), (toSym True))
                , ((((Concat ((Cnil Unit)) ((Concat ((Concat ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (0))) ((Cnil Unit)))) ((Single (0))))))) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Single (0)))))))))), (toSym False))
                , ((((Concat ((Concat ((Concat ((Cnil Unit)) ((Single (-1))))) ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (0))) ((Concat ((Single (-1))) ((Single (0))))))) ((Cnil Unit)))))))) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Single (-1)))))))))), (toSym False))
                , ((((Concat ((Concat ((Concat ((Single (0))) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Single (0))))))))) ((Concat ((Single (1))) ((Cnil Unit))))))), (toSym False))
                , ((((Concat ((Cnil Unit)) ((Concat ((Single (0))) ((Concat ((Concat ((Single (0))) ((Concat ((Concat ((Single (1))) ((Single (-1))))) ((Single (-1))))))) ((Concat ((Cnil Unit)) ((Single (-1)))))))))))), (toSym False))
                , ((((Concat ((Single (1))) ((Cnil Unit))))), (toSym True))
                , ((((Concat ((Concat ((Single (0))) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Single (1)))))))))), (toSym True))
                , ((((Concat ((Cnil Unit)) ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit))))))), (toSym True))
                , ((((Concat ((Concat ((Concat ((Cnil Unit)) ((Single (-1))))) ((Cnil Unit)))) ((Concat ((Concat ((Single (-1))) ((Concat ((Cnil Unit)) ((Concat ((Single (0))) ((Cnil Unit)))))))) ((Concat ((Single (0))) ((Cnil Unit))))))))), (toSym False))
                , ((((Concat ((Concat ((Cnil Unit)) ((Single (1))))) ((Single (1)))))), (toSym True))
                , ((((Concat ((Single (-1))) ((Concat ((Cnil Unit)) ((Cnil Unit))))))), (toSym False))
                ]
