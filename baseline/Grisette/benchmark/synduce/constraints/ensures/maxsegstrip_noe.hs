...
data Expr2_1
  = Param12_1
  | Prod2_1 (UnionM Expr2_2) (UnionM Expr2_2) (UnionM Expr2_2) (UnionM Expr2_2)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgProd2_1 e2_0 e2_1 e2_2 e2_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e3_0 e2_4 e2_5] ++ [mrgAccess0_1_2_2 e1_0] ++ [mrgAccess1_1_2_2 e1_1] ++ [mrgAccess2_1_2_2 e1_2] ++ [mrgAccess3_1_2_2 e1_3] ++ [mrgAccess0_0_2_2 e0_0] ++ [mrgAccess1_0_2_2 e0_1] ++ [mrgAccess2_0_2_2 e0_2] ++ [mrgMax2_2 e2_6 e2_7])
        return res
    gen3 gendepth
...
eval2_1 env (Prod2_1 p0 p1 p2 p3) = ((evalU2_2 env p0), (evalU2_2 env p1), (evalU2_2 env p2), (evalU2_2 env p3))
...
eval2_2 env (CIte2_2 p0 p1 p2) = mrgIte ((evalU2_3 env p0) ==~ (toSym True)) (evalU2_2 env p1) (evalU2_2 env p2)
eval2_2 env (Access0_1_2_2 p0) = get1from4 (evalU2_1 env p0)
eval2_2 env (Access1_1_2_2 p0) = get2from4 (evalU2_1 env p0)
eval2_2 env (Access2_1_2_2 p0) = get3from4 (evalU2_1 env p0)
eval2_2 env (Access3_1_2_2 p0) = get4from4 (evalU2_1 env p0)
            ...
            Ncons h t -> 
              ...
              let
                res =
                  (f t)
              in
              ((max' ((get1from4 res) +  hsum) 0), (max' (get2from4 res) ((get1from4 res) +  hsum)), (max' ((get4from4 res) +  hsum) (get3from4 res)), ((get4from4 res) +  hsum))
          
      in
      f  xs)
  in
  ((get1from4 res), (get2from4 res), (get3from4 res))
        ...
        Sglt x -> 
          let
            info =
              (sum' x)
          in
          evalU0_0 (RefEnv [("info", (Env0 info))]) ((genSym (2::Int) "hole0") :: (UnionM Expr0_0))
        Cat l r -> 
          let
            tmp1 =
              (f l)
          ...
          let
            tmp2 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp2", (Env1 tmp2)), ("tmp1", (Env1 tmp1))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
...
ioPair :: [(CNList, (Integer, Integer, Integer))] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(CNList, (Integer, Integer, Integer))] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((Sglt (Cons ((-2)) ((Cons ((2)) ((Cons ((4)) ((Cons ((5)) ((Cons ((-4)) ((Cons ((5)) ((Cons ((3)) ((Cons ((3)) ((Elt (-3))))))))))))))))))))), (((13)), ((13)), ((13))))
                , ((((Cat ((Sglt (Cons ((5)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((5)) ((Cons ((1)) ((Cons ((4)) ((Cons ((-2)) ((Cons ((-2)) ((Elt (2)))))))))))))))))))) ((Sglt (Cons ((1)) ((Cons ((-1)) ((Cons ((-3)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((5)) ((Cons ((-1)) ((Elt (-2))))))))))))))))))))), (((12)), ((12)), ((5))))
                , ((((Cat ((Cat ((Sglt (Elt (-4)))) ((Sglt (Cons ((4)) ((Elt (2)))))))) ((Cat ((Sglt (Elt (-4)))) ((Sglt (Elt (-5))))))))), (((2)), ((6)), ((0))))
                , ((((Cat ((Cat ((Sglt (Cons ((-4)) ((Elt (-1)))))) ((Sglt (Cons ((-1)) ((Elt (-1)))))))) ((Cat ((Sglt (Cons ((2)) ((Elt (4)))))) ((Sglt (Cons ((5)) ((Elt (-1))))))))))), (((3)), ((10)), ((10))))
                , ((((Sglt (Cons ((1)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((3)) ((Cons ((-5)) ((Elt (-4))))))))))))))), (((0)), ((0)), ((0))))
                , ((((Sglt (Cons ((-1)) ((Cons ((-2)) ((Cons ((5)) ((Cons ((-4)) ((Cons ((-5)) ((Elt (-2))))))))))))))), (((0)), ((0)), ((0))))
                , ((((Sglt (Cons ((4)) ((Elt (-4))))))), (((0)), ((0)), ((0))))
                , ((((Cat ((Sglt (Elt (1)))) ((Sglt (Cons ((-5)) ((Cons ((-5)) ((Cons ((5)) ((Cons ((5)) ((Elt (-5))))))))))))))), (((1)), ((1)), ((0))))
                , ((((Cat ((Sglt (Elt (-5)))) ((Sglt (Cons ((3)) ((Cons ((1)) ((Elt (-2))))))))))), (((0)), ((2)), ((2))))
                , ((((Sglt (Elt (4))))), (((4)), ((4)), ((4))))
                , ((((Sglt (Cons ((1)) ((Elt (0))))))), (((1)), ((1)), ((1))))
                , ((((Cat ((Sglt (Cons ((2)) ((Cons ((-1)) ((Cons ((2)) ((Elt (5)))))))))) ((Sglt (Cons ((-2)) ((Elt (2))))))))), (((8)), ((8)), ((8))))
                , ((((Sglt (Cons ((-4)) ((Elt (3))))))), (((0)), ((0)), ((0))))
                , ((((Sglt (Elt (3))))), (((3)), ((3)), ((3))))
                , ((((Cat ((Cat ((Sglt (Elt (-3)))) ((Sglt (Cons ((4)) ((Cons ((4)) ((Elt (3)))))))))) ((Sglt (Cons ((0)) ((Cons ((5)) ((Elt (5))))))))))), (((18)), ((21)), ((21))))
                , ((((Cat ((Sglt (Cons ((4)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((5)) ((Cons ((5)) ((Cons ((4)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((2)) ((Elt (-3)))))))))))))))))))))))))) ((Sglt (Cons ((3)) ((Elt (-3))))))))), (((8)), ((8)), ((8))))
                , ((((Cat ((Sglt (Elt (2)))) ((Sglt (Cons ((1)) ((Cons ((-2)) ((Elt (-1))))))))))), (((2)), ((2)), ((0))))
                , ((((Sglt (Cons ((3)) ((Cons ((-5)) ((Elt (-1))))))))), (((0)), ((0)), ((0))))
                , ((((Cat ((Cat ((Sglt (Elt (-5)))) ((Sglt (Cons ((-1)) ((Cons ((5)) ((Cons ((4)) ((Elt (-2)))))))))))) ((Sglt (Cons ((-2)) ((Cons ((1)) ((Elt (-2))))))))))), (((1)), ((6)), ((3))))
                , ((((Sglt (Elt (-3))))), (((0)), ((0)), ((0))))
                ]
