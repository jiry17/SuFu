...
eval2_1 env (Param42_1) = evalVar0 env "global0"
...
eval3_1 env (Param23_1) = evalVar1 env "tmp5"
        ...
        Node a l r -> mrgIte (global0 <~  a)
            ...
            (let
              tmp3 =
                (f r)
            in
            evalU2_0 (RefEnv [("tmp3", (Env1 tmp3)), ("a", (Env0 a)), ("global0", (Env0 global0))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0)))
  in
  f 
  ...
  mrgIte (is_bst t)
    ...
    let
      tmp5 =
        (target global0 t)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp5", (Env1 tmp5))]) ((genSym (2::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
