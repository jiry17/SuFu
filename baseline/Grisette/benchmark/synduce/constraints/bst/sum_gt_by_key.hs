...
-- output_type: Int
-- param_list: global0 tmp2 l tmp3 a r m
data Expr1_0
  = Param01_0
  | Param11_0
  | Param31_0
...
-- output_type: Int
-- param_list: global0 l a r m tmp4
data Expr2_0
  = Param02_0
  | Param22_0
  | Param52_0
...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam00_0] ++ [mrgParam10_0] ++ [mrgParam40_0] ++ [mrgCzero0_0]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam11_0] ++ [mrgParam31_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam02_0] ++ [mrgParam22_0] ++ [mrgParam52_0] ++ [mrgCzero2_0]
...
eval0_0 env (Param00_0) = evalVar0 env "k"
eval0_0 env (Param10_0) = evalVar0 env "global0"
eval0_0 env (Param40_0) = evalVar0 env "v"
...
eval1_0 env (Param31_0) = evalVar0 env "tmp3"
eval1_0 env (Param41_0) = evalVar0 env "a"
...
eval2_0 env (Param02_0) = evalVar0 env "global0"
eval2_0 env (Param22_0) = evalVar0 env "a"
...
eval3_0 env (Param23_0) = evalVar0 env "tmp6"
...
Hole grammar for #1
global0 tmp2 l tmp3 a r m 

Hole grammar for #2
global0 l a r m tmp4 
...
spec global0 = 
  let
    f l = 
      case l of
        Elt k v -> mrgIte (k >~  global0)
            (v)
            (0)
        Cons k v t -> (mrgIte (k >~  global0)
            (v)
            (0)) +  (f t)
        ...
        Value k v -> 
          let
            tmp1 =
              (Value k v)
          in
          evalU0_0 (RefEnv [("k", (Env0 k)), ("global0", (Env0 global0)), ("v", (Env0 v))]) ((genSym (4::Int) "hole0") :: (UnionM Expr0_0))
        Node a l r -> mrgIte (a >~  global0)
            ...
            let
              tmp3 =
                (f r)
            in
            evalU1_0 (RefEnv [("global0", (Env0 global0)), ("tmp2", (Env0 tmp2)), ("tmp3", (Env0 tmp3)), ("a", (Env0 a))]) ((genSym (6::Int) "hole1") :: (UnionM Expr1_0)))
            (let
              tmp4 =
                (f r)
            in
            evalU2_0 (RefEnv [("global0", (Env0 global0)), ("a", (Env0 a)), ("tmp4", (Env0 tmp4))]) ((genSym (6::Int) "hole2") :: (UnionM Expr2_0)))
  ...
  mrgIte (is_map m)
    ...
    let
      tmp6 =
        (target global0 m)
    in
    evalU3_0 (RefEnv [("global0", (Env0 global0)), ("tmp6", (Env0 tmp6))]) ((genSym (4::Int) "hole3") :: (UnionM Expr3_0)))
    (0)
...
ioPair :: [((SymInteger, Map), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, Map), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((