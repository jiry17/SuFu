...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam42_1] ++ [mrgParam52_1] ++ [mrgParam62_1] ++ [mrgCzero2_1]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam23_0] ++ [mrgParam73_0]
    genSingle1 = [mrgParam33_1] ++ [mrgParam53_1] ++ [mrgParam63_1] ++ [mrgCzero3_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd3_1 e1_0 e1_1] ++ [mrgCsub3_1 e1_2 e1_3] ++ [mrgCIte3_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_3_1 e0_0] ++ [mrgAccess1_0_3_1 e0_1] ++ [mrgMin3_1 e1_6 e1_7] ++ [mrgMax3_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam24_0] ++ [mrgParam34_0] ++ [mrgCzero4_0]
    genSingle1 = [mrgParam04_1]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd4_0 e0_0 e0_1] ++ [mrgCsub4_0 e0_2 e0_3] ++ [mrgCIte4_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_4_0 e1_0] ++ [mrgAccess1_1_4_0 e1_1] ++ [mrgMin4_0 e0_6 e0_7] ++ [mrgMax4_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval0_1 env (Param40_1) = evalVar0 env "global1"
...
eval2_1 env (Param52_1) = evalVar0 env "global1"
...
eval3_0 env (Param23_0) = evalVar1 env "tmp4"
eval3_0 env (Param73_0) = evalVar1 env "tmp5"
...
eval3_1 env (Param33_1) = evalVar0 env "a"
eval3_1 env (Param53_1) = evalVar0 env "global0"
eval3_1 env (Param63_1) = evalVar0 env "global1"
...
eval4_1 env (Param04_1) = evalVar1 env "tmp7"
...
spec global0 global1 = 
  let
    f t = 
      case t of
        Leaf a -> mrgIte ((global1 >~  a) &&~  (a >~  global0))
            (a)
            (0)
        Node a l r -> (mrgIte ((global1 >~  a) &&~  (a >~  global0))
            (a)
            (0)) +  ((f l) +  (f r))
        ...
        Node a l r -> mrgIte (a <~  global0)
            (let
              tmp2 =
                (f r)
            in
            evalU1_0 (RefEnv [("tmp2", (Env1 tmp2)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0)))
            (mrgIte (a >~  global1)
              (let
                tmp3 =
                  (f l)
              in
              evalU2_0 (RefEnv [("tmp3", (Env1 tmp3)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0)))
              (let
                tmp4 =
                  (f l)
              in
              let
                tmp5 =
                  (f r)
              in
              evalU3_0 (RefEnv [("tmp4", (Env1 tmp4)), ("tmp5", (Env1 tmp5)), ("a", (Env0 a)), ("global0", (Env0 global0)), ("global1", (Env0 global1))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0))))
...
main' global0 global1 t = 
  mrgIte (is_bst t)
    ...
    in
    evalU4_0 (RefEnv [("global1", (Env0 global1)), ("global0", (Env0 global0)), ("tmp7", (Env1 tmp7))]) ((genSym (1::Int) "hole4") :: (UnionM Expr4_0)))
    (0)
...
main = do
    let pairs = [
                ((((0)), ((3)), ((Node ((4)) ((Node ((-1)) ((Node ((-3)) ((Leaf (-5))) ((Leaf (-3))))) ((Node ((2)) ((Leaf (1))) ((Leaf (2))))))) ((Leaf (4)))))), (5))
