...
-- output_type: {Bool,Int}
-- param_list: r tmp4 l tmp3 a global0 t
data Expr2_0
  = Param12_0
  | Param32_0
...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam00_1] ++ [mrgParam20_1] ++ [mrgCzero0_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_0_1 e0_0] ++ [mrgMin0_1 e1_6 e1_7] ++ [mrgMax0_1 e1_8 e1_9])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_1_1 e0_0] ++ [mrgMin1_1 e1_6 e1_7] ++ [mrgMax1_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam12_0] ++ [mrgParam32_0]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_9 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess1_0_2_1 e0_0] ++ [mrgMin2_1 e1_6 e1_7] ++ [mrgMax2_1 e1_8 e1_9])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd3_2 e2_0 e2_1] ++ [mrgCsub3_2 e2_2 e2_3] ++ [mrgCIte3_2 e0_0 e2_4 e2_5] ++ [mrgAccess1_1_3_2 e1_0] ++ [mrgMin3_2 e2_6 e2_7] ++ [mrgMax3_2 e2_8 e2_9])
        return res
...
eval0_1 env (Param00_1) = evalVar0 env "global0"
        ...
        Leaf x -> 
          let
            tmp1 =
              (Leaf x)
          in
          evalU0_0 (RefEnv [("global0", (Env0 global0)), ("x", (Env0 x))]) ((genSym (2::Int) "hole0") :: (UnionM Expr0_0))
        Node a l r -> mrgIte (global0 <~  a)
            ...
            let
              tmp4 =
                (f r)
            in
            evalU2_0 (RefEnv [("tmp4", (Env1 tmp4)), ("tmp3", (Env1 tmp3)), ("a", (Env0 a)), ("global0", (Env0 global0))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0)))
...
main = do
    let pairs = [
                ((((3)), ((Node ((-4)) ((Leaf (-4))) ((Node ((-4)) ((Leaf (-4))) ((Node ((3)) ((Leaf (-2))) ((Leaf (4)))))))))), (toSym True))
                , ((((-1)), ((Node ((1)) ((Node ((-1)) ((Node ((-2)) ((Leaf (-4))) ((Leaf (-1))))) ((Leaf (1))))) ((Leaf (1)))))), (toSym True))
                , ((((-1)), ((Node ((-1)) ((Leaf (-3))) ((Node ((0)) ((Leaf (-1))) ((Node ((2)) ((Leaf (1))) ((Leaf (5)))))))))), (toSym True))
                , ((((-2)), ((Node ((2)) ((Node ((-5)) ((Leaf (-5))) ((Node ((1)) ((Leaf (-2))) ((Leaf (2))))))) ((Leaf (3)))))), (toSym True))
                , ((((-2)), ((Node ((-2)) ((Leaf (-5))) ((Node ((3)) ((Node ((1)) ((Leaf (-2))) ((Leaf (1))))) ((Leaf (3)))))))), (toSym True))
                , ((((5)), ((Node ((0)) ((Node ((-4)) ((Leaf (-5))) ((Leaf (-1))))) ((Node ((4)) ((Leaf (0))) ((Leaf (5)))))))), (toSym True))
                , ((((-5)), ((Node ((-3)) ((Leaf (-5))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (-3)))))))), (toSym True))
                , ((((-4)), ((Node ((-2)) ((Node ((-3)) ((Leaf (-4))) ((Leaf (-2))))) ((Leaf (-2)))))), (toSym True))
                , ((((-5)), ((Node ((-5)) ((Node ((-5)) ((Leaf (-5))) ((Leaf (-5))))) ((Leaf (-4)))))), (toSym True))
                , ((((-3)), ((Node ((-3)) ((Leaf (-4))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (0)))))))), (toSym True))
                , ((((-5)), ((Node ((-2)) ((Leaf (-5))) ((Node ((-1)) ((Leaf (-2))) ((Leaf (1)))))))), (toSym True))
                , ((((-5)), ((Node ((-5)) ((Leaf (-5))) ((Node ((-3)) ((Leaf (-5))) ((Leaf (1)))))))), (toSym True))
                , ((((-4)), ((Node ((-1)) ((Node ((-2)) ((Leaf (-4))) ((Leaf (-2))))) ((Leaf (3)))))), (toSym True))
                , ((((-3)), ((Node ((-4)) ((Leaf (-4))) ((Node ((-3)) ((Leaf (-4))) ((Leaf (1)))))))), (toSym True))
                , ((((-1)), ((Node ((-4)) ((Leaf (-5))) ((Node ((-1)) ((Leaf (-3))) ((Leaf (1)))))))), (toSym True))
                , ((((-2)), ((Node ((-1)) ((Node ((-3)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (5)))))), (toSym True))
                , ((((-1)), ((Node ((-1)) ((Node ((-3)) ((Leaf (-4))) ((Leaf (-2))))) ((Leaf (1)))))), (toSym True))
                , ((((-3)), ((Node ((-3)) ((Leaf (-3))) ((Node ((-3)) ((Leaf (-3))) ((Leaf (3)))))))), (toSym True))
                , ((((-2)), ((Node ((-1)) ((Leaf (-2))) ((Node ((-1)) ((Leaf (-1))) ((Leaf (0)))))))), (toSym True))
                , ((((-2)), ((Node ((-1)) ((Node ((-5)) ((Leaf (-5))) ((Leaf (-2))))) ((Leaf (2)))))), (toSym True))
                ]
