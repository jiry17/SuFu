...
-- output_type: Bool
-- param_list: r t l tmp3 a global1 b global0 tmp2
data Expr1_0
  = Param31_0
  | Param81_0
...
-- output_type: Bool
-- param_list: r tmp4 t a l global1 global0 b
data Expr2_0
  = Param12_0
...
-- output_type: Bool
-- param_list: r l a tmp5 global1 b global0 t tmp6
data Expr3_0
  = Param33_0
  | Param83_0
...
-- output_type: Bool
-- param_list: t global0 global1 tmp8
data Expr4_0
  = Param34_0
  | Inside4_0 (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1)
...
data Expr4_1
  ...
  | Min4_1 (UnionM Expr4_1) (UnionM Expr4_1)
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam31_0] ++ [mrgParam81_0]
    genSingle1 = [mrgParam41_1] ++ [mrgParam51_1] ++ [mrgParam61_1] ++ [mrgParam71_1] ++ [mrgCzero1_1]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam32_1] ++ [mrgParam52_1] ++ [mrgParam62_1] ++ [mrgParam72_1] ++ [mrgCzero2_1]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam33_0] ++ [mrgParam83_0]
    genSingle1 = [mrgParam23_1] ++ [mrgParam43_1] ++ [mrgParam53_1] ++ [mrgParam63_1] ++ [mrgCzero3_1]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam34_0]
    genSingle1 = [mrgParam14_1] ++ [mrgParam24_1] ++ [mrgCzero4_1]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
        ...
        e1_8 <- (gen1 (gendepth - 1))
        e1_9 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgInside4_0 e1_0 e1_1 e1_2 e1_3] ++ [mrgCeq4_0 e1_4 e1_5] ++ [mrgCless4_0 e1_6 e1_7] ++ [mrgCleq4_0 e1_8 e1_9] ++ [mrgCand4_0 e0_0 e0_1] ++ [mrgCor4_0 e0_2 e0_3] ++ [mrgCnot4_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e1_8 <- (gen1 (gendepth - 1))
        e1_9 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd4_1 e1_0 e1_1] ++ [mrgCsub4_1 e1_2 e1_3] ++ [mrgCIte4_1 e0_0 e1_4 e1_5] ++ [mrgMin4_1 e1_6 e1_7] ++ [mrgMax4_1 e1_8 e1_9])
        return res
...
eval1_0 env (Param81_0) = evalVar1 env "tmp2"
...
eval1_1 env (Param41_1) = evalVar0 env "a"
eval1_1 env (Param51_1) = evalVar0 env "global1"
eval1_1 env (Param61_1) = evalVar0 env "b"
eval1_1 env (Param71_1) = evalVar0 env "global0"
...
eval2_1 env (Param32_1) = evalVar0 env "a"
...
eval3_0 env (Param33_0) = evalVar1 env "tmp5"
eval3_0 env (Param83_0) = evalVar1 env "tmp6"
...
eval3_1 env (Param23_1) = evalVar0 env "a"
eval3_1 env (Param43_1) = evalVar0 env "global1"
eval3_1 env (Param53_1) = evalVar0 env "b"
eval3_1 env (Param63_1) = evalVar0 env "global0"
...
eval4_0 env (Param34_0) = evalVar1 env "tmp8"
eval4_0 env (Inside4_0 p0 p1 p2 p3) = inside (evalU4_1 env p0) (evalU4_1 env p1) (evalU4_1 env p2) (evalU4_1 env p3)
...
eval4_1 env (Param14_1) = evalVar0 env "global0"
eval4_1 env (Param24_1) = evalVar0 env "global1"
...
eval4_1 env (Min4_1 p0 p1) = min' (evalU4_1 env p0) (evalU4_1 env p1)
...
Hole grammar for #1
r t l tmp3 a global1 b global0 tmp2 

Hole grammar for #2
r tmp4 t a l global1 global0 b 

Hole grammar for #3
r l a tmp5 global1 b global0 t tmp6 

Hole grammar for #4
t global0 global1 tmp8 
-}
        ...
        Node a b l r -> mrgIte (b >~  global1)
            (mrgIte (a >~  global0)
              ...
              let
                tmp3 =
                  (f r)
              in
              evalU1_0 (RefEnv [("tmp3", (Env1 tmp3)), ("tmp2", (Env1 tmp2)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("b", (Env0 b)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0)))
              (let
                tmp4 =
                  (f r)
              in
              evalU2_0 (RefEnv [("tmp4", (Env1 tmp4)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("global0", (Env0 global0)), ("b", (Env0 b))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0))))
            (let
              tmp5 =
                (f l)
            in
            let
              tmp6 =
                (f r)
            in
            evalU3_0 (RefEnv [("tmp5", (Env1 tmp5)), ("tmp6", (Env1 tmp6)), ("a", (Env0 a)), ("global1", (Env0 global1)), ("b", (Env0 b)), ("global0", (Env0 global0))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0)))
...
main' global0 global1 t = 
  mrgIte (is_bst t)
    ...
    in
    evalU4_0 (RefEnv [("tmp8", (Env1 tmp8)), ("global0", (Env0 global0)), ("global1", (Env0 global1))]) ((genSym (1::Int) "hole4") :: (UnionM Expr4_0)))
    ((toSym False))
