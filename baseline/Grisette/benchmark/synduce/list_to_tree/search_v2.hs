...
data Expr2_2
  = Param02_2
  | Prod2_2 (UnionM Expr2_0) (UnionM Expr2_1)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess0_2_2_0 e2_0] ++ [mrgCeq2_0 e1_0 e1_1] ++ [mrgCless2_0 e1_2 e1_3] ++ [mrgCleq2_0 e1_4 e1_5] ++ [mrgCand2_0 e0_0 e0_1] ++ [mrgCor2_0 e0_2 e0_3] ++ [mrgCnot2_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e0_0 e1_4 e1_5] ++ [mrgAccess1_2_2_1 e2_0])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        e0_0 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgProd2_2 e0_0 e1_0])
        return res
...
eval2_1 env (Param22_1) = evalVar1 env "global0"
...
eval2_1 env (Access1_2_2_1 p0) = snd (evalU2_2 env p0)

evalU2_1 :: RefEnv -> UnionM Expr2_1 -> SymInteger
evalU2_1 env = onUnion (eval2_1 env)

eval2_2 :: RefEnv -> Expr2_2 -> (SymBool, SymInteger)
eval2_2 env (Param02_2) = evalVar0 env "tmp5"
eval2_2 env (Prod2_2 p0 p1) = ((evalU2_0 env p0), (evalU2_1 env p1))

evalU2_2 :: RefEnv -> UnionM Expr2_2 -> (SymBool, SymInteger)
...
main = do
    let pairs = [
                ((((4)), ((Node ((0)) ((Node ((-4)) ((Node ((3)) ((Empty Unit)) ((Empty Unit)))) ((Empty Unit)))) ((Empty Unit))))), (toSym False))
                , ((((-5)), ((Empty Unit))), (toSym False))
                , ((((1)), ((Node ((-2)) ((Node ((5)) ((Node ((5)) ((Empty Unit)) ((Node ((1)) ((Empty Unit)) ((Empty Unit)))))) ((Empty Unit)))) ((Empty Unit))))), (toSym True))
                , ((((-1)), ((Node ((-4)) ((Node ((0)) ((Node ((0)) ((Empty Unit)) ((Empty Unit)))) ((Empty Unit)))) ((Node ((2)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-2)), ((Node ((-5)) ((Node ((3)) ((Empty Unit)) ((Node ((-2)) ((Node ((3)) ((Empty Unit)) ((Empty Unit)))) ((Empty Unit)))))) ((Empty Unit))))), (toSym True))
                , ((((-3)), ((Node ((4)) ((Node ((4)) ((Empty Unit)) ((Empty Unit)))) ((Node ((1)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-1)), ((Node ((1)) ((Empty Unit)) ((Node ((1)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-4)), ((Node ((3)) ((Empty Unit)) ((Empty Unit))))), (toSym False))
                , ((((0)), ((Node ((5)) ((Empty Unit)) ((Empty Unit))))), (toSym False))
                , ((((4)), ((Node ((-3)) ((Empty Unit)) ((Node ((-3)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-5)), ((Empty Unit))), (toSym False))
                , ((((0)), ((Node ((-3)) ((Node ((-3)) ((Empty Unit)) ((Node ((3)) ((Empty Unit)) ((Node ((2)) ((Empty Unit)) ((Empty Unit)))))))) ((Empty Unit))))), (toSym False))
                , ((((1)), ((Node ((2)) ((Node ((5)) ((Empty Unit)) ((Empty Unit)))) ((Node ((4)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-2)), ((Node ((-1)) ((Empty Unit)) ((Node ((-1)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((-5)), ((Node ((-1)) ((Empty Unit)) ((Node ((5)) ((Empty Unit)) ((Node ((1)) ((Empty Unit)) ((Empty Unit))))))))), (toSym False))
                , ((((-4)), ((Node ((3)) ((Node ((4)) ((Empty Unit)) ((Node ((-3)) ((Empty Unit)) ((Empty Unit)))))) ((Node ((-3)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((3)), ((Empty Unit))), (toSym False))
                , ((((-3)), ((Node ((-4)) ((Empty Unit)) ((Empty Unit))))), (toSym False))
                , ((((5)), ((Node ((-1)) ((Empty Unit)) ((Node ((2)) ((Empty Unit)) ((Empty Unit))))))), (toSym False))
                , ((((2)), ((Empty Unit))), (toSym False))
                ]
