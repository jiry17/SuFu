...
eval2_1 env (Param12_1) = evalVar0 env "tmp4"
        ...
        Node a l r -> 
          let
            result =
              (f s l)
          in
          f ((a +  (fst result)), (max' (snd result) (a +  (fst result)))) r
        ...
        Node a l r -> 
          ...
          let
            tmp3 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("tmp3", (Env0 tmp3)), ("a", (Env1 a))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                ...
                , (((Node ((-1)) ((Nil Unit)) ((Node ((4)) ((Nil Unit)) ((Node ((2)) ((Nil Unit)) ((Nil Unit)))))))), (5))
                , (((Nil Unit)), (0))
                , (((Nil Unit)), (0))
                , (((Node ((-2)) ((Node ((5)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))))) ((Nil Unit)))) ((Nil Unit)))), (11))
                , (((Node ((-4)) ((Node ((0)) ((Node ((0)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Node ((2)) ((Nil Unit)) ((Nil Unit)))))), (0))
                , (((Node ((-5)) ((Nil Unit)) ((Nil Unit)))), (0))
                , (((Nil Unit)), (0))
                , (((Node ((3)) ((Node ((5)) ((Nil Unit)) ((Node ((0)) ((Nil Unit)) ((Node ((4)) ((Nil Unit)) ((Nil Unit)))))))) ((Nil Unit)))), (12))
                , (((Nil Unit)), (0))
                , (((Node ((1)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))))), (2))
                , (((Nil Unit)), (0))
                ...
                , (((Node ((-1)) ((Node ((5)) ((Node ((-4)) ((Nil Unit)) ((Nil Unit)))) ((Nil Unit)))) ((Nil Unit)))), (1))
                , (((Nil Unit)), (0))
