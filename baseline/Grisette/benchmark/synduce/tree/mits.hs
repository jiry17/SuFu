        ...
        Node a l r -> 
          let
            result =
              (f s l)
          in
          f ((a +  (fst result)), (max' 0 (a +  (snd result)))) r
...
main = do
    let pairs = [
                ...
                , (((Node ((-1)) ((Nil Unit)) ((Node ((4)) ((Nil Unit)) ((Node ((2)) ((Nil Unit)) ((Nil Unit)))))))), (6))
                , (((Nil Unit)), (0))
                , (((Nil Unit)), (0))
                , (((Node ((-2)) ((Node ((5)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))))) ((Nil Unit)))) ((Nil Unit)))), (9))
                ...
                , (((Nil Unit)), (0))
                , (((Node ((-1)) ((Nil Unit)) ((Node ((5)) ((Nil Unit)) ((Node ((1)) ((Nil Unit)) ((Nil Unit)))))))), (6))
                ]
