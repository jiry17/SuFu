  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e0_0 e2_4 e2_5] ++ [mrgAccess1_1_2_2 e1_0])
        return res
...
eval1_1 env (Param51_1) = evalVar0 env "a"
        ...
        Node a l r -> 
          ...
          let
            r2 =
              (f r)
          in
          (a, (((((fst r1) <~  a) &&~  (a <~  (fst r2))) &&~  (snd r1)) &&~  (snd r2)))
        ...
        Node a l r -> 
          ...
          let
            tmp3 =
              (f r)
          in
          evalU1_0 (RefEnv [("tmp2", (Env1 tmp2)), ("tmp3", (Env1 tmp3)), ("a", (Env0 a))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Leaf (-4))), (toSym True))
                , (((Node ((-2)) ((Node ((5)) ((Leaf (3))) ((Leaf (5))))) ((Node ((-5)) ((Leaf (1))) ((Node ((-5)) ((Leaf (3))) ((Leaf (5))))))))), (toSym False))
                , (((Node ((3)) ((Node ((5)) ((Leaf (-5))) ((Node ((4)) ((Node ((4)) ((Leaf (-4))) ((Leaf (1))))) ((Leaf (-2))))))) ((Leaf (-1))))), (toSym False))
                , (((Node ((1)) ((Leaf (3))) ((Node ((4)) ((Leaf (-1))) ((Leaf (-2))))))), (toSym False))
                , (((Node ((-4)) ((Node ((0)) ((Leaf (-3))) ((Leaf (5))))) ((Node ((2)) ((Leaf (4))) ((Node ((-5)) ((Leaf (-3))) ((Leaf (-5))))))))), (toSym False))
                , (((Node ((-4)) ((Leaf (-3))) ((Node ((0)) ((Leaf (2))) ((Leaf (-3))))))), (toSym False))
                , (((Leaf (-3))), (toSym True))
                , (((Node ((5)) ((Leaf (2))) ((Leaf (-1))))), (toSym False))
                , (((Node ((-2)) ((Node ((0)) ((Leaf (-4))) ((Leaf (1))))) ((Node ((-1)) ((Leaf (-3))) ((Node ((-5)) ((Leaf (-1))) ((Leaf (5))))))))), (toSym False))
                , (((Node ((1)) ((Node ((1)) ((Leaf (-2))) ((Leaf (-4))))) ((Leaf (1))))), (toSym False))
                , (((Node ((-2)) ((Node ((-4)) ((Node ((-3)) ((Leaf (-3))) ((Leaf (-3))))) ((Leaf (1))))) ((Node ((3)) ((Leaf (3))) ((Leaf (-4))))))), (toSym False))
                , (((Node ((-4)) ((Leaf (0))) ((Leaf (5))))), (toSym False))
                , (((Leaf (3))), (toSym True))
                , (((Node ((3)) ((Node ((-5)) ((Leaf (-4))) ((Leaf (-2))))) ((Node ((-3)) ((Leaf (-1))) ((Leaf (-2))))))), (toSym False))
                , (((Leaf (0))), (toSym True))
                , (((Leaf (-4))), (toSym True))
                , (((Node ((2)) ((Leaf (-1))) ((Node ((-4)) ((Leaf (1))) ((Node ((-1)) ((Leaf (3))) ((Node ((1)) ((Leaf (4))) ((Leaf (-2))))))))))), (toSym False))
                , (((Node ((-1)) ((Leaf (-3))) ((Leaf (-2))))), (toSym False))
                , (((Node ((-2)) ((Leaf (-4))) ((Leaf (2))))), (toSym True))
                , (((Node ((-5)) ((Leaf (4))) ((Node ((0)) ((Node ((2)) ((Leaf (-4))) ((Leaf (-3))))) ((Node ((2)) ((Leaf (-1))) ((Leaf (2))))))))), (toSym False))
                ]
