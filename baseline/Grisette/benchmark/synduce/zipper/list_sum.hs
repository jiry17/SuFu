...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam31_0] ++ [mrgCzero1_0]
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam34_0] ++ [mrgParam44_0] ++ [mrgCzero4_0]
...
instance GenSym (Int) Expr5_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam15_0] ++ [mrgCzero5_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_5 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd5_0 e0_0 e0_1] ++ [mrgCsub5_0 e0_2 e0_3] ++ [mrgCIte5_0 e1_0 e0_4 e0_5])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval4_0 env (Param34_0) = evalVar0 env "tmp6"
eval4_0 env (Param44_0) = evalVar0 env "tmp7"
...
eval5_0 env (Param15_0) = evalVar0 env "tmp8"
        ...
        Cons h t -> 
          ...
          let
            tmp3 =
              (Cons h (Nil Unit))
          in
          evalU1_0 (RefEnv [("h", (Env0 h)), ("tmp2", (Env0 tmp2))]) ((genSym (1::Int) "hole1") :: (UnionM Expr1_0))
        ...
        Cons h t -> 
          let
            tmp5 =
              (f t)
          in
          evalU3_0 (RefEnv [("h", (Env0 h)), ("tmp5", (Env0 tmp5))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0))
    ...
    Zip l r -> 
      ...
      let
        tmp7 =
          (list_repr r)
      in
      evalU4_0 (RefEnv [("tmp6", (Env0 tmp6)), ("tmp7", (Env0 tmp7))]) ((genSym (1::Int) "hole4") :: (UnionM Expr4_0))
...
main' z = 
  let
    tmp8 =
      (repr z)
  in
  evalU5_0 (RefEnv [("tmp8", (Env0 tmp8))]) ((genSym (1::Int) "hole5") :: (UnionM Expr5_0))
...
main = do
    let pairs = [
                (((Zip ((Nil Unit)) ((Cons ((4)) ((Cons ((5)) ((Nil Unit)))))))), (9))
                , (((Zip ((Cons ((-1)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-5)) ((Cons ((-3)) ((Nil Unit)))))))))))))))) ((Nil Unit)))), (-8))
                , (((Zip ((Cons ((-2)) ((Nil Unit)))) ((Cons ((2)) ((Nil Unit)))))), (0))
                , (((Zip ((Cons ((-5)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((5)) ((Nil Unit)))))))))))) ((Nil Unit)))), (-1))
                , (((Zip ((Cons ((3)) ((Nil Unit)))) ((Nil Unit)))), (3))
                , (((Zip ((Cons ((3)) ((Cons ((-2)) ((Nil Unit)))))) ((Nil Unit)))), (1))
                , (((Zip ((Cons ((-1)) ((Nil Unit)))) ((Cons ((-3)) ((Cons ((1)) ((Cons ((-3)) ((Nil Unit)))))))))), (-6))
                , (((Zip ((Nil Unit)) ((Nil Unit)))), (0))
                , (((Zip ((Nil Unit)) ((Cons ((-2)) ((Cons ((5)) ((Nil Unit)))))))), (3))
                , (((Zip ((Cons ((0)) ((Nil Unit)))) ((Cons ((-4)) ((Cons ((-3)) ((Cons ((0)) ((Nil Unit)))))))))), (-7))
                , (((Zip ((Cons ((5)) ((Nil Unit)))) ((Cons ((-4)) ((Cons ((2)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((5)) ((Nil Unit)))))))))))))))), (1))
                , (((Zip ((Cons ((-1)) ((Nil Unit)))) ((Nil Unit)))), (-1))
                , (((Zip ((Nil Unit)) ((Nil Unit)))), (0))
                , (((Zip ((Nil Unit)) ((Cons ((-3)) ((Nil Unit)))))), (-3))
                , (((Zip ((Cons ((-1)) ((Nil Unit)))) ((Nil Unit)))), (-1))
                , (((Zip ((Cons ((-2)) ((Cons ((-4)) ((Nil Unit)))))) ((Cons ((4)) ((Nil Unit)))))), (-2))
                , (((Zip ((Cons ((3)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((1)) ((Nil Unit)))))))))) ((Cons ((3)) ((Nil Unit)))))), (5))
                , (((Zip ((Nil Unit)) ((Cons ((-1)) ((Nil Unit)))))), (-1))
                , (((Zip ((Nil Unit)) ((Cons ((3)) ((Cons ((0)) ((Cons ((-3)) ((Nil Unit)))))))))), (0))
                , (((Zip ((Cons ((2)) ((Cons ((-1)) ((Cons ((-5)) ((Nil Unit)))))))) ((Cons ((-4)) ((Nil Unit)))))), (-8))
                ]
