  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_2_0 e1_0] ++ [mrgAccess1_1_2_0 e1_1] ++ [mrgAccess2_1_2_0 e1_2] ++ [mrgMax2_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval0_1 env (Param10_1) = evalVar0 env "t"
...
eval1_1 env (Param01_1) = evalVar0 env "idx"
eval1_1 env (Param11_1) = evalVar0 env "hd"
...
data IdxList
  = Ielt SymInteger
  | Icons SymInteger SymInteger IdxList
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon IdxList, ExtractSymbolics)
    via (Default IdxList)
...
instance SimpleMergeable IdxList where
  mrgIte cond l r = go cond l r
    where
      go cond (Ielt l) (Ielt r) = Ielt (mrgIte cond l r)
      go cond (Icons l1 l2 l3) (Icons r1 r2 r3) = Icons (mrgIte cond l1 r1) (mrgIte cond l2 r2) (mrgIte cond l3 r3)
      go _ _ _ = error "Should not happen"
        ...
        Ielt t -> 
          let
            tmp1 =
              (Elt t)
          in
          evalU0_0 (RefEnv [("t", (Env0 t))]) ((genSym (5::Int) "hole0") :: (UnionM Expr0_0))
        Icons hd idx tl -> 
          let
            tmp2 =
              (f tl)
          in
          evalU1_0 (RefEnv [("tmp2", (Env1 tmp2)), ("idx", (Env0 idx)), ("hd", (Env0 hd))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main' xs = 
  let
    tmp3 =
      (repr xs)
  in
  evalU2_0 (RefEnv [("tmp3", (Env1 tmp3))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(IdxList, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((Icons (5) (-3) (Icons (-2) (5) (Icons (-5) (4) (Ielt 5)))), 5)
                , ((Icons (-2) (-3) (Icons (-1) (4) (Icons (5) (3) (Icons (5) (2) (Icons (0) (4) (Icons (4) (3) (Icons (-2) (1) (Ielt (-2))))))))), 14)
                , ((Icons (-1) (-3) (Icons (-3) (3) (Icons (4) (-3) (Ielt (-4))))), 4)
                , ((Icons (-2) (-4) (Icons (0) (-2) (Icons (-3) (5) (Icons (2) (5) (Icons (0) (-5) (Icons (-3) (2) (Ielt (-3)))))))), 2)
                , ((Icons (-4) (-2) (Icons (2) (0) (Icons (2) (5) (Icons (-4) (-3) (Ielt (-1)))))), 4)
                , ((Ielt (-3)), 0)
                , ((Icons (-5) (5) (Icons (2) (-3) (Icons (2) (3) (Icons (-1) (1) (Icons (4) (-4) (Icons (-2) (-2) (Icons (2) (-4) (Icons (1) (-1) (Icons (1) (-3) (Ielt (-5))))))))))), 9)
                , ((Icons (-5) (-1) (Icons (-2) (5) (Icons (-1) (1) (Ielt (-2))))), 0)
                , ((Ielt 4), 4)
                , ((Icons (4) (-4) (Icons (-3) (-5) (Icons (3) (-3) (Icons (1) (-4) (Icons (-4) (3) (Icons (-4) (-3) (Ielt 5))))))), 5)
                , ((Icons (2) (-4) (Icons (0) (3) (Icons (0) (-1) (Icons (-1) (1) (Icons (2) (1) (Ielt 2)))))), 5)
                , ((Icons (-5) (-5) (Icons (-4) (4) (Icons (2) (-3) (Ielt (-1))))), 2)
                , ((Icons (5) (-4) (Icons (-5) (0) (Ielt 1))), 5)
                , ((Ielt (-1)), 0)
                , ((Icons (-1) (-1) (Icons (-4) (0) (Icons (-4) (-1) (Icons (3) (-5) (Icons (5) (4) (Icons (-2) (-5) (Icons (-1) (5) (Icons (-1) (-3) (Icons (-2) (4) (Ielt (-2))))))))))), 8)
                , ((Icons (-4) (-4) (Icons (-4) (4) (Icons (-4) (-5) (Icons (4) (1) (Icons (0) (2) (Icons (-4) (3) (Icons (-5) (2) (Icons (-1) (1) (Ielt 2))))))))), 4)
                , ((Icons (-4) (2) (Icons (-5) (-3) (Icons (-3) (-4) (Icons (5) (3) (Icons (-4) (5) (Icons (-4) (3) (Icons (1) (3) (Icons (0) (-3) (Ielt (-3)))))))))), 5)
                , ((Icons (4) (-5) (Icons (4) (4) (Ielt (-1)))), 8)
                , ((Icons (4) (-3) (Icons (-5) (-2) (Icons (3) (1) (Icons (-5) (2) (Ielt (-1)))))), 4)
                , ((Icons (5) (0) (Ielt 1)), 6)
                ]
