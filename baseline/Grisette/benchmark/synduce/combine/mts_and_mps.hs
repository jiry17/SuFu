...
eval1_1 env (Param31_1) = evalVar1 env "h"
        ...
        Cons h t -> 
          let
            tmp2 =
              (f t)
          in
          evalU1_0 (RefEnv [("tmp2", (Env0 tmp2)), ("h", (Env1 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                ((Nil Unit), (0, 0))
                , ((Nil Unit), (0, 0))
                , ((Cons (2) (Cons (4) (Cons (3) (Cons (1) (Cons (5) (Cons (3) (Cons (1) (Cons (-4) (Nil Unit))))))))), (15, 19))
                , ((Cons (4) (Cons (5) (Nil Unit))), (9, 9))
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), (13, 10))
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), (0, 1))
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), (13, 8))
                , ((Cons (4) (Cons (-4) (Cons (1) (Cons (-2) (Nil Unit))))), (0, 4))
                , ((Cons (-3) (Nil Unit)), (0, 0))
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), (0, 0))
                , ((Cons (4) (Cons (-5) (Nil Unit))), (0, 4))
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), (2, 0))
                , ((Nil Unit), (0, 0))
                , ((Cons (2) (Cons (0) (Cons (-2) (Cons (-5) (Cons (5) (Cons (-3) (Cons (2) (Nil Unit)))))))), (4, 2))
                , ((Cons (4) (Cons (-2) (Cons (-2) (Nil Unit)))), (0, 4))
                , ((Nil Unit), (0, 0))
                , ((Cons (3) (Cons (-5) (Cons (2) (Nil Unit)))), (2, 3))
                , ((Cons (5) (Cons (-1) (Cons (0) (Nil Unit)))), (4, 5))
                , ((Nil Unit), (0, 0))
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), (7, 0))
                ]
