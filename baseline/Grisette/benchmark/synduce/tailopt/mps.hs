...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam10_1] ++ [mrgCzero0_1] ++ [mrgAl_inf0_1]
...
eval0_0 env (Param00_0) = evalVar0 env "pre"
...
eval0_1 env (Param10_1) = evalVar1 env "h"
...
repr = 
  let
    f pre xs = 
      case xs of
        Nil _ -> pre
        Cons h t -> f (evalU0_0 (RefEnv [("pre", (Env0 pre)), ("h", (Env1 h))]) ((genSym (5::Int) "hole0") :: (UnionM Expr0_0))) t
  in
  f  (let
    tmp1 =
      (Nil Unit)
  in
  evalU1_0 (RefEnv []) ((genSym (3::Int) "hole1") :: (UnionM Expr1_0)))
