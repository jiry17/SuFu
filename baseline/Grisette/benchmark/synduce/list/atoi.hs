...
instance GenSym (Int) Expr0_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgCzero0_1] ++ [mrgBase0_1] ++ [mrgAl_inf0_1]
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam01_1] ++ [mrgCzero1_1] ++ [mrgBase1_1] ++ [mrgAl_inf1_1]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgCzero2_1] ++ [mrgBase2_1] ++ [mrgAl_inf2_1]
...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCzero3_0] ++ [mrgBase3_0] ++ [mrgAl_inf3_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_3_0 e1_0] ++ [mrgAccess1_1_3_0 e1_1] ++ [mrgCmul3_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
main = do
    let pairs = [
                ...
                , (((Cnil Unit)), 0)
                , (((Single (-1))), -1)
                , (((Concat ((Cnil Unit)) ((Single (0))))), 0)
                , (((Single (5))), 5)
                , (((Concat ((Concat ((Cnil Unit)) ((Single (3))))) ((Cnil Unit)))), 3)
                , (((Concat ((Single (-2))) ((Single (5))))), 48)
                , (((Single (-2))), -2)
                , (((Cnil Unit)), 0)
                , (((Concat ((Concat ((Single (0))) ((Cnil Unit)))) ((Single (4))))), 40)
                , (((Concat ((Single (-3))) ((Single (-2))))), -23)
                , (((Concat ((Concat ((Cnil Unit)) ((Single (-1))))) ((Single (1))))), 9)
                , (((Concat ((Concat ((Cnil Unit)) ((Single (4))))) ((Single (4))))), 44)
                , (((Single (-4))), -4)
                , (((Cnil Unit)), 0)
                , (((Concat ((Single (4))) ((Cnil Unit)))), 4)
                ]
