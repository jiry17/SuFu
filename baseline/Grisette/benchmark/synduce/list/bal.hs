        ...
        Single x -> 
          let
            tmp2 =
              (Cons x (Nil Unit))
          in
          evalU1_0 (RefEnv [("x", (Env0 x))]) ((genSym (3::Int) "hole1") :: (UnionM Expr1_0))
        Concat a b -> 
          let
            tmp3 =
              (f a)
...
main = do
    let pairs = [
                (((Cnil Unit)), True)
                , (((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Single (2))))) ((Cnil Unit)))))), True)
                , (((Concat ((Single (3))) ((Concat ((Single (3))) ((Single (1))))))), True)
                , (((Single (-2))), False)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit)))), False)
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5))))))), True)
                , (((Concat ((Cnil Unit)) ((Single (1))))), True)
                , (((Cnil Unit)), True)
                , (((Concat ((Concat ((Concat ((Single (2))) ((Concat ((Single (4))) ((Single (4))))))) ((Single (-4))))) ((Cnil Unit)))), False)
                , (((Single (-1))), False)
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Cnil Unit)))))), True)
                , (((Single (4))), True)
                , (((Concat ((Cnil Unit)) ((Cnil Unit)))), True)
                , (((Concat ((Single (0))) ((Cnil Unit)))), False)
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))))), True)
                , (((Concat ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit)))) ((Single (-1))))), False)
                , (((Single (-3))), False)
                , (((Concat ((Single (5))) ((Single (-3))))), False)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Cnil Unit)) ((Cnil Unit)))))) ((Cnil Unit)))), True)
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))), True)
                ]
