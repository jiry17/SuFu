...
main = do
    let pairs = [
                (((Cnil Unit)), (0))
                , (((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Single (2))))) ((Cnil Unit)))))), (1))
                , (((Concat ((Single (3))) ((Concat ((Single (3))) ((Single (1))))))), (7))
                , (((Single (-2))), (0))
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit)))), (5))
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5))))))), (5))
