...
evalVar1 :: RefEnv -> Ident -> (SymBool, SymBool, SymBool)
...
-- output_type: {Bool,Bool,Bool}
-- param_list: a tmp3 b tmp2 xs
data Expr1_0
  = Param11_0
  | Param31_0
  | Prod1_0 (UnionM Expr1_2) (UnionM Expr1_2) (UnionM Expr1_2)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgAccess0_0_0_1 e0_0] ++ [mrgAccess1_0_0_1 e0_1] ++ [mrgAccess2_0_0_1 e0_2] ++ [mrgCeq0_1 e2_0 e2_1] ++ [mrgCless0_1 e2_2 e2_3] ++ [mrgCleq0_1 e2_4 e2_5] ++ [mrgCand0_1 e1_0 e1_1] ++ [mrgCor0_1 e1_2 e1_3] ++ [mrgCnot0_1 e1_4])
        return res
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd0_2 e2_0 e2_1] ++ [mrgCsub0_2 e2_2 e2_3] ++ [mrgCIte0_2 e1_0 e2_4 e2_5])
        return res
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam11_0] ++ [mrgParam31_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e2_1 <- (gen2 (gendepth - 1))
        e2_2 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd1_0 e2_0 e2_1 e2_2])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgAccess0_0_1_2 e0_0] ++ [mrgAccess1_0_1_2 e0_1] ++ [mrgAccess2_0_1_2 e0_2] ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCless1_2 e1_2 e1_3] ++ [mrgCleq1_2 e1_4 e1_5] ++ [mrgCand1_2 e2_0 e2_1] ++ [mrgCor1_2 e2_2 e2_3] ++ [mrgCnot1_2 e2_4])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess0_1_2_0 e1_0] ++ [mrgAccess1_1_2_0 e1_1] ++ [mrgAccess2_1_2_0 e1_2] ++ [mrgCeq2_0 e2_0 e2_1] ++ [mrgCless2_0 e2_2 e2_3] ++ [mrgCleq2_0 e2_4 e2_5] ++ [mrgCand2_0 e0_0 e0_1] ++ [mrgCor2_0 e0_2 e0_3] ++ [mrgCnot2_0 e0_4])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_4 <- (gen2 (gendepth - 1))
        e2_5 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e0_0 e2_4 e2_5])
        return res

eval0_0 :: RefEnv -> Expr0_0 -> (SymBool, SymBool, SymBool)
eval0_0 env (Prod0_0 p0 p1 p2) = ((evalU0_1 env p0), (evalU0_1 env p1), (evalU0_1 env p2))
eval0_0 env (CFalse30_0) = ((toSym False),(toSym False),(toSym False))

evalU0_0 :: RefEnv -> UnionM Expr0_0 -> (SymBool, SymBool, SymBool)
...
eval1_0 :: RefEnv -> Expr1_0 -> (SymBool, SymBool, SymBool)
eval1_0 env (Param11_0) = evalVar1 env "tmp3"
eval1_0 env (Param31_0) = evalVar1 env "tmp2"
eval1_0 env (Prod1_0 p0 p1 p2) = ((evalU1_2 env p0), (evalU1_2 env p1), (evalU1_2 env p2))

evalU1_0 :: RefEnv -> UnionM Expr1_0 -> (SymBool, SymBool, SymBool)
...
eval1_2 env (Access0_0_1_2 p0) = get1from3 (evalU1_0 env p0)
    ...
    f xs = 
      case xs of
        ...
        Cons hd tl -> 
          ...
          in
          (new_an, new_bn, (get3from3 result))
...
main = do
    let pairs = [
                (((Concat ((Concat ((Single (toSym True))) ((Concat ((Concat ((Single (toSym True))) ((Single (toSym True))))) ((Single (toSym False))))))) ((Single (toSym False))))), (toSym False))
                , (((Single (toSym False))), (toSym True))
                , (((Concat ((Single (toSym True))) ((Single (toSym False))))), (toSym False))
                , (((Concat ((Concat ((Single (toSym True))) ((Concat ((Concat ((Single (toSym True))) ((Single (toSym False))))) ((Single (toSym False))))))) ((Single (toSym False))))), (toSym False))
                , (((Concat ((Single (toSym True))) ((Concat ((Single (toSym True))) ((Concat ((Single (toSym False))) ((Concat ((Single (toSym False))) ((Single (toSym True))))))))))), (toSym False))
                , (((Concat ((Concat ((Single (toSym True))) ((Concat ((Single (toSym False))) ((Single (toSym False))))))) ((Single (toSym True))))), (toSym False))
                , (((Concat ((Single (toSym True))) ((Concat ((Single (toSym True))) ((Concat ((Single (toSym False))) ((Single (toSym True))))))))), (toSym False))
                , (((Single (toSym True))), (toSym True))
                , (((Concat ((Single (toSym False))) ((Single (toSym False))))), (toSym True))
                , (((Concat ((Concat ((Single (toSym False))) ((Single (toSym False))))) ((Concat ((Single (toSym True))) ((Concat ((Single (toSym True))) ((Single (toSym True))))))))), (toSym True))
                , (((Concat ((Concat ((Single (toSym True))) ((Single (toSym True))))) ((Single (toSym False))))), (toSym False))
                , (((Concat ((Single (toSym False))) ((Concat ((Single (toSym False))) ((Concat ((Single (toSym True))) ((Single (toSym False))))))))), (toSym False))
                , (((Single (toSym True))), (toSym True))
                , (((Concat ((Single (toSym True))) ((Single (toSym False))))), (toSym False))
                , (((Single (toSym False))), (toSym True))
                , (((Single (toSym True))), (toSym True))
                , (((Concat ((Single (toSym False))) ((Single (toSym True))))), (toSym True))
                , (((Single (toSym True))), (toSym True))
                , (((Single (toSym True))), (toSym True))
                , (((Concat ((Single (toSym False))) ((Concat ((Single (toSym False))) ((Single (toSym True))))))), (toSym True))
                ]
