  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_2_0 e1_0] ++ [mrgAccess1_1_2_0 e1_1] ++ [mrgMin2_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval1_0 env (Param41_0) = evalVar1 env "tmp3"
    ...
    f xs = 
      case xs of
        ...
        Cons hd tl -> 
          ...
          let
            new_cnt =
              (mrgIte (hd <~  (fst result))
                (1)
                ((snd result) +  (mrgIte (hd ==~  (fst result))
                  (1)
                  (0))))
          in
          (new_min, new_cnt)
        ...
        Concat a b -> 
          ...
          let
            tmp3 =
              (f b)
          in
          evalU1_0 (RefEnv [("tmp2", (Env1 tmp2)), ("tmp3", (Env1 tmp3))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
...
main = do
    let pairs = [
                (((Concat ((Concat ((Concat ((Single (1))) ((Single (5))))) ((Single (3))))) ((Single (1))))), 2)
                , (((Single (-2))), 1)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Single (3))))), 1)
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Single (-1))))))) ((Concat ((Single (5))) ((Single (3))))))), 1)
                , (((Concat ((Concat ((Single (3))) ((Concat ((Single (-2))) ((Concat ((Single (-1))) ((Single (1))))))))) ((Single (3))))), 1)
                , (((Concat ((Concat ((Single (4))) ((Single (-4))))) ((Concat ((Single (-4))) ((Single (2))))))), 2)
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Single (-1))))))), 1)
                , (((Concat ((Single (-2))) ((Single (-3))))), 1)
                , (((Concat ((Single (-2))) ((Single (5))))), 1)
                , (((Concat ((Single (2))) ((Concat ((Single (-1))) ((Single (-1))))))), 2)
                , (((Single (2))), 1)
                , (((Concat ((Concat ((Single (-3))) ((Concat ((Concat ((Single (-4))) ((Single (2))))) ((Single (0))))))) ((Single (-2))))), 1)
                , (((Concat ((Concat ((Single (5))) ((Single (1))))) ((Concat ((Single (-4))) ((Single (-2))))))), 1)
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (3))))))), 2)
                , (((Concat ((Single (0))) ((Concat ((Single (1))) ((Concat ((Single (0))) ((Single (2))))))))), 2)
                , (((Concat ((Concat ((Concat ((Single (-4))) ((Single (-3))))) ((Single (-3))))) ((Concat ((Single (1))) ((Single (-4))))))), 2)
                , (((Single (-4))), 1)
                , (((Concat ((Single (4))) ((Single (3))))), 1)
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (2))))))), 2)
                , (((Single (2))), 1)
                ]
