  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e0_0 e2_4 e2_5] ++ [mrgAccess1_1_2_2 e1_0] ++ [mrgMax2_2 e2_6 e2_7])
        return res
...
eval2_1 env (Param02_1) = evalVar1 env "tmp4"
...
f xs = 
      case xs of
        Single a -> (a, a, (toSym True))
        Cons hd tl -> 
          let
            result =
              (f tl)
          in
          (hd, (max' (get2from3 result) hd), (hd >~  (get2from3 result)))
...
main = do
    let pairs = [
                (((Cat ((Cat ((Cat ((Elt (1))) ((Elt (5))))) ((Elt (3))))) ((Elt (1))))), False)
                , (((Elt (-2))), True)
                , (((Cat ((Cat ((Elt (5))) ((Cat ((Elt (-3))) ((Cat ((Elt (-2))) ((Elt (-5))))))))) ((Elt (3))))), True)
                , (((Cat ((Cat ((Elt (0))) ((Cat ((Elt (4))) ((Elt (-1))))))) ((Cat ((Elt (5))) ((Elt (3))))))), False)
                , (((Cat ((Cat ((Elt (3))) ((Cat ((Elt (-2))) ((Cat ((Elt (-1))) ((Elt (1))))))))) ((Elt (3))))), False)
                , (((Cat ((Cat ((Elt (4))) ((Elt (-4))))) ((Cat ((Elt (-4))) ((Elt (2))))))), True)
                , (((Cat ((Elt (-3))) ((Cat ((Elt (4))) ((Elt (-1))))))), False)
                , (((Cat ((Elt (-2))) ((Elt (-3))))), True)
                , (((Cat ((Elt (-2))) ((Elt (5))))), False)
                , (((Cat ((Elt (2))) ((Cat ((Elt (-1))) ((Elt (-1))))))), True)
                , (((Elt (2))), True)
                , (((Cat ((Cat ((Elt (-3))) ((Cat ((Cat ((Elt (-4))) ((Elt (2))))) ((Elt (0))))))) ((Elt (-2))))), False)
                , (((Cat ((Cat ((Elt (5))) ((Elt (1))))) ((Cat ((Elt (-4))) ((Elt (-2))))))), True)
                , (((Cat ((Elt (1))) ((Cat ((Elt (1))) ((Elt (3))))))), False)
                , (((Cat ((Elt (0))) ((Cat ((Elt (1))) ((Cat ((Elt (0))) ((Elt (2))))))))), False)
                , (((Cat ((Cat ((Cat ((Elt (-4))) ((Elt (-3))))) ((Elt (-3))))) ((Cat ((Elt (1))) ((Elt (-4))))))), False)
                , (((Elt (-4))), True)
                , (((Cat ((Elt (4))) ((Elt (3))))), True)
                , (((Cat ((Elt (1))) ((Cat ((Elt (1))) ((Elt (2))))))), False)
                , (((Elt (2))), True)
                ]
