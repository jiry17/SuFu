...
main = do
    let pairs = [
                ...
                , (((Concat ((Single (3))) ((Concat ((Single (3))) ((Single (1))))))), 3)
                , (((Single (-2))), 1)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit)))), 4)
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5))))))), 3)
                , (((Concat ((Cnil Unit)) ((Single (1))))), 1)
                , (((Cnil Unit)), 0)
                , (((Concat ((Concat ((Concat ((Single (2))) ((Concat ((Single (4))) ((Single (4))))))) ((Single (-4))))) ((Cnil Unit)))), 4)
                , (((Single (-1))), 1)
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Cnil Unit)))))), 2)
                , (((Single (4))), 1)
                , (((Concat ((Cnil Unit)) ((Cnil Unit)))), 0)
                , (((Concat ((Single (0))) ((Cnil Unit)))), 1)
                ...
                , (((Concat ((Concat ((Single (5))) ((Concat ((Cnil Unit)) ((Cnil Unit)))))) ((Cnil Unit)))), 1)
