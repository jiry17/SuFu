  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd0_0 e0_0 e0_1] ++ [mrgCsub0_0 e0_2 e0_3] ++ [mrgCIte0_0 e1_0 e0_4 e0_5] ++ [mrgMax0_0 e0_6 e0_7] ++ [mrgCmul0_0 e0_8 e0_9])
        return res
    gen1 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_9 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd1_0 e0_0 e0_1] ++ [mrgCsub1_0 e0_2 e0_3] ++ [mrgCIte1_0 e1_0 e0_4 e0_5] ++ [mrgMax1_0 e0_6 e0_7] ++ [mrgCmul1_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_9 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e1_0 e0_4 e0_5] ++ [mrgMax2_0 e0_6 e0_7] ++ [mrgCmul2_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e0_9 <- (gen0 (gendepth - 1))
        e1_0 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e1_0 e0_4 e0_5] ++ [mrgMax3_0 e0_6 e0_7] ++ [mrgCmul3_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
main = do
    let pairs = [
                (((Cnil Unit)), (1))
                , (((Concat ((Cnil Unit)) ((Concat ((Concat ((Single (1))) ((Single (2))))) ((Cnil Unit)))))), (2))
                , (((Concat ((Single (3))) ((Concat ((Single (3))) ((Single (1))))))), (9))
                , (((Single (-2))), (-2))
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Cnil Unit)))), (-150))
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Cnil Unit)))))) ((Concat ((Cnil Unit)) ((Single (5))))))), (0))
                , (((Concat ((Cnil Unit)) ((Single (1))))), (1))
                , (((Cnil Unit)), (1))
                , (((Concat ((Concat ((Concat ((Single (2))) ((Concat ((Single (4))) ((Single (4))))))) ((Single (-4))))) ((Cnil Unit)))), (-128))
                , (((Single (-1))), (-1))
                , (((Concat ((Single (-3))) ((Concat ((Single (4))) ((Cnil Unit)))))), (-12))
                , (((Single (4))), (4))
                , (((Concat ((Cnil Unit)) ((Cnil Unit)))), (1))
                , (((Concat ((Single (0))) ((Cnil Unit)))), (0))
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))))), (1))
                , (((Concat ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit)))) ((Single (-1))))), (-1))
                , (((Single (-3))), (-3))
                , (((Concat ((Single (5))) ((Single (-3))))), (-15))
                , (((Concat ((Concat ((Single (5))) ((Concat ((Cnil Unit)) ((Cnil Unit)))))) ((Cnil Unit)))), (5))
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))), (1))
                ]
