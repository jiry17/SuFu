...
main = do
    let pairs = [
                ...
                , (((Single (-2))), -2)
                , (((Concat ((Concat ((Single (5))) ((Concat ((Single (-3))) ((Concat ((Single (-2))) ((Single (-5))))))))) ((Single (3))))), 3)
                , (((Concat ((Concat ((Single (0))) ((Concat ((Single (4))) ((Single (-1))))))) ((Concat ((Single (5))) ((Single (3))))))), 3)
                , (((Concat ((Concat ((Single (3))) ((Concat ((Single (-2))) ((Concat ((Single (-1))) ((Single (1))))))))) ((Single (3))))), 3)
                ...
                , (((Concat ((Single (-2))) ((Single (5))))), 5)
                , (((Concat ((Single (2))) ((Concat ((Single (-1))) ((Single (-1))))))), -1)
                , (((Single (2))), 2)
                , (((Concat ((Concat ((Single (-3))) ((Concat ((Concat ((Single (-4))) ((Single (2))))) ((Single (0))))))) ((Single (-2))))), -2)
                , (((Concat ((Concat ((Single (5))) ((Single (1))))) ((Concat ((Single (-4))) ((Single (-2))))))), -2)
                , (((Concat ((Single (1))) ((Concat ((Single (1))) ((Single (3))))))), 3)
