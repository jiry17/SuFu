...
eval1_0 env (Param01_0) = evalVar0 env "b"
eval1_0 env (Param11_0) = evalVar0 env "a"
...
data ZipCList
  ...
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon ZipCList, ExtractSymbolics)
    via (Default ZipCList)

data ZipList
  = Nil Unit
  | Cons SymInteger SymInteger ZipList
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon ZipList, ExtractSymbolics)
    via (Default ZipList)
{-
        ...
        Single a b -> 
          let
            tmp2 =
              (Cons a b (Nil Unit))
          in
          evalU1_0 (RefEnv [("b", (Env0 b)), ("a", (Env0 a))]) ((genSym (3::Int) "hole1") :: (UnionM Expr1_0))
        Concat a b -> 
          let
            tmp3 =
              (f a)
          ...
          let
            tmp4 =
              (f b)
          in
          evalU2_0 (RefEnv [("tmp3", (Env0 tmp3)), ("tmp4", (Env0 tmp4))]) ((genSym (5::Int) "hole2") :: (UnionM Expr2_0))
      
  in
  f 

f :: ZipList -> SymInteger
f xs = 
    case xs of
    Nil _ -> 0
    Cons a b t -> mrgIte (a ==~  b)
        (1 +  (f t))
        (f t)
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(ZipCList, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                (((Cnil Unit)), 0)
                , (((Concat ((Cnil Unit)) ((Concat ((Concat ((Single ((1)) ((3)))) ((Single ((-2)) ((4)))))) ((Single ((3)) ((-4)))))))), 0)
                , (((Single ((-2)) ((1)))), 0)
                , (((Concat ((Concat ((Single ((5)) ((-5)))) ((Concat ((Concat ((Cnil Unit)) ((Single ((-2)) ((5)))))) ((Cnil Unit)))))) ((Cnil Unit)))), 0)
                , (((Concat ((Concat ((Single ((0)) ((-4)))) ((Concat ((Single ((-2)) ((-1)))) ((Cnil Unit)))))) ((Concat ((Single ((-3)) ((3)))) ((Cnil Unit)))))), 0)
                , (((Concat ((Concat ((Cnil Unit)) ((Concat ((Concat ((Single ((-2)) ((-3)))) ((Single ((-1)) ((4)))))) ((Single ((5)) ((3)))))))) ((Cnil Unit)))), 0)
                , (((Concat ((Concat ((Single ((4)) ((3)))) ((Cnil Unit)))) ((Concat ((Single ((-4)) ((-2)))) ((Single ((-1)) ((-3)))))))), 0)
                , (((Concat ((Concat ((Cnil Unit)) ((Single ((4)) ((3)))))) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))))), 0)
                , (((Concat ((Single ((0)) ((-5)))) ((Cnil Unit)))), 0)
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Cnil Unit)))))))), 0)
                , (((Concat ((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Cnil Unit)))) ((Single ((-1)) ((3)))))), 0)
                , (((Concat ((Concat ((Cnil Unit)) ((Single ((-5)) ((5)))))) ((Concat ((Single ((-3)) ((-1)))) ((Single ((3)) ((5)))))))), 0)
                , (((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Concat ((Cnil Unit)) ((Single ((-1)) ((-1)))))) ((Single ((-3)) ((3)))))))), 1)
                , (((Concat ((Cnil Unit)) ((Concat ((Concat ((Single ((1)) ((-1)))) ((Single ((0)) ((-2)))))) ((Single ((-4)) ((3)))))))), 0)
                , (((Concat ((Concat ((Concat ((Single ((-4)) ((3)))) ((Cnil Unit)))) ((Cnil Unit)))) ((Concat ((Single ((-3)) ((1)))) ((Single ((-4)) ((3)))))))), 0)
                , (((Cnil Unit)), 0)
                , (((Concat ((Cnil Unit)) ((Single ((0)) ((3)))))), 0)
                , (((Concat ((Cnil Unit)) ((Concat ((Cnil Unit)) ((Single ((1)) ((3)))))))), 0)
                , (((Concat ((Concat ((Cnil Unit)) ((Cnil Unit)))) ((Concat ((Cnil Unit)) ((Single ((-2)) ((2)))))))), 0)
                , (((Concat ((Single ((-4)) ((1)))) ((Cnil Unit)))), 0)
                ]
