        ...
        Pnode a xs -> 
                    ...
                    Pcons h t -> 
                      ...
                      let
                        tmp5 =
                          (g t)
                      in
                      evalU2_0 (RefEnv [("a", (Env0 a)), ("tmp3", (Env0 tmp3)), ("tmp5", (Env0 tmp5)), ("tmp4", (Env0 tmp4))]) ((genSym (1::Int) "hole2") :: (UnionM Expr2_0))
          ...
          let
            tmp7 =
              (l2t xs)
          in
          evalU3_0 (RefEnv [("a", (Env0 a)), ("tmp7", (Env0 tmp7))]) ((genSym (1::Int) "hole3") :: (UnionM Expr3_0))
...
main = do
    let pairs = [
                (((Pnode ((-1)) ((Pcons ((Pnode ((4)) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))) ((Pnil Unit)))))), (3))
                , (((Pnode ((1)) ((Pcons ((Pnode ((5)) ((Pnil Unit)))) ((Pnil Unit)))))), (6))
                , (((Pleaf Unit)), (0))
                , (((Pnode ((0)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (0))
                , (((Pnode ((-2)) ((Pnil Unit)))), (-2))
                , (((Pnode ((5)) ((Pnil Unit)))), (5))
                , (((Pnode ((-4)) ((Pcons ((Pnode ((-4)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))) ((Pnil Unit)))))), (-8))
                , (((Pnode ((5)) ((Pnil Unit)))), (5))
                , (((Pnode ((-5)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pnode ((3)) ((Pnil Unit)))) ((Pnil Unit)))))))))), (-2))
                , (((Pnode ((5)) ((Pcons ((Pnode ((0)) ((Pcons ((Pnode ((4)) ((Pnil Unit)))) ((Pnil Unit)))))) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (9))
                , (((Pnode ((0)) ((Pcons ((Pnode ((1)) ((Pnil Unit)))) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (1))
                , (((Pnode ((2)) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))), (2))
                , (((Pnode ((-3)) ((Pnil Unit)))), (-3))
                , (((Pnode ((0)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pnode ((-5)) ((Pnil Unit)))) ((Pnil Unit)))))))), (-5))
                , (((Pnode ((-2)) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))), (-2))
                , (((Pnode ((-4)) ((Pcons ((Pleaf Unit)) ((Pcons ((Pnode ((-4)) ((Pnil Unit)))) ((Pnil Unit)))))))), (-8))
                , (((Pnode ((1)) ((Pcons ((Pnode ((5)) ((Pnil Unit)))) ((Pnil Unit)))))), (6))
                , (((Pnode ((-1)) ((Pcons ((Pnode ((4)) ((Pnil Unit)))) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (3))
                , (((Pnode ((1)) ((Pcons ((Pnode ((1)) ((Pnil Unit)))) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (2))
                , (((Pnode ((-1)) ((Pcons ((Pnode ((5)) ((Pnil Unit)))) ((Pcons ((Pleaf Unit)) ((Pnil Unit)))))))), (4))
                ]
