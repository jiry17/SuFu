...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam31_0] ++ [mrgParam41_0] ++ [mrgCzero1_0]
...
eval0_0 env (Param00_0) = evalVar0 env "i"
...
data NormExpr
  ...
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon NormExpr, ExtractSymbolics)
    via (Default NormExpr)
...
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [(NormExpr, Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((Nplus (Nplus (Nplus (Nint (1)) (Nint (5))) (Nint (3))) (Nint (1))), 10)
                , ((Nint (-2)), -2)
                , ((Nplus (Nplus (Nint (5)) (Nplus (Nint (-3)) (Nplus (Nint (-2)) (Nint (-5))))) (Nint (3))), -2)
                , ((Nplus (Nplus (Nint (0)) (Nplus (Nint (4)) (Nint (-1)))) (Nplus (Nint (5)) (Nint (3)))), 11)
                , ((Nplus (Nplus (Nint (3)) (Nplus (Nint (-2)) (Nplus (Nint (-1)) (Nint (1))))) (Nint (3))), 4)
                , ((Nplus (Nplus (Nint (4)) (Nint (-4))) (Nplus (Nint (-4)) (Nint (2)))), -2)
                , ((Nplus (Nint (-3)) (Nplus (Nint (4)) (Nint (-1)))), 0)
                , ((Nplus (Nint (-2)) (Nint (-3))), -5)
                , ((Nplus (Nint (-2)) (Nint (5))), 3)
                , ((Nplus (Nint (2)) (Nplus (Nint (-1)) (Nint (-1)))), 0)
                , ((Nint (2)), 2)
                , ((Nplus (Nplus (Nint (-3)) (Nplus (Nplus (Nint (-4)) (Nint (2))) (Nint (0)))) (Nint (-2))), -7)
                , ((Nplus (Nplus (Nint (5)) (Nint (1))) (Nplus (Nint (-4)) (Nint (-2)))), 0)
                , ((Nplus (Nint (1)) (Nplus (Nint (1)) (Nint (3)))), 5)
                , ((Nplus (Nint (0)) (Nplus (Nint (1)) (Nplus (Nint (0)) (Nint (2))))), 3)
                , ((Nplus (Nplus (Nplus (Nint (-4)) (Nint (-3))) (Nint (-3))) (Nplus (Nint (1)) (Nint (-4)))), -13)
                , ((Nint (-4)), -4)
                , ((Nplus (Nint (4)) (Nint (3))), 7)
