  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd3_1 e1_0 e1_1] ++ [mrgCsub3_1 e1_2 e1_3] ++ [mrgCIte3_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_3_1 e0_0] ++ [mrgAccess1_0_3_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
main = do
    let pairs = [
                ...
                , ((((Cons ((-3)) ((Nil Unit))))), (1))
                , ((((Cons ((-3)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((-3)) ((Nil Unit))))))))))))))))), (7))
                , ((((Cons ((4)) ((Cons ((-5)) ((Nil Unit))))))), (1))
                , ((((Cons ((-1)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((-3)) ((Cons ((0)) ((Cons ((2)) ((Nil Unit))))))))))))))), (6))
                , ((((Nil Unit))), (0))
