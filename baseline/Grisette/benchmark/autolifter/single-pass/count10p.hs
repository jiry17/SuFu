...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam01_1] ++ [mrgParam41_1] ++ [mrgCzero1_1] ++ [mrgCone1_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCleq1_2 e1_4 e1_5] ++ [mrgCor1_2 e2_2 e2_3])
        return res
...
eval0_1 env (Access00_1 p0) = fst (evalU0_0 env p0)
eval0_1 env (Access10_1 p0) = snd (evalU0_0 env p0)
...
eval1_1 env (Access01_1 p0) = fst (evalU1_0 env p0)
eval1_1 env (Access11_1 p0) = snd (evalU1_0 env p0)
...
eval2_0 env (Access02_0 p0) = fst (evalU2_1 env p0)
eval2_0 env (Access12_0 p0) = snd (evalU2_1 env p0)
    ...
    let run = (let f xs = 
                            case xs of
                                ...
                                Cons h t -> 
                                    ...
                                    let c0 = (al_head t) in
                                        {-
                                                        {if (or (<= h c0) (== c0 tmp1.2)) then tmp1.1
                else + 1 tmp1.1, if (or (== h 1) (== tmp1.2 1)) then 1
                else 0}
                                        -}
                                        evalU1_0 (RefEnv [("tmp1", (Env0 tmp1)), ("h", (Env1 h)), ("c0", (Env1 c0))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
            -- fst tmp2
...
count10p :: List -> SymInteger
count10p = 
    let f s0 s1 xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let upd = (mrgIte (s1 &&~  (h ==~  1)) (1) (0)) in 
                            let s1 = ((h ==~  0) &&~  (s0 ||~  s1)) in 
                                let s0 = (h ==~  1) in 
                                    upd +  (f s0 s1 t)
                in
    f  (toSym False) (toSym False)

main' = 
    single_pass count10p
...
main = do
    let pairs = [
                ...
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))))))), 5)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), 3)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))))))))), 3)
                ...
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 2)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))))))), 2)
