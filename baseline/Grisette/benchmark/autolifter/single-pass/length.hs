...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0] ++ [mrgParam31_0] ++ [mrgCzero1_0] ++ [mrgCone1_0] ++ [mrgAl_inf1_0]
...
main = do
    let pairs = [
                ((Cons (3) (Cons (-1) (Cons (2) (Cons (5) (Cons (1) (Cons (1) (Cons (4) (Cons (-4) (Cons (3) (Nil Unit)))))))))), 9)
                , ((Cons (-4) (Cons (2) (Cons (3) (Nil Unit)))), 3)
                , ((Cons (5) (Cons (-3) (Cons (3) (Nil Unit)))), 3)
                , ((Cons (3) (Nil Unit)), 1)
                , ((Cons (0) (Cons (-5) (Cons (-3) (Nil Unit)))), 3)
                , ((Cons (-1) (Cons (0) (Cons (2) (Cons (-4) (Cons (-1) (Cons (3) (Cons (-1) (Cons (1) (Cons (4) (Nil Unit)))))))))), 9)
                , ((Cons (4) (Cons (3) (Cons (2) (Cons (0) (Cons (1) (Cons (-4) (Cons (-1) (Nil Unit)))))))), 7)
                , ((Cons (0) (Cons (-2) (Cons (-2) (Cons (4) (Cons (4) (Cons (-2) (Cons (-1) (Cons (3) (Cons (-1) (Nil Unit)))))))))), 9)
                , ((Cons (0) (Cons (4) (Nil Unit))), 2)
                , ((Cons (2) (Cons (0) (Cons (0) (Nil Unit)))), 3)
                , ((Cons (3) (Nil Unit)), 1)
                , ((Cons (2) (Cons (0) (Cons (-1) (Cons (-2) (Cons (-3) (Cons (1) (Cons (-1) (Nil Unit)))))))), 7)
                , ((Cons (3) (Cons (3) (Cons (-1) (Nil Unit)))), 3)
                , ((Cons (3) (Cons (-5) (Cons (-2) (Nil Unit)))), 3)
                , ((Cons (5) (Cons (2) (Cons (0) (Cons (4) (Cons (3) (Cons (0) (Cons (1) (Cons (5) (Nil Unit))))))))), 8)
                , ((Cons (2) (Cons (2) (Cons (2) (Cons (3) (Cons (-1) (Cons (-5) (Cons (-2) (Cons (-4) (Nil Unit))))))))), 8)
                , ((Nil Unit), 0)
                , ((Cons (3) (Cons (0) (Cons (5) (Cons (-1) (Cons (-2) (Cons (5) (Cons (-5) (Cons (0) (Cons (3) (Nil Unit)))))))))), 9)
                , ((Cons (-1) (Cons (-3) (Cons (3) (Nil Unit)))), 3)
                , ((Cons (2) (Cons (2) (Cons (-5) (Cons (-2) (Cons (1) (Nil Unit)))))), 5)
                ]
