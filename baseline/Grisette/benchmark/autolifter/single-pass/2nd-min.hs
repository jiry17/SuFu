  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_3 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgMax1_1 e1_0 e1_1] ++ [mrgMin1_1 e1_2 e1_3] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
main = do
    let pairs = [
                ((Cons (-2) (Cons (3) (Cons (2) (Cons (1) (Cons (2) (Cons (2) (Cons (1) (Cons (1) (Cons (-2) (Nil Unit)))))))))), -2)
                , ((Cons (0) (Cons (5) (Nil Unit))), 5)
                , ((Cons (-1) (Cons (-1) (Nil Unit))), -1)
                , ((Cons (5) (Cons (-5) (Cons (5) (Cons (-5) (Cons (5) (Cons (-4) (Cons (4) (Nil Unit)))))))), -5)
                , ((Cons (5) (Cons (1) (Cons (4) (Cons (-2) (Cons (4) (Cons (2) (Cons (0) (Nil Unit)))))))), 0)
                , ((Cons (0) (Cons (1) (Cons (-4) (Cons (-3) (Cons (-5) (Cons (4) (Cons (1) (Nil Unit)))))))), -4)
                , ((Cons (2) (Cons (-5) (Cons (-5) (Cons (4) (Cons (4) (Cons (-3) (Cons (3) (Cons (1) (Nil Unit))))))))), -5)
                , ((Cons (-1) (Nil Unit)), 100)
                , ((Cons (-4) (Cons (0) (Cons (3) (Cons (1) (Cons (1) (Cons (-4) (Cons (-5) (Cons (0) (Nil Unit))))))))), -4)
                , ((Cons (-4) (Nil Unit)), 100)
                , ((Cons (-5) (Cons (-2) (Cons (4) (Nil Unit)))), -2)
                , ((Cons (-4) (Cons (4) (Cons (-5) (Cons (-4) (Cons (4) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (-4) (Nil Unit)))))))))), -4)
                , ((Cons (-3) (Cons (-3) (Cons (5) (Cons (4) (Cons (3) (Nil Unit)))))), -3)
                , ((Cons (2) (Cons (2) (Cons (-2) (Cons (-2) (Cons (2) (Cons (-2) (Cons (5) (Cons (3) (Cons (0) (Nil Unit)))))))))), -2)
                , ((Cons (2) (Cons (2) (Cons (-2) (Cons (2) (Cons (-4) (Nil Unit)))))), -2)
                , ((Cons (-4) (Cons (1) (Cons (-1) (Cons (3) (Cons (1) (Cons (-5) (Cons (1) (Nil Unit)))))))), -4)
                , ((Nil Unit), 100)
                , ((Cons (-1) (Cons (0) (Cons (-5) (Cons (-5) (Cons (4) (Cons (5) (Cons (-3) (Cons (-4) (Cons (1) (Nil Unit)))))))))), -5)
                , ((Cons (0) (Cons (-4) (Cons (1) (Cons (2) (Cons (3) (Cons (4) (Cons (3) (Cons (3) (Nil Unit))))))))), 0)
                , ((Cons (0) (Cons (2) (Nil Unit))), 2)
                ]
    startTime <- getCurrentTime
    result <- SysTimeout.timeout (100 * 1000000) $ ioPair pairs
