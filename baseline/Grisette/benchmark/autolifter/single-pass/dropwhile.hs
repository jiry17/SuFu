...
main = do
    let pairs = [
                ((Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))), 4)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (1) (Nil Unit))), 1)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Nil Unit)))), 1)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit)))))))), 0)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 2)
                , ((Cons (0) (Cons (0) (Nil Unit))), 2)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (1) (Cons (0) (Nil Unit)))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))))), 0)
                , ((Cons (1) (Cons (1) (Nil Unit))), 0)
                , ((Cons (0) (Cons (0) (Nil Unit))), 2)
                , ((Cons (1) (Nil Unit)), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 1)
                ]
