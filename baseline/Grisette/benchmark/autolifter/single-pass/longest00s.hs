...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam01_1] ++ [mrgCzero1_1] ++ [mrgCone1_1] ++ [mrgCtwo1_1]
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCless1_2 e1_3 e1_4] ++ [mrgCleq1_2 e1_5 e1_6] ++ [mrgCor1_2 e2_2 e2_3])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e2_0 e0_4 e0_5] ++ [mrgAccess02_0 e1_0] ++ [mrgAccess12_0 e1_1] ++ [mrgAccess22_0 e1_2])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval0_0 env (Prod0_0 p0 p1 p2) = ((evalU0_1 env p0), (evalU0_1 env p0), (evalU0_1 env p0))
eval0_0 env (Czero0_0) = (0,0,0)
...
eval1_0 env (Prod1_0 p0 p1 p2) = ((evalU1_1 env p0), (evalU1_1 env p0), (evalU1_1 env p0))
...
eval2_0 env (Access22_0 p0) = getThird (evalU2_1 env p0)
...
eval2_1 env (Prod2_1 p0 p1 p2) = ((evalU2_0 env p0), (evalU2_0 env p0), (evalU2_0 env p0))
...
single_pass v xs = 
    let run = (let f xs = 
                            case xs of
                                Nil _ -> 
                                    evalU0_0 (RefEnv []) ((genSym (0::Int) "hole0") :: (UnionM Expr0_0))
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        {-
                                                    {if (or (< 0 h) (<= tmp1.2 (+ tmp1.1 tmp1.3))) then tmp1.1
            else + 2 tmp1.1, + 1 tmp1.2, if (< 0 h) then + 1 tmp1.2
            else tmp1.3}
                                        -}
                                        -- 0 1 2 +
                                        -- < <= ||
                                        -- (mrgIte ((0 <~ h) ||~ (getSecond tmp1 <=~ (getFirst tmp1 + getThird tmp1))) (getFirst tmp1) (2 + getFirst tmp1), 1 + getSecond tmp1, mrgIte (0 <~ h) (1 + getSecond tmp1) (getThird tmp1))
...
main = do
    let pairs = [
                ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 2)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))), 4)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))), 4)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 2)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), 4)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))))))), 4)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (1) (Nil Unit))), 0)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 0)
                ]
