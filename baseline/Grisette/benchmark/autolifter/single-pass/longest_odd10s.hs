...
data Expr2_0
  ...
  | Access02_0 (UnionM Expr2_1)
  | Access12_0 (UnionM Expr2_1)
  | Al_inf2_0
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess00_1 e0_0] ++ [mrgAccess10_1 e0_1])
        return res
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgIs_even0_2 e1_0] ++ [mrgCeq0_2 e1_1 e1_2] ++ [mrgCless0_2 e1_3 e1_4] ++ [mrgCleq0_2 e1_5 e1_6] ++ [mrgCand0_2 e2_0 e2_1] ++ [mrgCor0_2 e2_2 e2_3] ++ [mrgCnot0_2 e2_4])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e2_0 e1_4 e1_5] ++ [mrgAccess01_1 e0_0] ++ [mrgAccess11_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgIs_even1_2 e1_0] ++ [mrgCeq1_2 e1_1 e1_2] ++ [mrgCless1_2 e1_3 e1_4] ++ [mrgCleq1_2 e1_5 e1_6] ++ [mrgCand1_2 e2_0 e2_1] ++ [mrgCor1_2 e2_2 e2_3] ++ [mrgCnot1_2 e2_4])
        return res
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCzero2_0] ++ [mrgAl_inf2_0]
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd2_0 e0_0 e0_1] ++ [mrgCsub2_0 e0_2 e0_3] ++ [mrgCIte2_0 e2_0 e0_4 e0_5] ++ [mrgAccess02_0 e1_0] ++ [mrgAccess12_0 e1_1])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgIs_even2_2 e0_0] ++ [mrgCeq2_2 e0_1 e0_2] ++ [mrgCless2_2 e0_3 e0_4] ++ [mrgCleq2_2 e0_5 e0_6] ++ [mrgCand2_2 e2_0 e2_1] ++ [mrgCor2_2 e2_2 e2_3] ++ [mrgCnot2_2 e2_4])
        return res

getFirst :: (SymInteger, SymInteger) -> SymInteger
getFirst (a, _) = a

getSecond :: (SymInteger, SymInteger) -> SymInteger
getSecond (_, b) = b

eval0_0 :: RefEnv -> Expr0_0 -> (SymInteger, SymInteger)
eval0_0 env (Prod0_0 p0 p1) = ((evalU0_1 env p0), (evalU0_1 env p1))
eval0_0 env (CTupleZero0_0) = (0,0)
...
eval0_2 env (Is_even0_2 p0) = is_even (evalU0_1 env p0)
...
eval1_2 env (Is_even1_2 p0) = is_even (evalU1_1 env p0)
...
eval2_0 env (Access02_0 p0) = getFirst (evalU2_1 env p0)
eval2_0 env (Access12_0 p0) = getSecond (evalU2_1 env p0)
...
eval2_2 env (Is_even2_2 p0) = is_even (evalU2_0 env p0)
...
div' a b = 
    let a1 = toCon (ssym "a" :: SymInteger) :: Maybe Integer in
    let b1 = toCon (ssym "b" :: SymInteger) :: Maybe Integer in
        case a1 of 
...
single_pass v xs = 
    let run = (let f xs = 
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        evalU1_0 (RefEnv [("tmp1", (Env0 tmp1)), ("h", (Env1 h))]) ((genSym (5::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
...
f :: SymBool -> SymBool -> SymInteger -> List -> SymInteger
f s1 s2 len xs = case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let s1 = (s2 &&~  (h ==~  1)) in 
                            let s2 = (h ==~  0) in 
                                let len = (mrgIte (s1) (len + 1) (mrgIte s2 len 0)) in
                                    mrgIte (is_even len) (f s1 s2 len t) (max' len (f s1 s2 len t))

longest_odd10s :: List -> SymInteger
longest_odd10s = f  (toSym False) (toSym False) 0

main' = 
    single_pass longest_odd10s
...
main = do
    let pairs = [
                ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), 1)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), 0)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), 0)
                , ((Nil Unit), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))))))), 1)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))), 0)
                , ((Cons (0) (Cons (1) (Nil Unit))), 1)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), 1)
                ]
