  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_0 <- (gen2 (gendepth - 1))
        e2_1 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCless1_2 e1_2 e1_3] ++ [mrgCand1_2 e2_0 e2_1])
        return res
...
count10s2 :: List -> SymInteger
count10s2 = 
    let f s0 xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let upd = (mrgIte (s0 &&~  (h ==~  2)) (1) (0)) in
                            let s0 = ((h ==~  1) ||~  (s0 &&~  (h ==~  0))) in 
                                upd +  (f s0 t)
                in f  (toSym False)

main' = 
    single_pass count10s2
...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (4) (Cons (4) (Cons (4) (Cons (3) (Cons (5) (Cons (4) (Cons (3) (Cons (0) (Nil Unit))))))))), 0)
                , ((Cons (5) (Cons (5) (Nil Unit))), 0)
                , ((Cons (1) (Cons (3) (Cons (5) (Cons (1) (Cons (2) (Cons (3) (Cons (5) (Cons (3) (Cons (5) (Nil Unit)))))))))), 1)
                , ((Cons (2) (Cons (4) (Cons (1) (Cons (2) (Nil Unit))))), 1)
                , ((Cons (0) (Cons (4) (Cons (5) (Cons (1) (Cons (2) (Cons (3) (Cons (4) (Cons (5) (Nil Unit))))))))), 1)
                , ((Cons (5) (Cons (1) (Cons (3) (Cons (1) (Nil Unit))))), 0)
                , ((Cons (1) (Nil Unit)), 0)
                , ((Cons (1) (Cons (0) (Cons (4) (Cons (4) (Cons (0) (Cons (2) (Cons (1) (Nil Unit)))))))), 0)
                , ((Cons (5) (Cons (0) (Nil Unit))), 0)
                , ((Cons (2) (Cons (2) (Cons (0) (Cons (1) (Cons (2) (Cons (4) (Nil Unit))))))), 1)
                , ((Nil Unit), 0)
                , ((Cons (4) (Cons (2) (Cons (2) (Cons (0) (Cons (5) (Cons (1) (Cons (3) (Nil Unit)))))))), 0)
                , ((Cons (5) (Cons (1) (Cons (1) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (4) (Cons (0) (Cons (4) (Nil Unit)))), 0)
                , ((Cons (5) (Cons (2) (Cons (2) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (3) (Cons (4) (Cons (4) (Nil Unit))))))))), 0)
                ]
