...
expected :: List -> (SymInteger, SymInteger)
expected = 
    let f p np xs = 
                case xs of
...
main = do
    let pairs = [
                ((Nil Unit), 0)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (4) (Cons (3) (Cons (1) (Cons (5) (Cons (3) (Cons (1) (Cons (-4) (Nil Unit))))))))), 9)
                , ((Cons (4) (Cons (5) (Nil Unit))), 5)
                , ((Cons (-3) (Cons (1) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (4) (Cons (1) (Cons (5) (Nil Unit)))))))))), 14)
                , ((Cons (-1) (Cons (2) (Cons (-3) (Cons (-2) (Nil Unit))))), 6)
                , ((Cons (-5) (Cons (3) (Cons (5) (Cons (-3) (Cons (-1) (Cons (1) (Cons (3) (Cons (5) (Nil Unit))))))))), 9)
                , ((Cons (4) (Cons (-4) (Cons (1) (Cons (-2) (Nil Unit))))), 11)
                , ((Cons (-3) (Nil Unit)), 3)
                , ((Cons (-3) (Cons (-4) (Cons (2) (Cons (3) (Cons (-4) (Cons (0) (Cons (-3) (Nil Unit)))))))), 10)
                , ((Cons (4) (Cons (-5) (Nil Unit))), 9)
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), 4)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (0) (Cons (-2) (Cons (-5) (Cons (5) (Cons (-3) (Cons (2) (Nil Unit)))))))), 15)
                , ((Cons (4) (Cons (-2) (Cons (-2) (Nil Unit)))), 6)
                , ((Nil Unit), 0)
                , ((Cons (3) (Cons (-5) (Cons (2) (Nil Unit)))), 10)
                , ((Cons (5) (Cons (-1) (Cons (0) (Nil Unit)))), 6)
                , ((Nil Unit), 0)
