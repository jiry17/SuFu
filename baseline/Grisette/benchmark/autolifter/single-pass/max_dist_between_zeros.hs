  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_2 <- (gen2 (gendepth - 1))
        e2_3 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCeq1_2 e1_0 e1_1] ++ [mrgCless1_2 e1_2 e1_3] ++ [mrgCor1_2 e2_2 e2_3])
        return res
                            ...
                            case xs of
                                ...
                                Cons h t -> 
                                    let tmp1 = (f t) in 
                                        ...
                                        -}
                                        evalU1_0 (RefEnv [("tmp1", (Env0 tmp1)), ("h", (Env1 h))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))
                            in
                f ) in 
        let tmp2 = (run xs) in 
...
max_dist_between_zeros :: List -> SymInteger
max_dist_between_zeros = 
    let f cs xs = 
                case xs of
                    Nil _ -> 0
                    Cons h t -> 
                        let cs = (mrgIte (h ==~  0) (0) (cs + 1)) in
                            max' cs (f cs t)
                in f 0

main' = 
    single_pass max_dist_between_zeros
...
main = do
    let pairs = [
                ((Cons (1) (Nil Unit)), 1)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))))))), 4)
                , ((Cons (0) (Cons (0) (Nil Unit))), 0)
                , ((Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), 1)
                , ((Cons (1) (Cons (0) (Cons (1) (Nil Unit)))), 1)
                , ((Cons (1) (Cons (1) (Cons (0) (Nil Unit)))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))), 3)
                , ((Cons (0) (Cons (0) (Nil Unit))), 0)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))), 1)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), 2)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))))))), 2)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))), 2)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), 2)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))))), 3)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), 4)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Nil Unit))))))))), 2)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))), 4)
                , ((Cons (0) (Nil Unit)), 0)
                , ((Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), 3)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit)))))))), 4)
                ]
