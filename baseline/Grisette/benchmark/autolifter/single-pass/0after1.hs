  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e1_3 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCless1_0 e1_2 e1_3] ++ [mrgCor1_0 e0_2 e0_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
zafter1 :: List -> SymBool
zafter1 = 
    let f seen1 xs = 
                case xs of
                    Nil _ -> toSym False
                    Cons h t -> mrgIte (seen1 &&~ (h ==~  0))
                            (toSym True)
                            (f (seen1 ||~ (h ==~ 1)) t)
...
main = do
    let pairs = [
                ((Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))))))), True)
                , ((Cons (0) (Nil Unit)), False)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))), True)
                , ((Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Nil Unit)))))))))))), True)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit)))))))), False)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))), True)
                , ((Nil Unit), False)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Nil Unit)))))))), True)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Nil Unit)))))))))))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))))))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (0) (Nil Unit))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (0) (Nil Unit))))), True)
                , ((Cons (1) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), True)
                , ((Cons (0) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (0) (Cons (0) (Cons (1) (Cons (0) (Cons (1) (Nil Unit))))))))))))), True)
                , ((Cons (1) (Cons (1) (Cons (1) (Cons (1) (Nil Unit))))), False)
                , ((Cons (0) (Cons (1) (Nil Unit))), False)
                , ((Cons (0) (Cons (1) (Cons (1) (Cons (0) (Cons (1) (Nil Unit)))))), True)
                ]
