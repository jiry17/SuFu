...
main = do
    let pairs = [
                ...
                , ((Cons (-1) (Cons (-1) (Cons (-4) (Cons (-3) (Cons (0) (Cons (2) (Nil Unit))))))), -9)
                , ((Nil Unit), 0)
                , ((Cons (2) (Cons (0) (Cons (-2) (Cons (-5) (Cons (5) (Cons (-3) (Cons (2) (Nil Unit)))))))), -5)
                , ((Cons (4) (Cons (-2) (Cons (-2) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (3) (Cons (-5) (Cons (2) (Nil Unit)))), -2)
                , ((Cons (5) (Cons (-1) (Cons (0) (Nil Unit)))), 0)
                , ((Nil Unit), 0)
                , ((Cons (-2) (Cons (-4) (Cons (-3) (Cons (-3) (Cons (-3) (Cons (1) (Cons (3) (Cons (3) (Nil Unit))))))))), -15)
                ]
