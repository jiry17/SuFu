  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgIs_even2_2 e1_0] ++ [mrgCeq2_2 e1_1 e1_2] ++ [mrgCless2_2 e1_3 e1_4] ++ [mrgCleq2_2 e1_5 e1_6] ++ [mrgCand2_2 e2_0 e2_1] ++ [mrgCor2_2 e2_2 e2_3] ++ [mrgCnot2_2 e2_4])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgIs_even3_2 e0_0] ++ [mrgCeq3_2 e0_1 e0_2] ++ [mrgCless3_2 e0_3 e0_4] ++ [mrgCleq3_2 e0_5 e0_6] ++ [mrgCand3_2 e2_0 e2_1] ++ [mrgCor3_2 e2_2 e2_3] ++ [mrgCnot3_2 e2_4])
        return res
...
eval2_2 env (Is_even2_2 p0) = is_even (evalU2_1 env p0)
...
eval3_2 env (Is_even3_2 p0) = is_even (evalU3_0 env p0)
