...
data Expr4_1
  ...
  | Czero4_1
  | CIte4_1 (UnionM Expr4_4) (UnionM Expr4_1) (UnionM Expr4_1)
  | Access0_2_4_1 (UnionM Expr4_2)
  | Access1_2_4_1 (UnionM Expr4_2)
  | Access2_2_4_1 (UnionM Expr4_2)
  | Access3_2_4_1 (UnionM Expr4_2)
  | Access4_2_4_1 (UnionM Expr4_2)
...
data Expr4_2
  = Param84_2
  | Access1_3_4_2 (UnionM Expr4_3)
  | Prod4_2 (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1) (UnionM Expr4_1)
  deriving stock (Generic, Show)
...
data Expr4_4
  = Ceq4_4 (UnionM Expr4_1) (UnionM Expr4_1)
  | Cless4_4 (UnionM Expr4_1) (UnionM Expr4_1)
  | Cleq4_4 (UnionM Expr4_1) (UnionM Expr4_1)
  | Cand4_4 (UnionM Expr4_4) (UnionM Expr4_4)
  | Cor4_4 (UnionM Expr4_4) (UnionM Expr4_4)
  | Cnot4_4 (UnionM Expr4_4)
  | CFalse4_4
  deriving stock (Generic, Show)
  deriving (Mergeable, EvaluateSym, ToCon Expr4_4)
    via (Default Expr4_4)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_0_1 e0_0] ++ [mrgAccess1_0_0_1 e0_1] ++ [mrgAccess2_0_0_1 e0_2] ++ [mrgAccess3_0_0_1 e0_3] ++ [mrgAccess4_0_0_1 e0_4])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e3_0 e1_4 e1_5] ++ [mrgAccess0_0_1_1 e0_0] ++ [mrgAccess1_0_1_1 e0_1] ++ [mrgAccess2_0_1_1 e0_2] ++ [mrgAccess3_0_1_1 e0_3] ++ [mrgAccess4_0_1_1 e0_4] ++ [mrgAccess0_2_1_1 e2_0])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1] ++ [mrgAccess2_0_2_1 e0_2] ++ [mrgAccess3_0_2_1 e0_3] ++ [mrgAccess4_0_2_1 e0_4])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd3_1 e1_0 e1_1] ++ [mrgCsub3_1 e1_2 e1_3] ++ [mrgCIte3_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_3_1 e0_0] ++ [mrgAccess1_0_3_1 e0_1] ++ [mrgAccess2_0_3_1 e0_2] ++ [mrgAccess3_0_3_1 e0_3] ++ [mrgAccess4_0_3_1 e0_4])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam24_1] ++ [mrgParam34_1] ++ [mrgParam64_1] ++ [mrgParam104_1] ++ [mrgCzero4_1] ++ [mrgAl_inf4_1]
    genSingle2 = [mrgParam84_2]
    genSingle3 = [mrgParam94_3]
    genSingle4 = [mrgCFalse4_4]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e1_0 <- (gen1 (gendepth - 1))
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e2_3 <- (gen2 (gendepth - 1))
        e2_4 <- (gen2 (gendepth - 1))
        e4_0 <- (gen4 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd4_1 e1_0 e1_1] ++ [mrgCsub4_1 e1_2 e1_3] ++ [mrgCIte4_1 e4_0 e1_4 e1_5] ++ [mrgAccess0_2_4_1 e2_0] ++ [mrgAccess1_2_4_1 e2_1] ++ [mrgAccess2_2_4_1 e2_2] ++ [mrgAccess3_2_4_1 e2_3] ++ [mrgAccess4_2_4_1 e2_4] ++ [mrgAccess0_0_4_1 e0_0] ++ [mrgAccess1_0_4_1 e0_1])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
        ...
        e1_4 <- (gen1 (gendepth - 1))
        e3_0 <- (gen3 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgAccess1_3_4_2 e3_0] ++ [mrgProd4_2 e1_0 e1_1 e1_2 e1_3 e1_4])
        return res
    gen3 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle3
      | otherwise = do
        res <- chooseUnionFresh (genSingle3)
        return res
    gen4 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle4
      | otherwise = do
        e1_0 <- (gen1 (gendepth - 1))
        e1_1 <- (gen1 (gendepth - 1))
        e1_2 <- (gen1 (gendepth - 1))
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e4_0 <- (gen4 (gendepth - 1))
        e4_1 <- (gen4 (gendepth - 1))
        e4_2 <- (gen4 (gendepth - 1))
        e4_3 <- (gen4 (gendepth - 1))
        e4_4 <- (gen4 (gendepth - 1))
        res <- chooseUnionFresh (genSingle4 ++ [mrgCeq4_4 e1_0 e1_1] ++ [mrgCless4_4 e1_2 e1_3] ++ [mrgCleq4_4 e1_4 e1_5] ++ [mrgCand4_4 e4_0 e4_1] ++ [mrgCor4_4 e4_2 e4_3] ++ [mrgCnot4_4 e4_4])
        return res
...
eval4_1 env (Param24_1) = evalVar1 env "len"
eval4_1 env (Param34_1) = evalVar1 env "r"
eval4_1 env (Param64_1) = evalVar1 env "l"
eval4_1 env (Param104_1) = evalVar1 env "h"
...
eval4_1 env (CIte4_1 p0 p1 p2) = mrgIte ((evalU4_4 env p0) ==~ (toSym True)) (evalU4_1 env p1) (evalU4_1 env p2)
eval4_1 env (Access0_2_4_1 p0) = get1from5 (evalU4_2 env p0)
eval4_1 env (Access1_2_4_1 p0) = get2from5 (evalU4_2 env p0)
eval4_1 env (Access2_2_4_1 p0) = get3from5 (evalU4_2 env p0)
eval4_1 env (Access3_2_4_1 p0) = get4from5 (evalU4_2 env p0)
eval4_1 env (Access4_2_4_1 p0) = get5from5 (evalU4_2 env p0)
eval4_1 env (Access0_0_4_1 p0) = fst (evalU4_0 env p0)
eval4_1 env (Access1_0_4_1 p0) = snd (evalU4_0 env p0)
eval4_1 env (Al_inf4_1) = (100 :: SymInteger)

evalU4_1 :: RefEnv -> UnionM Expr4_1 -> SymInteger
evalU4_1 env = onUnion (eval4_1 env)

eval4_2 :: RefEnv -> Expr4_2 -> (SymInteger, SymInteger, SymInteger, SymInteger, SymInteger)
eval4_2 env (Param84_2) = evalVar0 env "tmp5"
eval4_2 env (Access1_3_4_2 p0) = snd (evalU4_3 env p0)
eval4_2 env (Prod4_2 p0 p1 p2 p3 p4) = ((evalU4_1 env p0), (evalU4_1 env p1), (evalU4_1 env p2), (evalU4_1 env p3), (evalU4_1 env p4))

evalU4_2 :: RefEnv -> UnionM Expr4_2 -> (SymInteger, SymInteger, SymInteger, SymInteger, SymInteger)
evalU4_2 env = onUnion (eval4_2 env)

eval4_3 :: RefEnv -> Expr4_3 -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger, SymInteger))
eval4_3 env (Param94_3) = evalVar3 env "res"

evalU4_3 :: RefEnv -> UnionM Expr4_3 -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger, SymInteger))
evalU4_3 env = onUnion (eval4_3 env)

eval4_4 :: RefEnv -> Expr4_4 -> SymBool
eval4_4 env (Ceq4_4 p0 p1) =  (evalU4_1 env p0) ==~ (evalU4_1 env p1) 
eval4_4 env (Cless4_4 p0 p1) =  (evalU4_1 env p0) <~ (evalU4_1 env p1) 
eval4_4 env (Cleq4_4 p0 p1) =  (evalU4_1 env p0) <=~ (evalU4_1 env p1) 
eval4_4 env (Cand4_4 p0 p1) =  (evalU4_4 env p0) &&~ (evalU4_4 env p1) 
eval4_4 env (Cor4_4 p0 p1) =  (evalU4_4 env p0) ||~ (evalU4_4 env p1) 
eval4_4 env (Cnot4_4 p0) =  mrgIte ((evalU4_4 env p0) ==~ (toSym True)) (toSym False) (toSym True)
eval4_4 env (CFalse4_4) = (toSym False)

evalU4_4 :: RefEnv -> UnionM Expr4_4 -> SymBool
evalU4_4 env = onUnion (eval4_4 env)
...
main = do
    let pairs = [
                ((((Cons ((-5)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((4)) ((Cons ((-2)) ((Cons ((3)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-5)) ((Nil Unit)))))))))))))))))))))))), ((Ocons ((Update ((-2)) ((2)) ((-2)))) ((Ocons ((Query ((-3)) ((-4)))) ((Ocons ((Update ((-4)) ((-3)) ((4)))) ((Ocons ((Query ((-1)) ((5)))) ((Ocons ((Query ((-2)) ((0)))) ((Ocons ((Query ((0)) ((-4)))) ((Ocons ((Query ((-2)) ((4)))) ((Ocons ((Update ((4)) ((-5)) ((1)))) ((Ocons ((Query ((4)) ((2)))) ((Ocons ((Query ((0)) ((-2)))) ((Ocons ((Query ((-1)) ((4)))) ((Ocons ((Update ((1)) ((-5)) ((-2)))) ((Onil Unit))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((4)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((4)) ((Cons ((5)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((-4)) ((Cons ((0)) ((Nil Unit)))))))))))))))))))))), ((Ocons ((Query ((4)) ((-4)))) ((Onil Unit))))), (Nil Unit))
                , ((((Cons ((0)) ((Cons ((2)) ((Cons ((2)) ((Cons ((0)) ((Cons ((-4)) ((Nil Unit)))))))))))), ((Ocons ((Query ((-5)) ((1)))) ((Ocons ((Query ((1)) ((-2)))) ((Ocons ((Update ((-3)) ((-1)) ((-1)))) ((Ocons ((Update ((2)) ((5)) ((1)))) ((Ocons ((Update ((0)) ((-4)) ((2)))) ((Ocons ((Update ((4)) ((5)) ((-4)))) ((Ocons ((Update ((5)) ((-4)) ((4)))) ((Ocons ((Update ((3)) ((1)) ((1)))) ((Ocons ((Query ((4)) ((-3)))) ((Onil Unit))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((-4)) ((Cons ((3)) ((Cons ((2)) ((Cons ((0)) ((Cons ((0)) ((Cons ((4)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((2)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((0)) ((Nil Unit)))))))))))))))))))))))))))))), ((Ocons ((Query ((1)) ((0)))) ((Ocons ((Query ((-2)) ((5)))) ((Ocons ((Query ((4)) ((2)))) ((Ocons ((Update ((-4)) ((3)) ((-2)))) ((Ocons ((Update ((0)) ((-5)) ((-3)))) ((Ocons ((Update ((4)) ((1)) ((-2)))) ((Ocons ((Query ((0)) ((-2)))) ((Ocons ((Query ((-1)) ((2)))) ((Ocons ((Update ((5)) ((1)) ((5)))) ((Ocons ((Update ((1)) ((-2)) ((2)))) ((Ocons ((Query ((2)) ((3)))) ((Onil Unit))))))))))))))))))))))))), (Cons ((0)) ((Nil Unit))))
                , ((((Cons ((-1)) ((Cons ((-1)) ((Cons ((3)) ((Cons ((5)) ((Cons ((3)) ((Cons ((3)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Nil Unit)))))))))))))))))))))))))))))), ((Ocons ((Query ((-3)) ((3)))) ((Ocons ((Update ((2)) ((0)) ((-5)))) ((Ocons ((Query ((-1)) ((3)))) ((Ocons ((Update ((-3)) ((-5)) ((3)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Query ((0)) ((4)))) ((Ocons ((Update ((2)) ((3)) ((-5)))) ((Ocons ((Update ((5)) ((-5)) ((2)))) ((Ocons ((Query ((-4)) ((-2)))) ((Onil Unit))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((3)) ((Cons ((-3)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((-2)) ((Cons ((-4)) ((Nil Unit)))))))))))))))))))))))))), ((Ocons ((Update ((-3)) ((-4)) ((1)))) ((Ocons ((Update ((0)) ((0)) ((2)))) ((Ocons ((Update ((3)) ((-2)) ((-2)))) ((Ocons ((Query ((3)) ((5)))) ((Ocons ((Update ((4)) ((-5)) ((3)))) ((Ocons ((Query ((5)) ((5)))) ((Ocons ((Update ((5)) ((1)) ((5)))) ((Ocons ((Query ((0)) ((-5)))) ((Ocons ((Query ((-3)) ((3)))) ((Ocons ((Update ((5)) ((2)) ((3)))) ((Ocons ((Query ((1)) ((-2)))) ((Onil Unit))))))))))))))))))))))))), (Cons ((0)) ((Cons ((0)) ((Nil Unit))))))
                , ((((Cons ((-5)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((1)) ((Cons ((3)) ((Cons ((3)) ((Cons ((2)) ((Nil Unit)))))))))))))))))))), ((Onil Unit))), (Nil Unit))
                , ((((Cons ((-4)) ((Cons ((-4)) ((Cons ((1)) ((Cons ((4)) ((Cons ((-2)) ((Cons ((1)) ((Nil Unit)))))))))))))), ((Ocons ((Update ((-4)) ((-3)) ((-5)))) ((Ocons ((Update ((-4)) ((-4)) ((-4)))) ((Ocons ((Update ((-3)) ((-3)) ((-1)))) ((Ocons ((Query ((-1)) ((3)))) ((Ocons ((Update ((5)) ((-3)) ((1)))) ((Ocons ((Query ((5)) ((5)))) ((Ocons ((Update ((0)) ((-5)) ((-2)))) ((Ocons ((Query ((-2)) ((4)))) ((Ocons ((Update ((5)) ((-2)) ((4)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Update ((-3)) ((3)) ((-5)))) ((Ocons ((Update ((4)) ((4)) ((5)))) ((Onil Unit))))))))))))))))))))))))))), (Cons ((0)) ((Nil Unit))))
                , ((((Cons ((0)) ((Cons ((-5)) ((Cons ((5)) ((Cons ((1)) ((Cons ((-4)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((4)) ((Cons ((-3)) ((Nil Unit)))))))))))))))))))), ((Ocons ((Update ((-4)) ((-3)) ((2)))) ((Ocons ((Update ((-1)) ((-5)) ((4)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((-2)) ((Cons ((-1)) ((Nil Unit)))))), ((Ocons ((Query ((-3)) ((5)))) ((Ocons ((Update ((3)) ((2)) ((3)))) ((Ocons ((Query ((1)) ((5)))) ((Ocons ((Query ((4)) ((-1)))) ((Ocons ((Update ((-5)) ((1)) ((5)))) ((Ocons ((Update ((5)) ((5)) ((-1)))) ((Ocons ((Update ((-4)) ((-5)) ((-2)))) ((Ocons ((Query ((0)) ((-5)))) ((Ocons ((Query ((-5)) ((-3)))) ((Onil Unit))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((2)) ((Cons ((-5)) ((Nil Unit)))))), ((Ocons ((Update ((4)) ((-2)) ((-2)))) ((Onil Unit))))), (Nil Unit))
                , ((((Cons ((4)) ((Cons ((1)) ((Cons ((5)) ((Cons ((3)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((2)) ((Cons ((4)) ((Cons ((0)) ((Cons ((3)) ((Nil Unit)))))))))))))))))))))), ((Ocons ((Update ((4)) ((0)) ((5)))) ((Ocons ((Query ((0)) ((-3)))) ((Ocons ((Query ((-4)) ((3)))) ((Ocons ((Update ((-2)) ((0)) ((0)))) ((Ocons ((Query ((5)) ((-4)))) ((Ocons ((Query ((-5)) ((1)))) ((Ocons ((Update ((1)) ((-2)) ((2)))) ((Onil Unit))))))))))))))))), (Nil Unit))
                , ((((Cons ((2)) ((Cons ((0)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((4)) ((Cons ((3)) ((Cons ((-3)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((5)) ((Cons ((-4)) ((Cons ((0)) ((Cons ((-3)) ((Cons ((3)) ((Nil Unit)))))))))))))))))))))))))))))), ((Ocons ((Query ((0)) ((3)))) ((Ocons ((Update ((-2)) ((-1)) ((-1)))) ((Ocons ((Query ((4)) ((4)))) ((Ocons ((Update ((2)) ((0)) ((-5)))) ((Ocons ((Update ((-5)) ((-1)) ((-5)))) ((Ocons ((Update ((-5)) ((3)) ((4)))) ((Ocons ((Query ((2)) ((2)))) ((Ocons ((Query ((5)) ((2)))) ((Ocons ((Update ((1)) ((-4)) ((-3)))) ((Ocons ((Update ((-1)) ((1)) ((4)))) ((Ocons ((Update ((0)) ((-2)) ((-4)))) ((Ocons ((Update ((-2)) ((-2)) ((3)))) ((Onil Unit))))))))))))))))))))))))))), (Cons ((0)) ((Cons ((0)) ((Nil Unit))))))
                , ((((Cons ((-1)) ((Cons ((2)) ((Cons ((1)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((-4)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((0)) ((Cons ((1)) ((Cons ((4)) ((Nil Unit)))))))))))))))))))))))))))), ((Ocons ((Update ((3)) ((4)) ((3)))) ((Ocons ((Query ((-4)) ((5)))) ((Ocons ((Update ((-5)) ((-2)) ((-4)))) ((Ocons ((Query ((0)) ((-1)))) ((Ocons ((Update ((-1)) ((1)) ((2)))) ((Ocons ((Update ((-4)) ((-1)) ((2)))) ((Ocons ((Update ((3)) ((0)) ((-5)))) ((Onil Unit))))))))))))))))), (Nil Unit))
                , ((((Cons ((3)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((3)) ((Cons ((-2)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((-5)) ((Cons ((2)) ((Cons ((4)) ((Cons ((1)) ((Cons ((-2)) ((Nil Unit)))))))))))))))))))))))))), ((Ocons ((Query ((-5)) ((0)))) ((Ocons ((Query ((3)) ((5)))) ((Ocons ((Query ((0)) ((-5)))) ((Ocons ((Query ((-3)) ((4)))) ((Ocons ((Update ((4)) ((4)) ((-4)))) ((Onil Unit))))))))))))), (Cons ((0)) ((Nil Unit))))
                , ((((Cons ((5)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((-1)) ((Cons ((5)) ((Cons ((0)) ((Cons ((0)) ((Cons ((4)) ((Cons ((2)) ((Cons ((-4)) ((Nil Unit)))))))))))))))))))))))), ((Ocons ((Query ((5)) ((-1)))) ((Ocons ((Query ((5)) ((1)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((-1)) ((Cons ((-4)) ((Cons ((5)) ((Nil Unit)))))))), ((Ocons ((Update ((1)) ((2)) ((-2)))) ((Ocons ((Query ((-5)) ((5)))) ((Ocons ((Update ((-3)) ((-4)) ((3)))) ((Ocons ((Update ((-4)) ((1)) ((-1)))) ((Ocons ((Query ((5)) ((5)))) ((Ocons ((Update ((4)) ((-5)) ((-2)))) ((Ocons ((Update ((3)) ((-1)) ((5)))) ((Ocons ((Update ((4)) ((-4)) ((4)))) ((Ocons ((Query ((0)) ((5)))) ((Onil Unit))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((0)) ((Cons ((-2)) ((Cons ((5)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((-3)) ((Cons ((-5)) ((Nil Unit)))))))))))))))), ((Ocons ((Query ((-5)) ((1)))) ((Ocons ((Update ((-2)) ((5)) ((3)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((-2)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((-1)) ((Nil Unit)))))))))), ((Ocons ((Query ((-2)) ((4)))) ((Ocons ((Query ((-1)) ((3)))) ((Ocons ((Update ((5)) ((-4)) ((2)))) ((Ocons ((Update ((0)) ((1)) ((1)))) ((Ocons ((Query ((5)) ((4)))) ((Ocons ((Query ((-5)) ((0)))) ((Ocons ((Query ((2)) ((-1)))) ((Ocons ((Update ((0)) ((2)) ((-2)))) ((Ocons ((Query ((-4)) ((-5)))) ((Onil Unit))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((1)) ((Cons ((5)) ((Cons ((3)) ((Cons ((-1)) ((Cons ((-4)) ((Nil Unit)))))))))))), ((Ocons ((Update ((2)) ((0)) ((1)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Update ((-5)) ((5)) ((5)))) ((Ocons ((Query ((4)) ((-1)))) ((Ocons ((Update ((2)) ((-5)) ((3)))) ((Ocons ((Update ((-4)) ((5)) ((-2)))) ((Ocons ((Query ((3)) ((-5)))) ((Ocons ((Update ((4)) ((-4)) ((-1)))) ((Onil Unit))))))))))))))))))), (Nil Unit))
                ]
