...
type Result = (SymInteger, SymInteger, SymInteger, SymInteger)
...
data EnvValue
  ...
  | Env1 SymInteger
  | Env2 (SymInteger, (SymInteger, SymInteger, SymInteger, SymInteger))
  | Env3 (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
...
evalVar2 :: RefEnv -> Ident -> (SymInteger, (SymInteger, SymInteger, SymInteger, SymInteger))
...
evalVar3 :: RefEnv -> Ident -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
...
(SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
-}
...
data Expr3_0
  = Prod3_0 (UnionM Expr3_1) (UnionM Expr3_1) (UnionM Expr3_1) (UnionM Expr3_1)
  | CZero43_0
  deriving stock (Generic, Show)
...
data Expr4_1
  ...
  | Prod4_1 (UnionM Expr4_0) (UnionM Expr4_0) (UnionM Expr4_0) (UnionM Expr4_0)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd0_1 e1_0 e1_1] ++ [mrgCsub0_1 e1_2 e1_3] ++ [mrgCIte0_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_0_1 e0_0] ++ [mrgAccess1_0_0_1 e0_1] ++ [mrgAccess2_0_0_1 e0_2] ++ [mrgAccess3_0_0_1 e0_3])
        return res
    gen2 gendepth
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_3 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess1_2_1_0 e2_0] ++ [mrgProd1_0 e1_0 e1_1 e1_2 e1_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd1_1 e1_0 e1_1] ++ [mrgCsub1_1 e1_2 e1_3] ++ [mrgCIte1_1 e3_0 e1_4 e1_5] ++ [mrgAccess0_0_1_1 e0_0] ++ [mrgAccess1_0_1_1 e0_1] ++ [mrgAccess2_0_1_1 e0_2] ++ [mrgAccess3_0_1_1 e0_3] ++ [mrgAccess0_2_1_1 e2_0])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCZero42_0]
    genSingle1 = [mrgParam02_1] ++ [mrgParam12_1] ++ [mrgParam32_1] ++ [mrgParam42_1] ++ [mrgCzero2_1] ++ [mrgAl_inf2_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1] ++ [mrgAccess2_0_2_1 e0_2] ++ [mrgAccess3_0_2_1 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e1_3 <- (gen1 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd3_0 e1_0 e1_1 e1_2 e1_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e1_5 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd3_1 e1_0 e1_1] ++ [mrgCsub3_1 e1_2 e1_3] ++ [mrgCIte3_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_3_1 e0_0] ++ [mrgAccess1_0_3_1 e0_1] ++ [mrgAccess2_0_3_1 e0_2] ++ [mrgAccess3_0_3_1 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_3 <- (gen1 (gendepth - 1))
        e3_0 <- (gen3 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd4_0 e0_0 e0_1] ++ [mrgCsub4_0 e0_2 e0_3] ++ [mrgCIte4_0 e3_0 e0_4 e0_5] ++ [mrgAccess0_1_4_0 e1_0] ++ [mrgAccess1_1_4_0 e1_1] ++ [mrgAccess2_1_4_0 e1_2] ++ [mrgAccess3_1_4_0 e1_3])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e0_3 <- (gen0 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgAccess1_2_4_1 e2_0] ++ [mrgProd4_1 e0_0 e0_1 e0_2 e0_3])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
eval1_2 :: RefEnv -> Expr1_2 -> (SymInteger, (SymInteger, SymInteger, SymInteger, SymInteger))
eval1_2 env (Param61_2) = evalVar2 env "info"
eval1_2 env (Prod1_2 p0 p1) = ((evalU1_1 env p0), (evalU1_0 env p1))

evalU1_2 :: RefEnv -> UnionM Expr1_2 -> (SymInteger, (SymInteger, SymInteger, SymInteger, SymInteger))
...
eval2_1 env (Param42_1) = evalVar1 env "h"
...
eval2_1 env (Access0_0_2_1 p0) = get1from4 (evalU2_0 env p0)
eval2_1 env (Access1_0_2_1 p0) = get2from4 (evalU2_0 env p0)
eval2_1 env (Access2_0_2_1 p0) = get3from4 (evalU2_0 env p0)
eval2_1 env (Access3_0_2_1 p0) = get4from4 (evalU2_0 env p0)
...
eval3_0 env (Prod3_0 p0 p1 p2 p3) = ((evalU3_1 env p0), (evalU3_1 env p1), (evalU3_1 env p2), (evalU3_1 env p3))
...
eval3_1 env (Access0_0_3_1 p0) = get1from4 (evalU3_0 env p0)
eval3_1 env (Access1_0_3_1 p0) = get2from4 (evalU3_0 env p0)
eval3_1 env (Access2_0_3_1 p0) = get3from4 (evalU3_0 env p0)
eval3_1 env (Access3_0_3_1 p0) = get4from4 (evalU3_0 env p0)
...
eval4_0 env (Access0_1_4_0 p0) = get1from4 (evalU4_1 env p0)
eval4_0 env (Access1_1_4_0 p0) = get2from4 (evalU4_1 env p0)
eval4_0 env (Access2_1_4_0 p0) = get3from4 (evalU4_1 env p0)
eval4_0 env (Access3_1_4_0 p0) = get4from4 (evalU4_1 env p0)
eval4_0 env (Al_inf4_0) = (100 :: SymInteger)

evalU4_0 :: RefEnv -> UnionM Expr4_0 -> SymInteger
evalU4_0 env = onUnion (eval4_0 env)

eval4_1 :: RefEnv -> Expr4_1 -> (SymInteger, SymInteger, SymInteger, SymInteger)
eval4_1 env (Param84_1) = evalVar0 env "tmp5"
eval4_1 env (Access1_2_4_1 p0) = snd (evalU4_2 env p0)
eval4_1 env (Prod4_1 p0 p1 p2 p3) = ((evalU4_0 env p0), (evalU4_0 env p1), (evalU4_0 env p2), (evalU4_0 env p3))

evalU4_1 :: RefEnv -> UnionM Expr4_1 -> (SymInteger, SymInteger, SymInteger, SymInteger)
evalU4_1 env = onUnion (eval4_1 env)

eval4_2 :: RefEnv -> Expr4_2 -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
eval4_2 env (Param94_2) = evalVar3 env "res"

evalU4_2 :: RefEnv -> UnionM Expr4_2 -> (SegTree, (SymInteger, SymInteger, SymInteger, SymInteger))
...
main = do
    let pairs = [
                ((((Cons ((1)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((-1)) ((Cons ((-3)) ((Cons ((2)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((-4)) ((Cons ((4)) ((Cons ((4)) ((Nil Unit)))))))))))))))))))))))))), ((Ocons ((Query ((-4)) ((4)))) ((Ocons ((Update ((3)) ((1)) ((1)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((1)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((3)) ((Cons ((2)) ((Cons ((0)) ((Cons ((0)) ((Cons ((4)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((2)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((0)) ((Cons ((3)) ((Nil Unit)))))))))))))))))))))))))))))))))))), ((Ocons ((Query ((-3)) ((1)))) ((Onil Unit))))), (Nil Unit))
                , ((((Cons ((2)) ((Cons ((-5)) ((Cons ((3)) ((Cons ((2)) ((Cons ((0)) ((Cons ((-3)) ((Cons ((-3)) ((Cons ((1)) ((Cons ((5)) ((Cons ((0)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-3)) ((Cons ((5)) ((Cons ((5)) ((Cons ((-2)) ((Nil Unit)))))))))))))))))))))))))))))))))), ((Ocons ((Query ((2)) ((3)))) ((Ocons ((Update ((5)) ((1)) ((2)))) ((Ocons ((Query ((-1)) ((4)))) ((Ocons ((Query ((5)) ((-5)))) ((Onil Unit))))))))))), (Cons ((0)) ((Nil Unit))))
                , ((((Cons ((1)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((5)) ((Cons ((3)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((4)) ((Cons ((5)) ((Cons ((3)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((5)) ((Nil Unit)))))))))))))))))))))))))))))), ((Ocons ((Update ((-3)) ((-5)) ((3)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Query ((0)) ((4)))) ((Ocons ((Update ((2)) ((3)) ((-5)))) ((Ocons ((Update ((5)) ((-5)) ((2)))) ((Ocons ((Query ((-4)) ((-2)))) ((Ocons ((Update ((3)) ((4)) ((5)))) ((Onil Unit))))))))))))))))), (Nil Unit))
                , ((((Cons ((-2)) ((Cons ((-5)) ((Cons ((0)) ((Cons ((-3)) ((Nil Unit)))))))))), ((Ocons ((Query ((-2)) ((-3)))) ((Ocons ((Update ((2)) ((-4)) ((3)))) ((Ocons ((Query ((3)) ((0)))) ((Ocons ((Update ((-4)) ((1)) ((1)))) ((Ocons ((Query ((0)) ((2)))) ((Ocons ((Update ((3)) ((-2)) ((-2)))) ((Ocons ((Query ((3)) ((5)))) ((Ocons ((Update ((4)) ((-5)) ((3)))) ((Ocons ((Query ((5)) ((5)))) ((Ocons ((Update ((5)) ((1)) ((5)))) ((Ocons ((Query ((0)) ((-5)))) ((Onil Unit))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((-4)) ((Cons ((2)) ((Nil Unit)))))), ((Onil Unit))), (Nil Unit))
                , ((((Cons ((2)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((-5)) ((Cons ((5)) ((Cons ((0)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((2)) ((Cons ((-4)) ((Cons ((-5)) ((Cons ((4)) ((Nil Unit)))))))))))))))))))))))))))))), ((Ocons ((Query ((1)) ((4)))) ((Ocons ((Update ((-2)) ((-4)) ((1)))) ((Onil Unit))))))), (Cons ((1)) ((Nil Unit))))
                , ((((Cons ((-4)) ((Cons ((-5)) ((Nil Unit)))))), ((Ocons ((Update ((4)) ((-3)) ((-3)))) ((Ocons ((Update ((2)) ((2)) ((-1)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((1)) ((Nil Unit)))), ((Ocons ((Update ((-1)) ((0)) ((-5)))) ((Ocons ((Update ((2)) ((-2)) ((4)))) ((Ocons ((Update ((5)) ((-2)) ((4)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Update ((-3)) ((3)) ((-5)))) ((Ocons ((Update ((4)) ((4)) ((5)))) ((Ocons ((Update ((1)) ((3)) ((1)))) ((Ocons ((Update ((-5)) ((0)) ((5)))) ((Ocons ((Query ((-5)) ((-4)))) ((Ocons ((Update ((5)) ((0)) ((-2)))) ((Ocons ((Query ((-3)) ((1)))) ((Ocons ((Update ((5)) ((-4)) ((-4)))) ((Ocons ((Query ((4)) ((-3)))) ((Ocons ((Update ((4)) ((-5)) ((5)))) ((Ocons ((Update ((2)) ((-2)) ((3)))) ((Onil Unit))))))))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((2)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((2)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((4)) ((Cons ((4)) ((Cons ((0)) ((Cons ((-5)) ((Cons ((5)) ((Cons ((-5)) ((Nil Unit)))))))))))))))))))))))))), ((Ocons ((Update ((-4)) ((-5)) ((-2)))) ((Ocons ((Query ((0)) ((-5)))) ((Ocons ((Query ((-5)) ((-3)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Query ((4)) ((-5)))) ((Ocons ((Update ((5)) ((-2)) ((-5)))) ((Ocons ((Update ((-2)) ((2)) ((0)))) ((Ocons ((Query ((-1)) ((4)))) ((Ocons ((Query ((0)) ((5)))) ((Ocons ((Query ((3)) ((-2)))) ((Ocons ((Query ((-5)) ((2)))) ((Ocons ((Query ((5)) ((0)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Query ((3)) ((-4)))) ((Ocons ((Query ((5)) ((-2)))) ((Ocons ((Query ((-3)) ((-3)))) ((Ocons ((Update ((3)) ((4)) ((-3)))) ((Ocons ((Update ((0)) ((0)) ((5)))) ((Ocons ((Update ((-4)) ((5)) ((-5)))) ((Onil Unit))))))))))))))))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((2)) ((Nil Unit)))), ((Ocons ((Query ((2)) ((0)))) ((Ocons ((Query ((1)) ((2)))) ((Ocons ((Update ((4)) ((-5)) ((3)))) ((Ocons ((Update ((-3)) ((4)) ((-1)))) ((Ocons ((Update ((5)) ((2)) ((-4)))) ((Ocons ((Update ((2)) ((-3)) ((1)))) ((Ocons ((Query ((4)) ((2)))) ((Ocons ((Query ((0)) ((3)))) ((Ocons ((Update ((-2)) ((-1)) ((-1)))) ((Ocons ((Query ((4)) ((4)))) ((Ocons ((Update ((2)) ((0)) ((-5)))) ((Ocons ((Update ((-5)) ((-1)) ((-5)))) ((Ocons ((Update ((-5)) ((3)) ((4)))) ((Ocons ((Query ((2)) ((2)))) ((Ocons ((Query ((5)) ((2)))) ((Onil Unit))))))))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((0)) ((Cons ((-1)) ((Cons ((4)) ((Cons ((-1)) ((Cons ((-2)) ((Cons ((5)) ((Cons ((-2)) ((Cons ((3)) ((Cons ((3)) ((Cons ((-3)) ((Cons ((-1)) ((Nil Unit)))))))))))))))))))))))), ((Ocons ((Update ((4)) ((4)) ((-5)))) ((Ocons ((Query ((5)) ((-2)))) ((Ocons ((Update ((-1)) ((-5)) ((-3)))) ((Ocons ((Update ((0)) ((-1)) ((1)))) ((Ocons ((Query ((-4)) ((0)))) ((Ocons ((Update ((-2)) ((3)) ((4)))) ((Ocons ((Update ((5)) ((-4)) ((5)))) ((Ocons ((Update ((-5)) ((-2)) ((-4)))) ((Ocons ((Query ((0)) ((-1)))) ((Ocons ((Update ((-1)) ((1)) ((2)))) ((Ocons ((Update ((-4)) ((-1)) ((2)))) ((Ocons ((Update ((3)) ((0)) ((-5)))) ((Ocons ((Update ((3)) ((-1)) ((-1)))) ((Onil Unit))))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((3)) ((Cons ((-2)) ((Cons ((4)) ((Cons ((-5)) ((Cons ((-5)) ((Cons ((2)) ((Cons ((4)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((-1)) ((Nil Unit)))))))))))))))))))))), ((Ocons ((Update ((1)) ((4)) ((3)))) ((Ocons ((Update ((2)) ((0)) ((-5)))) ((Ocons ((Query ((-3)) ((4)))) ((Ocons ((Update ((4)) ((4)) ((-4)))) ((Ocons ((Update ((3)) ((4)) ((3)))) ((Ocons ((Query ((-2)) ((4)))) ((Ocons ((Query ((1)) ((3)))) ((Ocons ((Query ((5)) ((4)))) ((Ocons ((Query ((0)) ((5)))) ((Onil Unit))))))))))))))))))))), (Cons ((1)) ((Nil Unit))))
                , ((((Cons ((3)) ((Cons ((5)) ((Cons ((1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((1)) ((Cons ((3)) ((Cons ((-4)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((5)) ((Cons ((-5)) ((Nil Unit)))))))))))))))))))))))))), ((Ocons ((Query ((2)) ((-2)))) ((Ocons ((Query ((-5)) ((5)))) ((Onil Unit))))))), (Nil Unit))
                , ((((Cons ((-5)) ((Cons ((-4)) ((Cons ((-1)) ((Nil Unit)))))))), ((Ocons ((Update ((-3)) ((4)) ((-5)))) ((Ocons ((Query ((-2)) ((3)))) ((Ocons ((Query ((-2)) ((-4)))) ((Ocons ((Update ((4)) ((-1)) ((0)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Query ((5)) ((0)))) ((Ocons ((Update ((3)) ((5)) ((-3)))) ((Ocons ((Update ((-5)) ((1)) ((-3)))) ((Ocons ((Update ((-4)) ((-3)) ((2)))) ((Ocons ((Query ((-5)) ((1)))) ((Ocons ((Update ((-2)) ((5)) ((3)))) ((Ocons ((Update ((-2)) ((5)) ((1)))) ((Ocons ((Query ((4)) ((3)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Update ((-5)) ((0)) ((-2)))) ((Ocons ((Update ((4)) ((-1)) ((3)))) ((Onil Unit))))))))))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((3)) ((Cons ((0)) ((Cons ((1)) ((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((0)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-4)) ((Cons ((3)) ((Cons ((-3)) ((Cons ((-2)) ((Nil Unit)))))))))))))))))))))))))))))))))))))))), ((Ocons ((Query ((-5)) ((5)))) ((Ocons ((Query ((0)) ((1)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Update ((-5)) ((5)) ((5)))) ((Ocons ((Query ((4)) ((-1)))) ((Ocons ((Update ((2)) ((-5)) ((3)))) ((Ocons ((Update ((-4)) ((5)) ((-2)))) ((Ocons ((Query ((3)) ((-5)))) ((Ocons ((Update ((4)) ((-4)) ((-1)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Update ((-3)) ((-2)) ((-3)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Query ((3)) ((3)))) ((Ocons ((Update ((-1)) ((-3)) ((-4)))) ((Ocons ((Query ((5)) ((-3)))) ((Ocons ((Update ((-5)) ((-2)) ((-5)))) ((Ocons ((Query ((-5)) ((4)))) ((Onil Unit))))))))))))))))))))))))))))))))))))), (Cons ((1)) ((Nil Unit))))
                , ((((Cons ((0)) ((Cons ((-1)) ((Cons ((5)) ((Cons ((5)) ((Cons ((3)) ((Cons ((3)) ((Cons ((2)) ((Cons ((1)) ((Cons ((5)) ((Cons ((5)) ((Cons ((-4)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-2)) ((Cons ((4)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((0)) ((Nil Unit)))))))))))))))))))))))))))))))))))))), ((Ocons ((Update ((3)) ((-1)) ((-3)))) ((Ocons ((Update ((5)) ((4)) ((4)))) ((Ocons ((Update ((1)) ((-4)) ((-1)))) ((Ocons ((Update ((1)) ((-5)) ((4)))) ((Ocons ((Update ((0)) ((4)) ((1)))) ((Ocons ((Update ((1)) ((4)) ((-2)))) ((Ocons ((Update ((-4)) ((-4)) ((-2)))) ((Ocons ((Query ((4)) ((-4)))) ((Ocons ((Query ((-4)) ((3)))) ((Ocons ((Query ((-2)) ((0)))) ((Ocons ((Update ((1)) ((-1)) ((-2)))) ((Ocons ((Update ((-5)) ((-2)) ((4)))) ((Onil Unit))))))))))))))))))))))))))), (Nil Unit))
                , ((((Cons ((5)) ((Cons ((-2)) ((Cons ((-3)) ((Cons ((5)) ((Cons ((-4)) ((Nil Unit)))))))))))), ((Ocons ((Update ((-2)) ((2)) ((-2)))) ((Ocons ((Query ((-2)) ((3)))) ((Ocons ((Update ((-3)) ((1)) ((5)))) ((Ocons ((Query ((-3)) ((0)))) ((Ocons ((Query ((-4)) ((4)))) ((Ocons ((Update ((3)) ((2)) ((-1)))) ((Ocons ((Update ((0)) ((3)) ((3)))) ((Ocons ((Update ((1)) ((0)) ((-3)))) ((Ocons ((Query ((-1)) ((-5)))) ((Ocons ((Update ((1)) ((0)) ((-1)))) ((Ocons ((Query ((2)) ((2)))) ((Ocons ((Query ((-4)) ((5)))) ((Onil Unit))))))))))))))))))))))))))), (Cons ((0)) ((Nil Unit))))
                , ((((Cons ((-3)) ((Cons ((1)) ((Cons ((0)) ((Cons ((3)) ((Cons ((-2)) ((Cons ((-4)) ((Cons ((-2)) ((Cons ((5)) ((Cons ((-2)) ((Cons ((3)) ((Cons ((2)) ((Cons ((-3)) ((Cons ((1)) ((Cons ((3)) ((Cons ((0)) ((Cons ((3)) ((Nil Unit)))))))))))))))))))))))))))))))))), ((Ocons ((Update ((4)) ((5)) ((-1)))) ((Ocons ((Query ((1)) ((-3)))) ((Ocons ((Query ((-5)) ((-5)))) ((Ocons ((Update ((-5)) ((1)) ((1)))) ((Ocons ((Update ((3)) ((-1)) ((-1)))) ((Ocons ((Update ((5)) ((1)) ((-3)))) ((Onil Unit))))))))))))))), (Nil Unit))
                , ((((Cons ((5)) ((Cons ((-4)) ((Cons ((1)) ((Cons ((-5)) ((Cons ((4)) ((Cons ((3)) ((Cons ((5)) ((Cons ((-1)) ((Cons ((4)) ((Cons ((-3)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((5)) ((Cons ((3)) ((Cons ((1)) ((Cons ((-3)) ((Cons ((0)) ((Cons ((-2)) ((Nil Unit)))))))))))))))))))))))))))))))))))))))), ((Ocons ((Update ((-1)) ((-2)) ((-5)))) ((Ocons ((Update ((-4)) ((2)) ((5)))) ((Ocons ((Query ((-1)) ((2)))) ((Ocons ((Update ((2)) ((5)) ((-3)))) ((Ocons ((Query ((-3)) ((-3)))) ((Ocons ((Query ((4)) ((3)))) ((Ocons ((Update ((-2)) ((-2)) ((1)))) ((Ocons ((Query ((5)) ((-4)))) ((Ocons ((Update ((3)) ((-2)) ((-4)))) ((Ocons ((Update ((-4)) ((3)) ((0)))) ((Ocons ((Update ((4)) ((-1)) ((-2)))) ((Ocons ((Query ((-3)) ((3)))) ((Ocons ((Query ((-5)) ((5)))) ((Ocons ((Update ((4)) ((1)) ((5)))) ((Ocons ((Update ((0)) ((3)) ((1)))) ((Ocons ((Query ((0)) ((-3)))) ((Onil Unit))))))))))))))))))))))))))))))))))), (Nil Unit))
                ]
