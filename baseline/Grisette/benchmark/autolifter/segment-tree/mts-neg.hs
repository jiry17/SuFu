...
type Result = (SymInteger, SymInteger, SymInteger)
...
data SegTree
  ...
  deriving (Mergeable, EvaluateSym, ToCon SegTree, ExtractSymbolics)
    via (Default SegTree)
...
data EnvValue
  ...
  | Env1 SymBool
  | Env2 (SymBool, (SymInteger, SymInteger, SymInteger))
  | Env3 SymInteger
  | Env4 (SegTree, (SymInteger, SymInteger, SymInteger))
...
evalVar2 :: RefEnv -> Ident -> (SymBool, (SymInteger, SymInteger, SymInteger))
...
evalVar4 :: RefEnv -> Ident -> (SegTree, (SymInteger, SymInteger, SymInteger))
...
SymBool
(SymBool, (SymInteger, SymInteger, SymInteger))
SymInteger
(SegTree, (SymInteger, SymInteger, SymInteger))
-}
...
data Expr0_0
  = Param00_0
  | Param10_0
  | Prod0_0 (UnionM Expr0_2) (UnionM Expr0_2) (UnionM Expr0_2)
  deriving stock (Generic, Show)
...
data Expr0_2
  ...
  | Cmul0_2 (UnionM Expr0_2) (UnionM Expr0_2)
  | Al_inf0_2
  deriving stock (Generic, Show)
...
data Expr1_0
  ...
  | Prod1_0 (UnionM Expr1_3) (UnionM Expr1_3) (UnionM Expr1_3)
  deriving stock (Generic, Show)
...
data Expr1_3
  ...
  | Cmul1_3 (UnionM Expr1_3) (UnionM Expr1_3)
  | Al_inf1_3
  deriving stock (Generic, Show)
...
data Expr2_0
  = Prod2_0 (UnionM Expr2_2) (UnionM Expr2_2) (UnionM Expr2_2)
  | CZero32_0
  deriving stock (Generic, Show)
...
data Expr2_2
  ...
  | Cmul2_2 (UnionM Expr2_2) (UnionM Expr2_2)
  | Al_inf2_2
  deriving stock (Generic, Show)
...
data Expr3_0
  = Prod3_0 (UnionM Expr3_2) (UnionM Expr3_2) (UnionM Expr3_2)
  | CZero33_0
  deriving stock (Generic, Show)
...
data Expr3_2
  ...
  | Cmul3_2 (UnionM Expr3_2) (UnionM Expr3_2)
  | Al_inf3_2
  deriving stock (Generic, Show)
...
data Expr4_1
  ...
  | Prod4_1 (UnionM Expr4_0) (UnionM Expr4_0) (UnionM Expr4_0)
  deriving stock (Generic, Show)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd0_0 e2_0 e2_1 e2_2])
        return res
    gen1 gendepth
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd0_2 e2_0 e2_1] ++ [mrgCsub0_2 e2_2 e2_3] ++ [mrgCIte0_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_0_2 e0_0] ++ [mrgAccess1_0_0_2 e0_1] ++ [mrgAccess2_0_0_2 e0_2] ++ [mrgCmul0_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgAccess1_2_1_0 e2_0] ++ [mrgProd1_0 e3_0 e3_1 e3_2])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen3 gendepth
      ...
      | otherwise = do
        ...
        e3_4 <- (gen3 (gendepth - 1))
        e3_5 <- (gen3 (gendepth - 1))
        e3_6 <- (gen3 (gendepth - 1))
        e3_7 <- (gen3 (gendepth - 1))
        res <- chooseUnionFresh (genSingle3 ++ [mrgCadd1_3 e3_0 e3_1] ++ [mrgCsub1_3 e3_2 e3_3] ++ [mrgCIte1_3 e1_0 e3_4 e3_5] ++ [mrgAccess0_0_1_3 e0_0] ++ [mrgAccess1_0_1_3 e0_1] ++ [mrgAccess2_0_1_3 e0_2] ++ [mrgCmul1_3 e3_6 e3_7])
        return res
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgCZero32_0]
    genSingle1 = [mrgParam32_1]
    genSingle2 = [mrgParam02_2] ++ [mrgParam12_2] ++ [mrgParam42_2] ++ [mrgCzero2_2] ++ [mrgAl_inf2_2]
    gen0 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle0
      | otherwise = do
        e2_0 <- (gen2 (gendepth - 1))
        e2_1 <- (gen2 (gendepth - 1))
        e2_2 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd2_0 e2_0 e2_1 e2_2])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_6 <- (gen2 (gendepth - 1))
        e2_7 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd2_2 e2_0 e2_1] ++ [mrgCsub2_2 e2_2 e2_3] ++ [mrgCIte2_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_2_2 e0_0] ++ [mrgAccess1_0_2_2 e0_1] ++ [mrgAccess2_0_2_2 e0_2] ++ [mrgCmul2_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e2_1 <- (gen2 (gendepth - 1))
        e2_2 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgProd3_0 e2_0 e2_1 e2_2])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
    ...
    gen2 gendepth
      ...
      | otherwise = do
        ...
        e2_6 <- (gen2 (gendepth - 1))
        e2_7 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle2 ++ [mrgCadd3_2 e2_0 e2_1] ++ [mrgCsub3_2 e2_2 e2_3] ++ [mrgCIte3_2 e1_0 e2_4 e2_5] ++ [mrgAccess0_0_3_2 e0_0] ++ [mrgAccess1_0_3_2 e0_1] ++ [mrgAccess2_0_3_2 e0_2] ++ [mrgCmul3_2 e2_6 e2_7])
        return res
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_2 <- (gen1 (gendepth - 1))
        e3_0 <- (gen3 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd4_0 e0_0 e0_1] ++ [mrgCsub4_0 e0_2 e0_3] ++ [mrgCIte4_0 e3_0 e0_4 e0_5] ++ [mrgAccess0_1_4_0 e1_0] ++ [mrgAccess1_1_4_0 e1_1] ++ [mrgAccess2_1_4_0 e1_2] ++ [mrgCmul4_0 e0_6 e0_7])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
        ...
        e0_2 <- (gen0 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgAccess1_2_4_1 e2_0] ++ [mrgProd4_1 e0_0 e0_1 e0_2])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
...
eval0_0 env (Prod0_0 p0 p1 p2) = ((evalU0_2 env p0), (evalU0_2 env p1), (evalU0_2 env p2))
...
eval0_2 env (Access0_0_0_2 p0) = get1from3 (evalU0_0 env p0)
eval0_2 env (Access1_0_0_2 p0) = get2from3 (evalU0_0 env p0)
eval0_2 env (Access2_0_0_2 p0) = get3from3 (evalU0_0 env p0)
eval0_2 env (Cmul0_2 p0 p1) =  (evalU0_2 env p0) * (evalU0_2 env p1) 
...
eval1_0 env (Prod1_0 p0 p1 p2) = ((evalU1_3 env p0), (evalU1_3 env p1), (evalU1_3 env p2))
...
eval1_2 :: RefEnv -> Expr1_2 -> (SymBool, (SymInteger, SymInteger, SymInteger))
eval1_2 env (Param61_2) = evalVar2 env "info"
eval1_2 env (Prod1_2 p0 p1) = ((evalU1_1 env p0), (evalU1_0 env p1))

evalU1_2 :: RefEnv -> UnionM Expr1_2 -> (SymBool, (SymInteger, SymInteger, SymInteger))
...
eval1_3 env (Access1_0_1_3 p0) = get2from3 (evalU1_0 env p0)
eval1_3 env (Access2_0_1_3 p0) = get3from3 (evalU1_0 env p0)
eval1_3 env (Cmul1_3 p0 p1) =  (evalU1_3 env p0) * (evalU1_3 env p1) 
...
eval2_0 env (Prod2_0 p0 p1 p2) = ((evalU2_2 env p0), (evalU2_2 env p1), (evalU2_2 env p2))
eval2_0 env (CZero32_0) = (0,0,0)
...
eval2_2 env (Param42_2) = evalVar3 env "h"
...
eval2_2 env (Access0_0_2_2 p0) = get1from3 (evalU2_0 env p0)
eval2_2 env (Access1_0_2_2 p0) = get2from3 (evalU2_0 env p0)
eval2_2 env (Access2_0_2_2 p0) = get3from3 (evalU2_0 env p0)
eval2_2 env (Cmul2_2 p0 p1) =  (evalU2_2 env p0) * (evalU2_2 env p1) 
...
eval3_0 env (Prod3_0 p0 p1 p2) = ((evalU3_2 env p0), (evalU3_2 env p1), (evalU3_2 env p2))
eval3_0 env (CZero33_0) = (0,0,0)
...
eval3_2 env (Access0_0_3_2 p0) = get1from3 (evalU3_0 env p0)
eval3_2 env (Access1_0_3_2 p0) = get2from3 (evalU3_0 env p0)
eval3_2 env (Access2_0_3_2 p0) = get3from3 (evalU3_0 env p0)
eval3_2 env (Cmul3_2 p0 p1) =  (evalU3_2 env p0) * (evalU3_2 env p1) 
...
eval4_0 env (Access0_1_4_0 p0) = get1from3 (evalU4_1 env p0)
eval4_0 env (Access1_1_4_0 p0) = get2from3 (evalU4_1 env p0)
eval4_0 env (Access2_1_4_0 p0) = get3from3 (evalU4_1 env p0)
...
eval4_1 :: RefEnv -> Expr4_1 -> (SymInteger, SymInteger, SymInteger)
eval4_1 env (Param84_1) = evalVar0 env "tmp5"
eval4_1 env (Access1_2_4_1 p0) = snd (evalU4_2 env p0)
eval4_1 env (Prod4_1 p0 p1 p2) = ((evalU4_0 env p0), (evalU4_0 env p1), (evalU4_0 env p2))

evalU4_1 :: RefEnv -> UnionM Expr4_1 -> (SymInteger, SymInteger, SymInteger)
evalU4_1 env = onUnion (eval4_1 env)

eval4_2 :: RefEnv -> Expr4_2 -> (SegTree, (SymInteger, SymInteger, SymInteger))
eval4_2 env (Param94_2) = evalVar4 env "res"

evalU4_2 :: RefEnv -> UnionM Expr4_2 -> (SegTree, (SymInteger, SymInteger, SymInteger))
evalU4_2 env = onUnion (eval4_2 env)

eval4_3 :: RefEnv -> Expr4_3 -> SymBool
eval4_3 env (Param104_3) = (toSym False)
...
solve' merge_tag default_tag apply target init ops = 
  ...
  in
  let
    -- update_tree :: SymInteger -> SymInteger -> Tag -> SegTree
    update_tree ql qr tag =
      (let
        -- f :: SymInteger -> SymInteger -> SegTree -> SegTree
        f l r n = 
          mrgIte ((l >~  ql) ||~  (r <~  qr))
            (n)
            (mrgIte ((ql <=~  l) &&~  (r <=~  qr))
        ...
        Cons h t -> 
          let
            res =
              (f t)
          in
          ((max' ((snd res) +  h) (fst res)), ((snd res) +  h))
      
  in
  f  xs))

main' = 
  solve' merge_tag default_tag apply_tag mts
...
main = do
    let pairs = [
                ...
                , ((((Cons ((2)) ((Cons ((5)) ((Nil Unit)))))), ((Ocons ((Query ((1)) ((2)))) ((Ocons ((Query ((-1)) ((4)))) ((Ocons ((Query ((5)) ((-5)))) ((Ocons ((Update ((3)) ((-1)) ((toSym False)))) ((Ocons ((Query ((3)) ((-5)))) ((Ocons ((Query ((-5)) ((3)))) ((Ocons ((Query ((1)) ((-2)))) ((Onil Unit))))))))))))))))), (Cons ((7)) ((Nil Unit))))
