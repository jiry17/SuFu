...
data Expr3_0
  ...
  | Op3_0 (UnionM Expr3_0) (UnionM Expr3_0)
...
instance GenSym (Int) Expr1_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam01_0]
    genSingle1 = [mrgParam11_1] ++ [mrgCzero1_1]
...
instance GenSym (Int) Expr2_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    ...
    genSingle1 = [mrgParam32_1] ++ [mrgCzero2_1]
    ...
    gen1 gendepth
      ...
      | otherwise = do
        ...
        e1_7 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle1 ++ [mrgCadd2_1 e1_0 e1_1] ++ [mrgCsub2_1 e1_2 e1_3] ++ [mrgCIte2_1 e2_0 e1_4 e1_5] ++ [mrgAccess0_0_2_1 e0_0] ++ [mrgAccess1_0_2_1 e0_1] ++ [mrgCmul2_1 e1_6 e1_7])
        return res
    gen2 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle2
      | otherwise = do
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        e1_1 <- (gen1 (gendepth - 1))
        e2_0 <- (gen2 (gendepth - 1))
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_3_0 e1_0] ++ [mrgAccess1_1_3_0 e1_1] ++ [mrgOp3_0 e0_6 e0_7] ++ [mrgCmul3_0 e0_8 e0_9])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
eval1_1 env (Param11_1) = evalVar1 env "h"
...
eval2_0 env (Param22_0) = evalVar0 env "tail"
...
eval3_0 env (Param03_0) = evalVar1 env "global0"
...
eval3_0 env (Op3_0 p0 p1) = op (evalU3_0 env p0) (evalU3_0 env p1)
...
eval3_1 env (Param13_1) = evalVar0 env "tmp4"
            ...
            tail =
              ...
              let
                tmp3 =
                  (f t)
              in
              evalU1_0 (RefEnv [("tmp3", (Env0 tmp3)), ("h", (Env1 h))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0)))
          in
          evalU2_0 (RefEnv [("tail", (Env0 tail)), ("h", (Env1 h))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))
...
main' global0 xs = 
  let
    tmp4 =
      (tri (op global0) xs)
  in
  evalU3_0 (RefEnv [("global0", (Env1 global0)), ("tmp4", (Env0 tmp4))]) ((genSym (4::Int) "hole3") :: (UnionM Expr3_0))
...
main = do
    let pairs = [
                ((((-2)), ((Nil Unit))), (0))
                , ((((2)), ((Cons ((-1)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((2)) ((Nil Unit))))))))))))), (31))
                , ((((0)), ((Nil Unit))), (0))
                , ((((1)), ((Cons ((2)) ((Cons ((1)) ((Cons ((-2)) ((Cons ((-1)) ((Cons ((1)) ((Nil Unit))))))))))))), (1))
                , ((((-2)), ((Cons ((2)) ((Nil Unit))))), (2))
                , ((((2)), ((Cons ((2)) ((Nil Unit))))), (2))
                , ((((0)), ((Cons ((-1)) ((Cons ((2)) ((Cons ((1)) ((Cons ((2)) ((Cons ((-2)) ((Cons ((0)) ((Cons ((-2)) ((Cons ((2)) ((Nil Unit))))))))))))))))))), (-1))
                , ((((-1)), ((Cons ((2)) ((Nil Unit))))), (2))
                , ((((1)), ((Cons ((-2)) ((Nil Unit))))), (-2))
                , ((((1)), ((Cons ((-1)) ((Cons ((-2)) ((Cons ((1)) ((Cons ((-1)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((1)) ((Cons ((2)) ((Nil Unit))))))))))))))))))), (-1))
                , ((((-2)), ((Cons ((2)) ((Cons ((-2)) ((Nil Unit))))))), (6))
                , ((((-1)), ((Cons ((-1)) ((Nil Unit))))), (-1))
                , ((((2)), ((Cons ((-2)) ((Cons ((-2)) ((Cons ((0)) ((Cons ((-1)) ((Nil Unit))))))))))), (-14))
                , ((((-1)), ((Cons ((2)) ((Nil Unit))))), (2))
                , ((((-1)), ((Nil Unit))), (0))
                , ((((1)), ((Nil Unit))), (0))
                , ((((0)), ((Cons ((-2)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((1)) ((Cons ((2)) ((Cons ((0)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((-1)) ((Nil Unit))))))))))))))))))))), (-2))
                , ((((-2)), ((Cons ((0)) ((Cons ((-1)) ((Cons ((-2)) ((Nil Unit))))))))), (-6))
                , ((((1)), ((Cons ((0)) ((Cons ((2)) ((Cons ((-1)) ((Cons ((0)) ((Cons ((1)) ((Cons ((1)) ((Cons ((2)) ((Cons ((1)) ((Cons ((-1)) ((Nil Unit))))))))))))))))))))), (5))
                , ((((1)), ((Cons ((1)) ((Nil Unit))))), (1))
                ]
