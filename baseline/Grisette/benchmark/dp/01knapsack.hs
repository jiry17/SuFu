...
instance GenSym (Int) Expr3_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam03_0] ++ [mrgParam23_0] ++ [mrgCzero3_0]
...
eval0_0 env (Param10_0) = evalVar0 env "p"
...
eval2_0 env (Param02_0) = evalVar1 env "res"
eval2_0 env (Param22_0) = evalVar1 env "lim"
...
eval2_1 env (Param12_1) = evalVar0 env "p"
...
eval3_0 env (Param03_0) = evalVar1 env "res"
eval3_0 env (Param23_0) = evalVar1 env "lim"
...
eval3_1 env (Param13_1) = evalVar0 env "p"
...
type Item = (SymInteger, SymInteger)

data ItemList
  = Cons Item ItemList
  | Nil Unit
  deriving stock (Generic, Show, Eq)
  deriving (Mergeable, EvaluateSym, ToCon ItemList, ExtractSymbolics)
    via (Default ItemList)

type Plan = ItemList

data PlanList
  = ConsPlan (SymInteger, SymInteger) PlanList
  | NilPlan Unit
  deriving stock (Generic, Show, Eq)
        ...
        ConsPlan p t -> 
          let
            res =
              (f t)
          in
          ConsPlan (evalU0_0 (RefEnv [("p", (Env0 p)), ("i", (Env0 i))]) ((genSym (4::Int) "hole0") :: (UnionM Expr0_0))) (ConsPlan p res)
        NilPlan _ -> ps
      ...
      case items of
        ...
        Nil _ -> ConsPlan (let
            tmp1 =
              (Nil Unit)
          in
          evalU1_0 (RefEnv []) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))) (NilPlan Unit)
        ...
        ConsPlan p t -> 
          let
            res =
              (f t)
          in
          mrgIte (lim <~  (evalU2_0 (RefEnv [("res", (Env1 res)), ("lim", (Env1 lim)), ("p", (Env0 p))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))))
            (res)
            (max' (evalU3_0 (RefEnv [("res", (Env1 res)), ("lim", (Env1 lim)), ("p", (Env0 p))]) ((genSym (4::Int) "hole3") :: (UnionM Expr3_0))) res)
        NilPlan _ -> 0
  in
  f 
...
ioPair :: [((SymInteger, ItemList), Integer)] -> IO ()
ioPair pairs = do
    ...
    case res of
        ...
        Right model -> do
            print "success!"
    where
        constraint :: [((SymInteger, ItemList), Integer)] -> SymBool
        constraint [] = con True
...
main = do
    let pairs = [
                ((((-2)), ((Cons (((5)), ((-3))) ((Cons (((-2)), ((5))) ((Cons (((-5)), ((4))) ((Nil Unit))))))))), (9))
                , ((((-5)), ((Cons (((-2)), ((-3))) ((Cons (((-1)), ((4))) ((Cons (((5)), ((3))) ((Cons (((5)), ((2))) ((Cons (((0)), ((4))) ((Cons (((4)), ((3))) ((Cons (((-2)), ((1))) ((Nil Unit))))))))))))))))), (6))
                , ((((2)), ((Cons (((-1)), ((-3))) ((Cons (((-3)), ((3))) ((Cons (((4)), ((-3))) ((Nil Unit))))))))), (3))
                , ((((-2)), ((Cons (((-2)), ((-4))) ((Cons (((0)), ((-2))) ((Cons (((-3)), ((5))) ((Cons (((2)), ((5))) ((Cons (((0)), ((-5))) ((Cons (((-3)), ((2))) ((Nil Unit))))))))))))))), (12))
                , ((((-1)), ((Cons (((-4)), ((-2))) ((Cons (((2)), ((0))) ((Cons (((2)), ((5))) ((Cons (((-4)), ((-3))) ((Nil Unit))))))))))), (3))
                , ((((3)), ((Nil Unit))), (0))
                , ((((0)), ((Cons (((-5)), ((5))) ((Cons (((2)), ((-3))) ((Cons (((2)), ((3))) ((Cons (((-1)), ((1))) ((Cons (((4)), ((-4))) ((Cons (((-2)), ((-2))) ((Cons (((2)), ((-4))) ((Cons (((1)), ((-1))) ((Cons (((1)), ((-3))) ((Nil Unit))))))))))))))))))))), (9))
                , ((((-5)), ((Cons (((-5)), ((-1))) ((Cons (((-2)), ((5))) ((Cons (((-1)), ((1))) ((Nil Unit))))))))), (5))
                , ((((2)), ((Nil Unit))), (0))
                , ((((4)), ((Cons (((4)), ((-4))) ((Cons (((-3)), ((-5))) ((Cons (((3)), ((-3))) ((Cons (((1)), ((-4))) ((Cons (((-4)), ((3))) ((Cons (((-4)), ((-3))) ((Nil Unit))))))))))))))), (3))
                , ((((-1)), ((Cons (((2)), ((-4))) ((Cons (((0)), ((3))) ((Cons (((0)), ((-1))) ((Cons (((-1)), ((1))) ((Cons (((2)), ((1))) ((Nil Unit))))))))))))), (4))
                , ((((2)), ((Cons (((-5)), ((-5))) ((Cons (((-4)), ((4))) ((Cons (((2)), ((-3))) ((Nil Unit))))))))), (4))
                , ((((1)), ((Cons (((5)), ((-4))) ((Cons (((-5)), ((0))) ((Nil Unit))))))), (0))
                , ((((-4)), ((Nil Unit))), (0))
                , ((((4)), ((Cons (((-1)), ((-1))) ((Cons (((-4)), ((0))) ((Cons (((-4)), ((-1))) ((Cons (((3)), ((-5))) ((Cons (((5)), ((4))) ((Cons (((-2)), ((-5))) ((Cons (((-1)), ((5))) ((Cons (((-1)), ((-3))) ((Cons (((-2)), ((4))) ((Nil Unit))))))))))))))))))))), (13))
                , ((((1)), ((Cons (((-4)), ((-4))) ((Cons (((-4)), ((4))) ((Cons (((-4)), ((-5))) ((Cons (((4)), ((1))) ((Cons (((0)), ((2))) ((Cons (((-4)), ((3))) ((Cons (((-5)), ((2))) ((Cons (((-1)), ((1))) ((Nil Unit))))))))))))))))))), (13))
                , ((((5)), ((Cons (((-4)), ((2))) ((Cons (((-5)), ((-3))) ((Cons (((-3)), ((-4))) ((Cons (((5)), ((3))) ((Cons (((-4)), ((5))) ((Cons (((-4)), ((3))) ((Cons (((1)), ((3))) ((Cons (((0)), ((-3))) ((Nil Unit))))))))))))))))))), (16))
                , ((((3)), ((Cons (((4)), ((-5))) ((Cons (((4)), ((4))) ((Nil Unit))))))), (0))
                , ((((5)), ((Cons (((4)), ((-3))) ((Cons (((-5)), ((-2))) ((Cons (((3)), ((1))) ((Cons (((-5)), ((2))) ((Nil Unit))))))))))), (3))
                , ((((-2)), ((Cons (((5)), ((0))) ((Nil Unit))))), (0))
                ]
