...
evalVar1 :: RefEnv -> Ident -> (SymInteger, List)
  ...
  fresh gendepth = gen0 gendepth 
    ...
    gen0 gendepth
      ...
      | otherwise = do
        ...
        res <- chooseUnionFresh (genSingle0 ++ [mrgCadd3_0 e0_0 e0_1] ++ [mrgCsub3_0 e0_2 e0_3] ++ [mrgCIte3_0 e2_0 e0_4 e0_5] ++ [mrgAccess0_1_3_0 e1_0])
        return res
    gen1 gendepth
      | gendepth <= 0 = chooseUnionFresh genSingle1
      | otherwise = do
...
instance GenSym (Int) Expr4_0 where 
  ...
  fresh gendepth = gen0 gendepth 
    where
    genSingle0 = [mrgParam04_0] ++ [mrgCzero4_0] ++ [mrgOne4_0]
...
eval3_0 env (Param13_0) = evalVar0 env "h"
...
eval3_1 :: RefEnv -> Expr3_1 -> (SymInteger, List)
eval3_1 env (Param23_1) = evalVar1 env "last"

evalU3_1 :: RefEnv -> UnionM Expr3_1 -> (SymInteger, List)
...
eval4_0 env (Param04_0) = evalVar0 env "h"
      ...
      case xs of
        Nil _ -> Pcons (let
            tmp1 =
              (Nil Unit)
          in
          evalU0_0 (RefEnv []) ((genSym (4::Int) "hole0") :: (UnionM Expr0_0))) (Pnil Unit)
        Cons h (Nil _) -> Pcons (evalU1_0 (RefEnv [("h", (Env0 h))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))) (Pcons (let
            tmp2 =
              (Nil Unit)
          in
          evalU2_0 (RefEnv [("h", (Env0 h))]) ((genSym (4::Int) "hole2") :: (UnionM Expr2_0))) (Pnil Unit))
        Cons h t -> 
          let
            last =
              (take_back t)
          ...
          let
            res =
              (merge' (f t) (f (Cons h (snd last))))
          in
          mrgIte (h ==~  (fst last))
            (merge' (extend (\xs -> xs + 2) (f (snd last))) res)
            (res)
...
get_best = 
  ...
  let
    f xs = 
      case xs of
        Pnil _ -> 0
        Pcons h t -> max' (evalU4_0 (RefEnv [("h", (Env0 h))]) ((genSym (4::Int) "hole4") :: (UnionM Expr4_0))) (f t)
...
main = do
    let pairs = [
                ((((Nil Unit))), (0))
                , ((((Cons ((3)) ((Cons ((0)) ((Cons ((4)) ((Cons ((5)) ((Cons ((1)) ((Nil Unit))))))))))))), (1))
                , ((((Cons ((0)) ((Cons ((5)) ((Cons ((0)) ((Nil Unit))))))))), (3))
                , ((((Cons ((1)) ((Cons ((3)) ((Nil Unit))))))), (1))
                , ((((Nil Unit))), (0))
                , ((((Nil Unit))), (0))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((3)) ((Nil Unit))))))))))), (3))
                , ((((Cons ((3)) ((Cons ((0)) ((Cons ((4)) ((Cons ((3)) ((Cons ((5)) ((Nil Unit))))))))))))), (3))
                , ((((Cons ((0)) ((Nil Unit))))), (1))
                , ((((Cons ((5)) ((Cons ((1)) ((Nil Unit))))))), (1))
                , ((((Cons ((5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((1)) ((Cons ((5)) ((Nil Unit))))))))))))), (3))
                , ((((Cons ((1)) ((Nil Unit))))), (1))
                , ((((Cons ((5)) ((Cons ((5)) ((Cons ((0)) ((Cons ((0)) ((Cons ((1)) ((Nil Unit))))))))))))), (2))
                , ((((Cons ((5)) ((Nil Unit))))), (1))
                , ((((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((1)) ((Cons ((1)) ((Nil Unit))))))))))))), (2))
                , ((((Cons ((2)) ((Nil Unit))))), (1))
                , ((((Nil Unit))), (0))
                , ((((Nil Unit))), (0))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Nil Unit))))))))), (3))
                , ((((Cons ((5)) ((Cons ((2)) ((Cons ((0)) ((Cons ((4)) ((Cons ((1)) ((Nil Unit))))))))))))), (1))
                ]
