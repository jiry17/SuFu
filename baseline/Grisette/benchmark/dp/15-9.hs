...
generate = 
  let
    f xs = 
      case xs of
        Nil _ -> Pnil Unit
        Cons h (Nil _) -> Pcons (let
            tmp1 =
              (Leaf h)
          in
          evalU1_0 (RefEnv [("h", (Env1 h))]) ((genSym (4::Int) "hole1") :: (UnionM Expr1_0))) (Pnil Unit)
        Cons h t -> let
            g l r = 
              let
                res =
        ...
        Node l r -> 
          ...
          let
            rres =
              (f r)
          in
          ((((fst lres) +  (snd lres)) +  ((fst rres) +  (snd rres))), ((snd lres) +  (snd rres)))
...
main = do
    let pairs = [
                ((((Nil Unit))), (1000))
                , ((((Cons ((3)) ((Cons ((0)) ((Cons ((4)) ((Cons ((5)) ((Cons ((1)) ((Nil Unit))))))))))))), (29))
                , ((((Cons ((0)) ((Cons ((5)) ((Cons ((0)) ((Nil Unit))))))))), (10))
                , ((((Cons ((1)) ((Cons ((3)) ((Nil Unit))))))), (4))
                , ((((Nil Unit))), (1000))
                , ((((Nil Unit))), (1000))
                , ((((Cons ((4)) ((Cons ((4)) ((Cons ((4)) ((Cons ((3)) ((Nil Unit))))))))))), (30))
                , ((((Cons ((3)) ((Cons ((0)) ((Cons ((4)) ((Cons ((3)) ((Cons ((5)) ((Nil Unit))))))))))))), (33))
                , ((((Cons ((0)) ((Nil Unit))))), (0))
                , ((((Cons ((5)) ((Cons ((1)) ((Nil Unit))))))), (6))
                , ((((Cons ((5)) ((Cons ((3)) ((Cons ((5)) ((Cons ((1)) ((Cons ((5)) ((Nil Unit))))))))))))), (44))
                , ((((Cons ((1)) ((Nil Unit))))), (0))
                , ((((Cons ((5)) ((Cons ((5)) ((Cons ((0)) ((Cons ((0)) ((Cons ((1)) ((Nil Unit))))))))))))), (18))
                , ((((Cons ((5)) ((Nil Unit))))), (0))
                , ((((Cons ((3)) ((Cons ((4)) ((Cons ((4)) ((Cons ((1)) ((Cons ((1)) ((Nil Unit))))))))))))), (28))
                , ((((Cons ((2)) ((Nil Unit))))), (0))
                , ((((Nil Unit))), (1000))
                , ((((Nil Unit))), (1000))
                , ((((Cons ((1)) ((Cons ((1)) ((Cons ((1)) ((Nil Unit))))))))), (5))
                , ((((Cons ((5)) ((Cons ((2)) ((Cons ((0)) ((Cons ((4)) ((Cons ((1)) ((Nil Unit))))))))))))), (26))
                ]
